...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpYhnOfg/file1a1d11140ae0': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d11140ae0...
...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d11140ae0...
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d11140ae0/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d11140ae0...
#> ✔ First episode created in /tmp/RtmpYhnOfg/file1a1d11140ae0/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d11140ae0...
...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d11140ae0...
#> ✔ Lesson successfully created in /tmp/RtmpYhnOfg/file1a1d11140ae0
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d11140ae0...
#> /tmp/RtmpYhnOfg/file1a1d11140ae0
...
#> $build
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/episodes/introduction.md
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/episodes/introduction.md 2026-05-19
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/index.md                 2026-05-19
#> 
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpYhnOfg/file1a1d11140ae0/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
