...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmptmNyLK/file1c0539567193': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0539567193...
...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0539567193...
#> ☐ Edit /tmp/RtmptmNyLK/file1c0539567193/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0539567193...
#> ✔ First episode created in /tmp/RtmptmNyLK/file1c0539567193/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0539567193...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0539567193...
#> ✔ Lesson successfully created in /tmp/RtmptmNyLK/file1c0539567193
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0539567193...
#> /tmp/RtmptmNyLK/file1c0539567193
...
#> $build
#> /tmp/RtmptmNyLK/file1c0539567193/episodes/introduction.md
#> /tmp/RtmptmNyLK/file1c0539567193/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmptmNyLK/file1c0539567193/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmptmNyLK/file1c0539567193/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmptmNyLK/file1c0539567193/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmptmNyLK/file1c0539567193/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmptmNyLK/file1c0539567193/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmptmNyLK/file1c0539567193/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmptmNyLK/file1c0539567193/episodes/introduction.md 2026-01-19
#> /tmp/RtmptmNyLK/file1c0539567193/index.md                 2026-01-19
#> 
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmptmNyLK/file1c0539567193/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmptmNyLK/file1c0539567193/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
