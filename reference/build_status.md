...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmpfmukg6/file1bf35fa4b40e': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf35fa4b40e...
...
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf35fa4b40e...
#> ☐ Edit /tmp/Rtmpfmukg6/file1bf35fa4b40e/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf35fa4b40e...
#> ✔ First episode created in /tmp/Rtmpfmukg6/file1bf35fa4b40e/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf35fa4b40e...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf35fa4b40e...
#> ✔ Lesson successfully created in /tmp/Rtmpfmukg6/file1bf35fa4b40e
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf35fa4b40e...
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e
...
#> $build
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/episodes/introduction.md
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/episodes/introduction.md episodes/introduction.md
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/episodes/introduction.md site/built/introduction.md
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/episodes/introduction.md 2026-01-17
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/index.md                 2026-01-17
#> 
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/Rtmpfmukg6/file1bf35fa4b40e/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
