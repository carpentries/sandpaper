...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmpgc9t3l/file1c085e89fdec': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c085e89fdec...
...
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c085e89fdec...
#> ☐ Edit /tmp/Rtmpgc9t3l/file1c085e89fdec/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c085e89fdec...
#> ✔ First episode created in /tmp/Rtmpgc9t3l/file1c085e89fdec/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c085e89fdec...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c085e89fdec...
#> ✔ Lesson successfully created in /tmp/Rtmpgc9t3l/file1c085e89fdec
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c085e89fdec...
#> /tmp/Rtmpgc9t3l/file1c085e89fdec
...
#> $build
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/episodes/introduction.md
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/episodes/introduction.md episodes/introduction.md
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/episodes/introduction.md site/built/introduction.md
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/episodes/introduction.md 2026-01-18
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/index.md                 2026-01-18
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-01-18
#> 2        site/built/index.md 2026-01-18
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/Rtmpgc9t3l/file1c085e89fdec/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-01-18
#> 1        site/built/index.md 2026-01-18
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
