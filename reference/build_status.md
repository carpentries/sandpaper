...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmp82VLs2/file1a917a240a3e': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a917a240a3e...
...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a917a240a3e...
#> ☐ Edit /tmp/Rtmp82VLs2/file1a917a240a3e/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a917a240a3e...
#> ✔ First episode created in /tmp/Rtmp82VLs2/file1a917a240a3e/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a917a240a3e...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a917a240a3e...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a917a240a3e...
#> ✔ Lesson successfully created in /tmp/Rtmp82VLs2/file1a917a240a3e
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a917a240a3e...
#> /tmp/Rtmp82VLs2/file1a917a240a3e
...
#> $build
#> /tmp/Rtmp82VLs2/file1a917a240a3e/episodes/introduction.md
#> /tmp/Rtmp82VLs2/file1a917a240a3e/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/Rtmp82VLs2/file1a917a240a3e/episodes/introduction.md episodes/introduction.md
#> /tmp/Rtmp82VLs2/file1a917a240a3e/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/Rtmp82VLs2/file1a917a240a3e/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/Rtmp82VLs2/file1a917a240a3e/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/Rtmp82VLs2/file1a917a240a3e/episodes/introduction.md site/built/introduction.md
#> /tmp/Rtmp82VLs2/file1a917a240a3e/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/Rtmp82VLs2/file1a917a240a3e/episodes/introduction.md 2026-02-28
#> /tmp/Rtmp82VLs2/file1a917a240a3e/index.md                 2026-02-28
#> 
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/Rtmp82VLs2/file1a917a240a3e/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/Rtmp82VLs2/file1a917a240a3e/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
