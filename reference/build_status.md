...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpW7Mbc5/file199d3ed2f106': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3ed2f106...
...
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3ed2f106...
#> ☐ Edit /tmp/RtmpW7Mbc5/file199d3ed2f106/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3ed2f106...
#> ✔ First episode created in /tmp/RtmpW7Mbc5/file199d3ed2f106/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3ed2f106...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3ed2f106...
#> ✔ Lesson successfully created in /tmp/RtmpW7Mbc5/file199d3ed2f106
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3ed2f106...
#> /tmp/RtmpW7Mbc5/file199d3ed2f106
...
#> $build
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/episodes/introduction.md
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/episodes/introduction.md 2025-12-02
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/index.md                 2025-12-02
#> 
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpW7Mbc5/file199d3ed2f106/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
