...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpHGsTUG/file1a57351b9bba': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57351b9bba...
...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57351b9bba...
#> ☐ Edit /tmp/RtmpHGsTUG/file1a57351b9bba/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57351b9bba...
#> ✔ First episode created in /tmp/RtmpHGsTUG/file1a57351b9bba/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57351b9bba...
...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57351b9bba...
#> ✔ Lesson successfully created in /tmp/RtmpHGsTUG/file1a57351b9bba
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57351b9bba...
#> /tmp/RtmpHGsTUG/file1a57351b9bba
...
#> $build
#> /tmp/RtmpHGsTUG/file1a57351b9bba/episodes/introduction.md
#> /tmp/RtmpHGsTUG/file1a57351b9bba/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpHGsTUG/file1a57351b9bba/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpHGsTUG/file1a57351b9bba/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpHGsTUG/file1a57351b9bba/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpHGsTUG/file1a57351b9bba/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpHGsTUG/file1a57351b9bba/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpHGsTUG/file1a57351b9bba/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpHGsTUG/file1a57351b9bba/episodes/introduction.md 2026-05-19
#> /tmp/RtmpHGsTUG/file1a57351b9bba/index.md                 2026-05-19
#> 
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpHGsTUG/file1a57351b9bba/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpHGsTUG/file1a57351b9bba/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
