...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmpr0Li7l/file1cfd5ed01583': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd5ed01583...
...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd5ed01583...
#> ☐ Edit /tmp/Rtmpr0Li7l/file1cfd5ed01583/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd5ed01583...
#> ✔ First episode created in /tmp/Rtmpr0Li7l/file1cfd5ed01583/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd5ed01583...
...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd5ed01583...
#> ✔ Lesson successfully created in /tmp/Rtmpr0Li7l/file1cfd5ed01583
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd5ed01583...
#> /tmp/Rtmpr0Li7l/file1cfd5ed01583
...
#> $build
#> /tmp/Rtmpr0Li7l/file1cfd5ed01583/episodes/introduction.md
#> /tmp/Rtmpr0Li7l/file1cfd5ed01583/index.md
#> 
#> $new
#>                                              file
...
#>                                               built       date
#> episodes/introduction.md site/built/introduction.md 2026-09-15
#> index.md                        site/built/index.md 2026-09-15
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-09-15
#> 2        site/built/index.md 2026-09-15
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/Rtmpr0Li7l/file1cfd5ed01583/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/Rtmpr0Li7l/file1cfd5ed01583/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-09-15
#> 1        site/built/index.md 2026-09-15
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
