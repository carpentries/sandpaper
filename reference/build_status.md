...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpvfYpdV/file1ab479db1ebe': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab479db1ebe...
...
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab479db1ebe...
#> ☐ Edit /tmp/RtmpvfYpdV/file1ab479db1ebe/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab479db1ebe...
#> ✔ First episode created in /tmp/RtmpvfYpdV/file1ab479db1ebe/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab479db1ebe...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab479db1ebe...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab479db1ebe...
#> ✔ Lesson successfully created in /tmp/RtmpvfYpdV/file1ab479db1ebe
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab479db1ebe...
#> /tmp/RtmpvfYpdV/file1ab479db1ebe
...
#> $build
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/episodes/introduction.md
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/episodes/introduction.md 2026-02-28
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/index.md                 2026-02-28
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-02-28
#> 2        site/built/index.md 2026-02-28
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpvfYpdV/file1ab479db1ebe/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-02-28
#> 1        site/built/index.md 2026-02-28
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
