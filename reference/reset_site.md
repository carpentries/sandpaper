...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf4872d2...
...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf4872d2...
#> ☐ Edit /tmp/RtmpRhwHL2/file1ccf4872d2/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf4872d2...
#> ✔ First episode created in /tmp/RtmpRhwHL2/file1ccf4872d2/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf4872d2...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf4872d2...
#> ✔ Lesson successfully created in /tmp/RtmpRhwHL2/file1ccf4872d2
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf4872d2...
#> /tmp/RtmpRhwHL2/file1ccf4872d2
