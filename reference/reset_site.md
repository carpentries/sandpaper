...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0865db30cd...
...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0865db30cd...
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c0865db30cd/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0865db30cd...
#> ✔ First episode created in /tmp/RtmpG8rnQJ/file1c0865db30cd/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0865db30cd...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0865db30cd...
#> ✔ Lesson successfully created in /tmp/RtmpG8rnQJ/file1c0865db30cd
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0865db30cd...
#> /tmp/RtmpG8rnQJ/file1c0865db30cd
