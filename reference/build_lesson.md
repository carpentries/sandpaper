...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e65aea262...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e65aea262...
#> ☐ Edit /tmp/RtmpVcV2iC/file1b0e65aea262/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e65aea262...
#> ✔ First episode created in /tmp/RtmpVcV2iC/file1b0e65aea262/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e65aea262...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e65aea262...
#> ✔ Lesson successfully created in /tmp/RtmpVcV2iC/file1b0e65aea262
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e65aea262...
#> /tmp/RtmpVcV2iC/file1b0e65aea262
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpVcV2iC/file1b0e65aea262/episodes/first-script.Rmd.
#> /tmp/RtmpVcV2iC/file1b0e65aea262/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
