...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa252816b1f...
...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa252816b1f...
#> ☐ Edit /tmp/Rtmpw9vtxi/file1aa252816b1f/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa252816b1f...
#> ✔ First episode created in /tmp/Rtmpw9vtxi/file1aa252816b1f/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa252816b1f...
...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa252816b1f...
#> ✔ Lesson successfully created in /tmp/Rtmpw9vtxi/file1aa252816b1f
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa252816b1f...
#> /tmp/Rtmpw9vtxi/file1aa252816b1f
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmpw9vtxi/file1aa252816b1f/episodes/first-script.Rmd.
#> /tmp/Rtmpw9vtxi/file1aa252816b1f/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
