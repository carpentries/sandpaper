...
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae5fa1fbea...
...
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae5fa1fbea...
#> ☐ Edit /tmp/RtmpqRlAf5/file1aae5fa1fbea/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae5fa1fbea...
#> ✔ First episode created in /tmp/RtmpqRlAf5/file1aae5fa1fbea/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae5fa1fbea...
...
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae5fa1fbea...
#> ✔ Lesson successfully created in /tmp/RtmpqRlAf5/file1aae5fa1fbea
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae5fa1fbea...
#> /tmp/RtmpqRlAf5/file1aae5fa1fbea
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpqRlAf5/file1aae5fa1fbea/episodes/first-script.Rmd.
#> /tmp/RtmpqRlAf5/file1aae5fa1fbea/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
