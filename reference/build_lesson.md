...
#> → Creating Lesson in /tmp/RtmplVw70p/file19323ca7740f...
...
#> → Creating Lesson in /tmp/RtmplVw70p/file19323ca7740f...
#> ☐ Edit /tmp/RtmplVw70p/file19323ca7740f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmplVw70p/file19323ca7740f...
#> ✔ First episode created in /tmp/RtmplVw70p/file19323ca7740f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmplVw70p/file19323ca7740f...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmplVw70p/file19323ca7740f...
#> ✔ Lesson successfully created in /tmp/RtmplVw70p/file19323ca7740f
#> → Creating Lesson in /tmp/RtmplVw70p/file19323ca7740f...
#> /tmp/RtmplVw70p/file19323ca7740f
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmplVw70p/file19323ca7740f/episodes/first-script.Rmd.
#> /tmp/RtmplVw70p/file19323ca7740f/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
