...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc75438728...
...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc75438728...
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc75438728/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc75438728...
#> ✔ First episode created in /tmp/Rtmp4syuyP/file1cc75438728/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc75438728...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc75438728...
#> ✔ Lesson successfully created in /tmp/Rtmp4syuyP/file1cc75438728
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc75438728...
#> /tmp/Rtmp4syuyP/file1cc75438728
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc75438728/episodes/first-script.Rmd.
#> /tmp/Rtmp4syuyP/file1cc75438728/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
