...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf55db2602...
...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf55db2602...
#> ☐ Edit /tmp/RtmpRhwHL2/file1ccf55db2602/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf55db2602...
#> ✔ First episode created in /tmp/RtmpRhwHL2/file1ccf55db2602/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf55db2602...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf55db2602...
#> ✔ Lesson successfully created in /tmp/RtmpRhwHL2/file1ccf55db2602
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf55db2602...
#> /tmp/RtmpRhwHL2/file1ccf55db2602
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpRhwHL2/file1ccf55db2602/episodes/first-script.Rmd.
#> /tmp/RtmpRhwHL2/file1ccf55db2602/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
