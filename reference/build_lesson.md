...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bffa188aed...
...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bffa188aed...
#> ☐ Edit /tmp/RtmpuuNLIY/file1bffa188aed/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bffa188aed...
#> ✔ First episode created in /tmp/RtmpuuNLIY/file1bffa188aed/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bffa188aed...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bffa188aed...
#> ✔ Lesson successfully created in /tmp/RtmpuuNLIY/file1bffa188aed
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bffa188aed...
#> /tmp/RtmpuuNLIY/file1bffa188aed
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpuuNLIY/file1bffa188aed/episodes/first-script.Rmd.
#> /tmp/RtmpuuNLIY/file1bffa188aed/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
