...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942afcd0da...
...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942afcd0da...
#> ☐ Edit /tmp/Rtmpy7dRDl/file1942afcd0da/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942afcd0da...
#> ✔ First episode created in /tmp/Rtmpy7dRDl/file1942afcd0da/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942afcd0da...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942afcd0da...
#> ✔ Lesson successfully created in /tmp/Rtmpy7dRDl/file1942afcd0da
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942afcd0da...
#> /tmp/Rtmpy7dRDl/file1942afcd0da
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmpy7dRDl/file1942afcd0da/episodes/first-script.Rmd.
#> /tmp/Rtmpy7dRDl/file1942afcd0da/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
