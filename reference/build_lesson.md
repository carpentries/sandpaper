...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d24120bc8...
...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d24120bc8...
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d24120bc8/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d24120bc8...
#> ✔ First episode created in /tmp/RtmpFQ2hak/file1a5d24120bc8/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d24120bc8...
...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d24120bc8...
#> ✔ Lesson successfully created in /tmp/RtmpFQ2hak/file1a5d24120bc8
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d24120bc8...
#> /tmp/RtmpFQ2hak/file1a5d24120bc8
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d24120bc8/episodes/first-script.Rmd.
#> /tmp/RtmpFQ2hak/file1a5d24120bc8/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
