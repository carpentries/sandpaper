...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff642885b...
...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff642885b...
#> ☐ Edit /tmp/Rtmph9vhkW/file1bff642885b/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff642885b...
#> ✔ First episode created in /tmp/Rtmph9vhkW/file1bff642885b/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff642885b...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff642885b...
#> ✔ Lesson successfully created in /tmp/Rtmph9vhkW/file1bff642885b
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff642885b...
#> /tmp/Rtmph9vhkW/file1bff642885b
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmph9vhkW/file1bff642885b/episodes/first-script.Rmd.
#> /tmp/Rtmph9vhkW/file1bff642885b/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
