...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0550f3b180...
...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0550f3b180...
#> ☐ Edit /tmp/RtmptmNyLK/file1c0550f3b180/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0550f3b180...
#> ✔ First episode created in /tmp/RtmptmNyLK/file1c0550f3b180/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0550f3b180...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0550f3b180...
#> ✔ Lesson successfully created in /tmp/RtmptmNyLK/file1c0550f3b180
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0550f3b180...
#> /tmp/RtmptmNyLK/file1c0550f3b180
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmptmNyLK/file1c0550f3b180/episodes/first-script.Rmd.
#> /tmp/RtmptmNyLK/file1c0550f3b180/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
