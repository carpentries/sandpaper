...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a5773659351...
...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a5773659351...
#> ☐ Edit /tmp/RtmpHGsTUG/file1a5773659351/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a5773659351...
#> ✔ First episode created in /tmp/RtmpHGsTUG/file1a5773659351/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a5773659351...
...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a5773659351...
#> ✔ Lesson successfully created in /tmp/RtmpHGsTUG/file1a5773659351
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a5773659351...
#> /tmp/RtmpHGsTUG/file1a5773659351
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpHGsTUG/file1a5773659351/episodes/first-script.Rmd.
#> /tmp/RtmpHGsTUG/file1a5773659351/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
