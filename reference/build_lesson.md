...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe79b3c20f...
...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe79b3c20f...
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe79b3c20f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe79b3c20f...
#> ✔ First episode created in /tmp/RtmpL2X6sE/file1bfe79b3c20f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe79b3c20f...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe79b3c20f...
#> ✔ Lesson successfully created in /tmp/RtmpL2X6sE/file1bfe79b3c20f
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe79b3c20f...
#> /tmp/RtmpL2X6sE/file1bfe79b3c20f
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe79b3c20f/episodes/first-script.Rmd.
#> /tmp/RtmpL2X6sE/file1bfe79b3c20f/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
