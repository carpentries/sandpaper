...
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba22c6cfc...
...
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba22c6cfc...
#> ☐ Edit /tmp/RtmpQHhDUx/file1ba22c6cfc/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba22c6cfc...
#> ✔ First episode created in /tmp/RtmpQHhDUx/file1ba22c6cfc/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba22c6cfc...
...
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba22c6cfc...
#> ✔ Lesson successfully created in /tmp/RtmpQHhDUx/file1ba22c6cfc
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba22c6cfc...
#> /tmp/RtmpQHhDUx/file1ba22c6cfc
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpQHhDUx/file1ba22c6cfc/episodes/first-script.Rmd.
#> /tmp/RtmpQHhDUx/file1ba22c6cfc/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
