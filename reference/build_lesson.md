...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08363f335d...
...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08363f335d...
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c08363f335d/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08363f335d...
#> ✔ First episode created in /tmp/RtmpG8rnQJ/file1c08363f335d/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08363f335d...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08363f335d...
#> ✔ Lesson successfully created in /tmp/RtmpG8rnQJ/file1c08363f335d
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08363f335d...
#> /tmp/RtmpG8rnQJ/file1c08363f335d
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c08363f335d/episodes/first-script.Rmd.
#> /tmp/RtmpG8rnQJ/file1c08363f335d/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
