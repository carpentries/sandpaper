...
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5370fa208d...
...
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5370fa208d...
#> ☐ Edit /tmp/Rtmpf7ur3n/file1c5370fa208d/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5370fa208d...
#> ✔ First episode created in /tmp/Rtmpf7ur3n/file1c5370fa208d/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5370fa208d...
...
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5370fa208d...
#> ✔ Lesson successfully created in /tmp/Rtmpf7ur3n/file1c5370fa208d
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5370fa208d...
#> /tmp/Rtmpf7ur3n/file1c5370fa208d
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmpf7ur3n/file1c5370fa208d/episodes/first-script.Rmd.
#> /tmp/Rtmpf7ur3n/file1c5370fa208d/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
