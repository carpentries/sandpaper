...
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c0937490eab...
...
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c0937490eab...
#> ☐ Edit /tmp/Rtmp9LdTx2/file1c0937490eab/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c0937490eab...
#> ✔ First episode created in /tmp/Rtmp9LdTx2/file1c0937490eab/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c0937490eab...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c0937490eab...
#> ✔ Lesson successfully created in /tmp/Rtmp9LdTx2/file1c0937490eab
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c0937490eab...
#> /tmp/Rtmp9LdTx2/file1c0937490eab
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/Rtmp9LdTx2/file1c0937490eab/episodes/getting-started.md.
#> /tmp/Rtmp9LdTx2/file1c0937490eab/episodes/getting-started.md
```
