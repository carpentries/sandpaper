...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2218ef5...
...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2218ef5...
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d2218ef5/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2218ef5...
#> ✔ First episode created in /tmp/RtmpFQ2hak/file1a5d2218ef5/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2218ef5...
...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2218ef5...
#> ✔ Lesson successfully created in /tmp/RtmpFQ2hak/file1a5d2218ef5
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2218ef5...
#> /tmp/RtmpFQ2hak/file1a5d2218ef5
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d2218ef5/episodes/getting-started.md.
#> /tmp/RtmpFQ2hak/file1a5d2218ef5/episodes/getting-started.md
```
