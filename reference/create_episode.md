...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc72b438eae...
...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc72b438eae...
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc72b438eae/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc72b438eae...
#> ✔ First episode created in /tmp/Rtmp4syuyP/file1cc72b438eae/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc72b438eae...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc72b438eae...
#> ✔ Lesson successfully created in /tmp/Rtmp4syuyP/file1cc72b438eae
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc72b438eae...
#> /tmp/Rtmp4syuyP/file1cc72b438eae
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc72b438eae/episodes/getting-started.md.
#> /tmp/Rtmp4syuyP/file1cc72b438eae/episodes/getting-started.md
```
