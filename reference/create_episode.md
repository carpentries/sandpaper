...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe1d355444...
...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe1d355444...
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe1d355444/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe1d355444...
#> ✔ First episode created in /tmp/RtmpL2X6sE/file1bfe1d355444/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe1d355444...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe1d355444...
#> ✔ Lesson successfully created in /tmp/RtmpL2X6sE/file1bfe1d355444
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe1d355444...
#> /tmp/RtmpL2X6sE/file1bfe1d355444
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe1d355444/episodes/getting-started.md.
#> /tmp/RtmpL2X6sE/file1bfe1d355444/episodes/getting-started.md
```
