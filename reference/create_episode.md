...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e3caf8c84...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e3caf8c84...
#> ☐ Edit /tmp/RtmpVcV2iC/file1b0e3caf8c84/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e3caf8c84...
#> ✔ First episode created in /tmp/RtmpVcV2iC/file1b0e3caf8c84/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e3caf8c84...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e3caf8c84...
#> ✔ Lesson successfully created in /tmp/RtmpVcV2iC/file1b0e3caf8c84
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e3caf8c84...
#> /tmp/RtmpVcV2iC/file1b0e3caf8c84
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpVcV2iC/file1b0e3caf8c84/episodes/getting-started.md.
#> /tmp/RtmpVcV2iC/file1b0e3caf8c84/episodes/getting-started.md
```
