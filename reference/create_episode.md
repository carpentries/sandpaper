...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08745dcb02...
...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08745dcb02...
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c08745dcb02/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08745dcb02...
#> ✔ First episode created in /tmp/RtmpG8rnQJ/file1c08745dcb02/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08745dcb02...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08745dcb02...
#> ✔ Lesson successfully created in /tmp/RtmpG8rnQJ/file1c08745dcb02
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c08745dcb02...
#> /tmp/RtmpG8rnQJ/file1c08745dcb02
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c08745dcb02/episodes/getting-started.md.
#> /tmp/RtmpG8rnQJ/file1c08745dcb02/episodes/getting-started.md
```
