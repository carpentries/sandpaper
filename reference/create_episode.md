...
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5490e4ee6...
...
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5490e4ee6...
#> ☐ Edit /tmp/RtmppZSt3g/file1be5490e4ee6/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5490e4ee6...
#> ✔ First episode created in /tmp/RtmppZSt3g/file1be5490e4ee6/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5490e4ee6...
...
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5490e4ee6...
#> ✔ Lesson successfully created in /tmp/RtmppZSt3g/file1be5490e4ee6
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5490e4ee6...
#> /tmp/RtmppZSt3g/file1be5490e4ee6
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmppZSt3g/file1be5490e4ee6/episodes/getting-started.md.
#> /tmp/RtmppZSt3g/file1be5490e4ee6/episodes/getting-started.md
```
