...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01495c082f...
...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01495c082f...
#> ☐ Edit /tmp/RtmpNIRNTg/file1c01495c082f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01495c082f...
#> ✔ First episode created in /tmp/RtmpNIRNTg/file1c01495c082f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01495c082f...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01495c082f...
#> ✔ Lesson successfully created in /tmp/RtmpNIRNTg/file1c01495c082f
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01495c082f...
#> /tmp/RtmpNIRNTg/file1c01495c082f
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpNIRNTg/file1c01495c082f/episodes/getting-started.md.
#> /tmp/RtmpNIRNTg/file1c01495c082f/episodes/getting-started.md
```
