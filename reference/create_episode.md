...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff987dedc...
...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff987dedc...
#> ☐ Edit /tmp/Rtmph9vhkW/file1bff987dedc/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff987dedc...
#> ✔ First episode created in /tmp/Rtmph9vhkW/file1bff987dedc/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff987dedc...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff987dedc...
#> ✔ Lesson successfully created in /tmp/Rtmph9vhkW/file1bff987dedc
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff987dedc...
#> /tmp/Rtmph9vhkW/file1bff987dedc
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/Rtmph9vhkW/file1bff987dedc/episodes/getting-started.md.
#> /tmp/Rtmph9vhkW/file1bff987dedc/episodes/getting-started.md
```
