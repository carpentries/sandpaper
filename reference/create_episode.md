...
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfef558702...
...
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfef558702...
#> ☐ Edit /tmp/RtmpHkg0h5/file1bfef558702/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfef558702...
#> ✔ First episode created in /tmp/RtmpHkg0h5/file1bfef558702/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfef558702...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfef558702...
#> ✔ Lesson successfully created in /tmp/RtmpHkg0h5/file1bfef558702
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfef558702...
#> /tmp/RtmpHkg0h5/file1bfef558702
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpHkg0h5/file1bfef558702/episodes/getting-started.md.
#> /tmp/RtmpHkg0h5/file1bfef558702/episodes/getting-started.md
```
