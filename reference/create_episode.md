...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57587e68af...
...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57587e68af...
#> ☐ Edit /tmp/RtmpHGsTUG/file1a57587e68af/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57587e68af...
#> ✔ First episode created in /tmp/RtmpHGsTUG/file1a57587e68af/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57587e68af...
...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57587e68af...
#> ✔ Lesson successfully created in /tmp/RtmpHGsTUG/file1a57587e68af
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57587e68af...
#> /tmp/RtmpHGsTUG/file1a57587e68af
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpHGsTUG/file1a57587e68af/episodes/getting-started.md.
#> /tmp/RtmpHGsTUG/file1a57587e68af/episodes/getting-started.md
```
