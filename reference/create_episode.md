...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194252e98143...
...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194252e98143...
#> ☐ Edit /tmp/Rtmpy7dRDl/file194252e98143/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194252e98143...
#> ✔ First episode created in /tmp/Rtmpy7dRDl/file194252e98143/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194252e98143...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194252e98143...
#> ✔ Lesson successfully created in /tmp/Rtmpy7dRDl/file194252e98143
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194252e98143...
#> /tmp/Rtmpy7dRDl/file194252e98143
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/Rtmpy7dRDl/file194252e98143/episodes/getting-started.md.
#> /tmp/Rtmpy7dRDl/file194252e98143/episodes/getting-started.md
```
