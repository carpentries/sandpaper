...
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c62213856...
...
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c62213856...
#> ☐ Edit /tmp/RtmpZEO1dD/file1c0c62213856/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c62213856...
#> ✔ First episode created in /tmp/RtmpZEO1dD/file1c0c62213856/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c62213856...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c62213856...
#> ✔ Lesson successfully created in /tmp/RtmpZEO1dD/file1c0c62213856
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c62213856...
#> /tmp/RtmpZEO1dD/file1c0c62213856
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpZEO1dD/file1c0c62213856/episodes/getting-started.md.
#> /tmp/RtmpZEO1dD/file1c0c62213856/episodes/getting-started.md
```
