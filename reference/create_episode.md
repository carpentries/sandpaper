...
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae1c1a665a...
...
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae1c1a665a...
#> ☐ Edit /tmp/RtmpqRlAf5/file1aae1c1a665a/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae1c1a665a...
#> ✔ First episode created in /tmp/RtmpqRlAf5/file1aae1c1a665a/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae1c1a665a...
...
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae1c1a665a...
#> ✔ Lesson successfully created in /tmp/RtmpqRlAf5/file1aae1c1a665a
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae1c1a665a...
#> /tmp/RtmpqRlAf5/file1aae1c1a665a
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpqRlAf5/file1aae1c1a665a/episodes/getting-started.md.
#> /tmp/RtmpqRlAf5/file1aae1c1a665a/episodes/getting-started.md
```
