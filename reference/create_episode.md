...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff3f5bde44...
...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff3f5bde44...
#> ☐ Edit /tmp/RtmpuuNLIY/file1bff3f5bde44/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff3f5bde44...
#> ✔ First episode created in /tmp/RtmpuuNLIY/file1bff3f5bde44/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff3f5bde44...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff3f5bde44...
#> ✔ Lesson successfully created in /tmp/RtmpuuNLIY/file1bff3f5bde44
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff3f5bde44...
#> /tmp/RtmpuuNLIY/file1bff3f5bde44
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpuuNLIY/file1bff3f5bde44/episodes/getting-started.md.
#> /tmp/RtmpuuNLIY/file1bff3f5bde44/episodes/getting-started.md
```
