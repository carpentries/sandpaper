...
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4125bd8c0...
...
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4125bd8c0...
#> ☐ Edit /tmp/RtmpvfYpdV/file1ab4125bd8c0/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4125bd8c0...
#> ✔ First episode created in /tmp/RtmpvfYpdV/file1ab4125bd8c0/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4125bd8c0...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4125bd8c0...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4125bd8c0...
#> ✔ Lesson successfully created in /tmp/RtmpvfYpdV/file1ab4125bd8c0
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4125bd8c0...
#> /tmp/RtmpvfYpdV/file1ab4125bd8c0
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpvfYpdV/file1ab4125bd8c0/episodes/getting-started.md.
#> /tmp/RtmpvfYpdV/file1ab4125bd8c0/episodes/getting-started.md
```
