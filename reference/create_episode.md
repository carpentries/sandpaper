...
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf351349a32...
...
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf351349a32...
#> ☐ Edit /tmp/Rtmpfmukg6/file1bf351349a32/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf351349a32...
#> ✔ First episode created in /tmp/Rtmpfmukg6/file1bf351349a32/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf351349a32...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf351349a32...
#> ✔ Lesson successfully created in /tmp/Rtmpfmukg6/file1bf351349a32
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf351349a32...
#> /tmp/Rtmpfmukg6/file1bf351349a32
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/Rtmpfmukg6/file1bf351349a32/episodes/getting-started.md.
#> /tmp/Rtmpfmukg6/file1bf351349a32/episodes/getting-started.md
```
