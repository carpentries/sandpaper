...
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b362110a681...
...
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b362110a681...
#> ☐ Edit /tmp/RtmpMXjarq/file1b362110a681/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b362110a681...
#> ✔ First episode created in /tmp/RtmpMXjarq/file1b362110a681/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b362110a681...
...
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b362110a681...
#> ✔ Lesson successfully created in /tmp/RtmpMXjarq/file1b362110a681
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b362110a681...
#> /tmp/RtmpMXjarq/file1b362110a681
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpMXjarq/file1b362110a681/episodes/getting-started.md.
#> /tmp/RtmpMXjarq/file1b362110a681/episodes/getting-started.md
```
