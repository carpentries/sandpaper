...
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3811024975...
...
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3811024975...
#> ☐ Edit /tmp/RtmprvyUoW/file1c3811024975/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3811024975...
#> ✔ First episode created in /tmp/RtmprvyUoW/file1c3811024975/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3811024975...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3811024975...
#> ✔ Lesson successfully created in /tmp/RtmprvyUoW/file1c3811024975
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3811024975...
#> /tmp/RtmprvyUoW/file1c3811024975
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmprvyUoW/file1c3811024975/episodes/getting-started.md.
#> /tmp/RtmprvyUoW/file1c3811024975/episodes/getting-started.md
```
