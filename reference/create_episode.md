...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d5e5de37f...
...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d5e5de37f...
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d5e5de37f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d5e5de37f...
#> ✔ First episode created in /tmp/RtmpYhnOfg/file1a1d5e5de37f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d5e5de37f...
...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d5e5de37f...
#> ✔ Lesson successfully created in /tmp/RtmpYhnOfg/file1a1d5e5de37f
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d5e5de37f...
#> /tmp/RtmpYhnOfg/file1a1d5e5de37f
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d5e5de37f/episodes/getting-started.md.
#> /tmp/RtmpYhnOfg/file1a1d5e5de37f/episodes/getting-started.md
```
