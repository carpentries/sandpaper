...
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba232c109a3...
...
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba232c109a3...
#> ☐ Edit /tmp/RtmpQHhDUx/file1ba232c109a3/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba232c109a3...
#> ✔ First episode created in /tmp/RtmpQHhDUx/file1ba232c109a3/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba232c109a3...
...
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba232c109a3...
#> ✔ Lesson successfully created in /tmp/RtmpQHhDUx/file1ba232c109a3
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba232c109a3...
#> /tmp/RtmpQHhDUx/file1ba232c109a3
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpQHhDUx/file1ba232c109a3/episodes/getting-started.md.
#> /tmp/RtmpQHhDUx/file1ba232c109a3/episodes/getting-started.md
```
