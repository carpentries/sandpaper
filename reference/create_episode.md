...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf2947da1b...
...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf2947da1b...
#> ☐ Edit /tmp/RtmpRhwHL2/file1ccf2947da1b/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf2947da1b...
#> ✔ First episode created in /tmp/RtmpRhwHL2/file1ccf2947da1b/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf2947da1b...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf2947da1b...
#> ✔ Lesson successfully created in /tmp/RtmpRhwHL2/file1ccf2947da1b
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf2947da1b...
#> /tmp/RtmpRhwHL2/file1ccf2947da1b
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpRhwHL2/file1ccf2947da1b/episodes/getting-started.md.
#> /tmp/RtmpRhwHL2/file1ccf2947da1b/episodes/getting-started.md
```
