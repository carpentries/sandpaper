...
#> → Creating Lesson in /tmp/RtmpMShUNW/file1932702bbb9d...
...
#> → Creating Lesson in /tmp/RtmpMShUNW/file1932702bbb9d...
#> ☐ Edit /tmp/RtmpMShUNW/file1932702bbb9d/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpMShUNW/file1932702bbb9d...
#> ✔ First episode created in /tmp/RtmpMShUNW/file1932702bbb9d/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpMShUNW/file1932702bbb9d...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpMShUNW/file1932702bbb9d...
#> ✔ Lesson successfully created in /tmp/RtmpMShUNW/file1932702bbb9d
#> → Creating Lesson in /tmp/RtmpMShUNW/file1932702bbb9d...
#> /tmp/RtmpMShUNW/file1932702bbb9d
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpMShUNW/file1932702bbb9d/episodes/getting-started.md.
#> /tmp/RtmpMShUNW/file1932702bbb9d/episodes/getting-started.md
```
