...
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c08383fccb2...
...
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c08383fccb2...
#> ☐ Edit /tmp/Rtmpgc9t3l/file1c08383fccb2/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c08383fccb2...
#> ✔ First episode created in /tmp/Rtmpgc9t3l/file1c08383fccb2/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c08383fccb2...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c08383fccb2...
#> ✔ Lesson successfully created in /tmp/Rtmpgc9t3l/file1c08383fccb2
#> → Creating Lesson in /tmp/Rtmpgc9t3l/file1c08383fccb2...
#> /tmp/Rtmpgc9t3l/file1c08383fccb2
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/Rtmpgc9t3l/file1c08383fccb2/episodes/getting-started.md.
#> /tmp/Rtmpgc9t3l/file1c08383fccb2/episodes/getting-started.md
```
