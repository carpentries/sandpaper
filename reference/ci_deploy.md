...
#> ℹ Lesson bootstrapped in 3.193357 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01373219 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.24 seconds
...
#>   name                 commit                        updated            
#>   <chr>                <chr>                         <dttm>             
#> 1 main                 b5ada9583ee77e56daeeeecd4c83… 2026-01-17 14:46:35
#> 2 sandpaper-local/main b5ada9583ee77e56daeeeecd4c83… 2026-01-17 14:46:35
...
#> 1 episodes/introd… 2026-01-17 14:46:35 2026-01-17 14:46:35       1 b5ad…
...
#> [md-outputs (root-commit) abcac6d] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpqJUIxl/REMOTE-1c595d7d2d1a
...
#> From /tmp/RtmpqJUIxl/REMOTE-1c595d7d2d1a
...
#>   /tmp/RtmpqJUIxl/file1c59463092c8/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at abcac6d)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at abcac6d Initializing md-outputs branch
#> ::endgroup::
...
#> 
#> 
#> processing file: /tmp/RtmpqJUIxl/file1c59463092c8/lesson-example/episodes/introduction.Rmd
#> 1/3          
#> 2/3 [pyramid]
#> 3/3          
#> output file: /tmp/RtmpqJUIxl/file1c59463092c8/lesson-example/site/built/introduction.md
#> 
#> ::endgroup::
...
#> Source  : b5ada9583ee77e56daeeeecd4c834dd4c9fa1ff8
#> Branch  : main
#> Author  : carpenter <team@carpentries.org>
#> Time    : 2026-01-17 14:46:35 +0000
#> Message : Initial commit [via `{sandpaper}`]
#> '
#> [md-outputs 71fa0a4] markdown source builds
...
#> sandpaper-local  /tmp/RtmpqJUIxl/REMOTE-1c595d7d2d1a (fetch)
#> sandpaper-local  /tmp/RtmpqJUIxl/REMOTE-1c595d7d2d1a (push)
#> Running git push --force sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpqJUIxl/REMOTE-1c595d7d2d1a
#>    abcac6d..71fa0a4  HEAD -> md-outputs
#> ::endgroup::
#> ::group::Create New Branch
...
#> [gh-pages (root-commit) adf7448] Initializing gh-pages branch
...
#>   /tmp/RtmpqJUIxl/file1c59463092c8/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at adf7448)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at adf7448 Initializing gh-pages branch
#> ::endgroup::
...
#> ══ Validating cff ══════════════════════════════════════════════════════
#> ✔ Congratulations! /tmp/RtmpqJUIxl/file1c59463092c8/lesson-example/CITATION.cff is valid
...
#> 
#> Output created: /tmp/RtmpqJUIxl/file1c59463092c8/lesson-example/site/docs/index.html
#> ::endgroup::
...
#> 
#> Auto-generated via `{sandpaper}`
#> Source  : 71fa0a47c4d2fa65b5225c39c3e6056280c6ee44
#> Branch  : md-outputs
#> Author  : GitHub Actions <actions@github.com>
#> Time    : 2026-01-17 14:46:39 +0000
...
#>   name                       commit                  updated            
#>   <chr>                      <chr>                   <dttm>             
#> 1 gh-pages                   0bab6026db4b442d96c20d… 2026-01-17 14:46:51
#> 2 main                       b5ada9583ee77e56daeeee… 2026-01-17 14:46:35
#> 3 md-outputs                 71fa0a47c4d2fa65b5225c… 2026-01-17 14:46:39
#> 4 sandpaper-local/gh-pages   0bab6026db4b442d96c20d… 2026-01-17 14:46:51
#> 5 sandpaper-local/main       b5ada9583ee77e56daeeee… 2026-01-17 14:46:35
#> 6 sandpaper-local/md-outputs 71fa0a47c4d2fa65b5225c… 2026-01-17 14:46:39
...
#>   file            created             modified            commits head  
#> * <chr>           <dttm>              <dttm>                <int> <chr> 
#> 1 introduction.md 2026-01-17 14:46:39 2026-01-17 14:46:39       1 71fa0…
...
#>   file             created             modified            commits head 
#> * <chr>            <dttm>              <dttm>                <int> <chr>
#> 1 introduction.ht… 2026-01-17 14:46:51 2026-01-17 14:46:51       1 0bab…
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpqJUIxl/REMOTE-1c595d7d2d1a)
#> /tmp/RtmpqJUIxl/REMOTE-1c595d7d2d1a
