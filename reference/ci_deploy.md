...
#> ℹ Lesson bootstrapped in 3.367056 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01387811 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.41 seconds
...
#>   name                 commit                        updated            
#>   <chr>                <chr>                         <dttm>             
#> 1 main                 60892de174c45bef14fece5a8cb6… 2026-01-17 23:01:03
#> 2 sandpaper-local/main 60892de174c45bef14fece5a8cb6… 2026-01-17 23:01:03
...
#> 1 episodes/introd… 2026-01-17 23:01:03 2026-01-17 23:01:03       1 6089…
...
#> [md-outputs (root-commit) 593f40c] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/Rtmpfmukg6/REMOTE-1bf3d7a9211
...
#> From /tmp/Rtmpfmukg6/REMOTE-1bf3d7a9211
...
#>   /tmp/Rtmpfmukg6/file1bf3d2e950a/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 593f40c)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 593f40c Initializing md-outputs branch
#> ::endgroup::
...
#> 
#> 
#> processing file: /tmp/Rtmpfmukg6/file1bf3d2e950a/lesson-example/episodes/introduction.Rmd
#> 1/3          
#> 2/3 [pyramid]
#> 3/3          
#> output file: /tmp/Rtmpfmukg6/file1bf3d2e950a/lesson-example/site/built/introduction.md
#> 
#> ::endgroup::
...
#> Source  : 60892de174c45bef14fece5a8cb6ddfb738ba7ae
#> Branch  : main
#> Author  : carpenter <team@carpentries.org>
#> Time    : 2026-01-17 23:01:03 +0000
#> Message : Initial commit [via `{sandpaper}`]
#> '
#> [md-outputs 3fde716] markdown source builds
...
#> sandpaper-local  /tmp/Rtmpfmukg6/REMOTE-1bf3d7a9211 (fetch)
#> sandpaper-local  /tmp/Rtmpfmukg6/REMOTE-1bf3d7a9211 (push)
#> Running git push --force sandpaper-local 'HEAD:md-outputs'
#> To /tmp/Rtmpfmukg6/REMOTE-1bf3d7a9211
#>    593f40c..3fde716  HEAD -> md-outputs
#> ::endgroup::
#> ::group::Create New Branch
...
#> [gh-pages (root-commit) 131bd78] Initializing gh-pages branch
...
#>   /tmp/Rtmpfmukg6/file1bf3d2e950a/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 131bd78)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 131bd78 Initializing gh-pages branch
#> ::endgroup::
...
#> ══ Validating cff ══════════════════════════════════════════════════════
#> ✔ Congratulations! /tmp/Rtmpfmukg6/file1bf3d2e950a/lesson-example/CITATION.cff is valid
...
#> 
#> Output created: /tmp/Rtmpfmukg6/file1bf3d2e950a/lesson-example/site/docs/index.html
#> ::endgroup::
...
#> 
#> Auto-generated via `{sandpaper}`
#> Source  : 3fde7166d3690eef2551a362cfa6b950a6908f2a
#> Branch  : md-outputs
#> Author  : GitHub Actions <actions@github.com>
#> Time    : 2026-01-17 23:01:07 +0000
...
#>   name                       commit                  updated            
#>   <chr>                      <chr>                   <dttm>             
#> 1 gh-pages                   8cb553cbc57f0a86f58395… 2026-01-17 23:01:18
#> 2 main                       60892de174c45bef14fece… 2026-01-17 23:01:03
#> 3 md-outputs                 3fde7166d3690eef2551a3… 2026-01-17 23:01:07
#> 4 sandpaper-local/gh-pages   8cb553cbc57f0a86f58395… 2026-01-17 23:01:18
#> 5 sandpaper-local/main       60892de174c45bef14fece… 2026-01-17 23:01:03
#> 6 sandpaper-local/md-outputs 3fde7166d3690eef2551a3… 2026-01-17 23:01:07
...
#>   file            created             modified            commits head  
#> * <chr>           <dttm>              <dttm>                <int> <chr> 
#> 1 introduction.md 2026-01-17 23:01:07 2026-01-17 23:01:07       1 3fde7…
...
#>   file             created             modified            commits head 
#> * <chr>            <dttm>              <dttm>                <int> <chr>
#> 1 introduction.ht… 2026-01-17 23:01:18 2026-01-17 23:01:18       1 8cb5…
...
#> ℹ removing 'sandpaper-local' (/tmp/Rtmpfmukg6/REMOTE-1bf3d7a9211)
#> /tmp/Rtmpfmukg6/REMOTE-1bf3d7a9211
