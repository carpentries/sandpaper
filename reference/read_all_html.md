...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpszXVxM/file1be6193cf19': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpszXVxM/file1be6193cf19/index.html
#> /tmp/RtmpszXVxM/file1be6193cf19/instructor/index.html
#> 
```
