...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmppZSt3g/file1be522adfcb8': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmppZSt3g/file1be522adfcb8/index.html
#> /tmp/RtmppZSt3g/file1be522adfcb8/instructor/index.html
#> 
```
