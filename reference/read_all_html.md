...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmph9vhkW/file1bff74aaec14': no such file or directory
...
#> 
#> $paths
#> /tmp/Rtmph9vhkW/file1bff74aaec14/index.html
#> /tmp/Rtmph9vhkW/file1bff74aaec14/instructor/index.html
#> 
```
