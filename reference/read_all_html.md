...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpuuNLIY/file1bff7afaf7aa': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpuuNLIY/file1bff7afaf7aa/index.html
#> /tmp/RtmpuuNLIY/file1bff7afaf7aa/instructor/index.html
#> 
```
