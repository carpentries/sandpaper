...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpNIRNTg/file1c012bb4e976': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpNIRNTg/file1c012bb4e976/index.html
#> /tmp/RtmpNIRNTg/file1c012bb4e976/instructor/index.html
#> 
```
