...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmpfmukg6/file1bf329d12e7f': no such file or directory
...
#> 
#> $paths
#> /tmp/Rtmpfmukg6/file1bf329d12e7f/index.html
#> /tmp/Rtmpfmukg6/file1bf329d12e7f/instructor/index.html
#> 
```
