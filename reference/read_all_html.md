...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpYhnOfg/file1a1d7aaddfbc': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpYhnOfg/file1a1d7aaddfbc/index.html
#> /tmp/RtmpYhnOfg/file1a1d7aaddfbc/instructor/index.html
#> 
```
