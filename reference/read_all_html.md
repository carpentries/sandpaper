...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmpy7dRDl/file194212c68f58': no such file or directory
...
#> 
#> $paths
#> /tmp/Rtmpy7dRDl/file194212c68f58/index.html
#> /tmp/Rtmpy7dRDl/file194212c68f58/instructor/index.html
#> 
```
