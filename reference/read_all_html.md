...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpFQ2hak/file1a5d700834cd': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpFQ2hak/file1a5d700834cd/index.html
#> /tmp/RtmpFQ2hak/file1a5d700834cd/instructor/index.html
#> 
```
