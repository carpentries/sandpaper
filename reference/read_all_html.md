...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpqRlAf5/file1aae3d01ddf8': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpqRlAf5/file1aae3d01ddf8/index.html
#> /tmp/RtmpqRlAf5/file1aae3d01ddf8/instructor/index.html
#> 
```
