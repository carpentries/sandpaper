...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmptmNyLK/file1c05381f39d9': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmptmNyLK/file1c05381f39d9/index.html
#> /tmp/RtmptmNyLK/file1c05381f39d9/instructor/index.html
#> 
```
