...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpMXjarq/file1b36427f419b': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpMXjarq/file1b36427f419b/index.html
#> /tmp/RtmpMXjarq/file1b36427f419b/instructor/index.html
#> 
```
