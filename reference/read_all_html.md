...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpHGsTUG/file1a5764aeb56e': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpHGsTUG/file1a5764aeb56e/index.html
#> /tmp/RtmpHGsTUG/file1a5764aeb56e/instructor/index.html
#> 
```
