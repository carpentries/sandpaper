...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpRhwHL2/file1ccf7c1a4ec6': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpRhwHL2/file1ccf7c1a4ec6/index.html
#> /tmp/RtmpRhwHL2/file1ccf7c1a4ec6/instructor/index.html
#> 
```
