...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmplVw70p/file19323889da37': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmplVw70p/file19323889da37/index.html
#> /tmp/RtmplVw70p/file19323889da37/instructor/index.html
#> 
```
