...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpHkg0h5/file1bfe25d1e8ae': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpHkg0h5/file1bfe25d1e8ae/index.html
#> /tmp/RtmpHkg0h5/file1bfe25d1e8ae/instructor/index.html
#> 
```
