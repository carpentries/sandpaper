...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpQHhDUx/file1ba26d1a205': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpQHhDUx/file1ba26d1a205/index.html
#> /tmp/RtmpQHhDUx/file1ba26d1a205/instructor/index.html
#> 
```
