...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpL2X6sE/file1bfe166b4026': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpL2X6sE/file1bfe166b4026/index.html
#> /tmp/RtmpL2X6sE/file1bfe166b4026/instructor/index.html
#> 
```
