...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1e92c540...
...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1e92c540...
#> ☐ Edit /tmp/RtmpRhwHL2/file1ccf1e92c540/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1e92c540...
#> ✔ First episode created in /tmp/RtmpRhwHL2/file1ccf1e92c540/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1e92c540...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1e92c540...
#> ✔ Lesson successfully created in /tmp/RtmpRhwHL2/file1ccf1e92c540
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1e92c540...
#> /tmp/RtmpRhwHL2/file1ccf1e92c540
...
#>     overview: FALSE
#>     path: /tmp/RtmpRhwHL2/file1ccf1e92c540
#>     reset: function () 
#>     rmd: FALSE
#>     sandpaper: TRUE
