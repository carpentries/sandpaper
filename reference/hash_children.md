...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpFQ2hak/file1a5d2eb6f76f': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2eb6f76f...
...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2eb6f76f...
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d2eb6f76f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2eb6f76f...
#> ✔ First episode created in /tmp/RtmpFQ2hak/file1a5d2eb6f76f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2eb6f76f...
...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2eb6f76f...
#> ✔ Lesson successfully created in /tmp/RtmpFQ2hak/file1a5d2eb6f76f
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d2eb6f76f...
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f
...
#> [1] "/tmp/RtmpFQ2hak/file1a5d2eb6f76f/episodes/introduction.Rmd"
#> [2] "/tmp/RtmpFQ2hak/file1a5d2eb6f76f/episodes/files/hi.md"     
#> 
#> $CODE_OF_CONDUCT.md
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/CODE_OF_CONDUCT.md
#> 
#> $CONTRIBUTING.md
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/CONTRIBUTING.md
#> 
#> $LICENSE.md
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/LICENSE.md
#> 
#> $README.md
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/README.md
#> 
#> $index.md
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/index.md
#> 
#> $links.md
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/links.md
#> 
#> $`instructors/instructor-notes.md`
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/instructors/instructor-notes.md
#> 
#> $`learners/reference.md`
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/learners/reference.md
#> 
#> $`learners/setup.md`
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/learners/setup.md
#> 
#> $`profiles/learner-profiles.md`
#> /tmp/RtmpFQ2hak/file1a5d2eb6f76f/profiles/learner-profiles.md
#> 
