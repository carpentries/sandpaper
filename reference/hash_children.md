...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpW7Mbc5/file199d3bbaba96': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3bbaba96...
...
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3bbaba96...
#> ☐ Edit /tmp/RtmpW7Mbc5/file199d3bbaba96/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3bbaba96...
#> ✔ First episode created in /tmp/RtmpW7Mbc5/file199d3bbaba96/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3bbaba96...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3bbaba96...
#> ✔ Lesson successfully created in /tmp/RtmpW7Mbc5/file199d3bbaba96
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d3bbaba96...
#> /tmp/RtmpW7Mbc5/file199d3bbaba96
...
#> [1] "/tmp/RtmpW7Mbc5/file199d3bbaba96/episodes/introduction.Rmd"
#> [2] "/tmp/RtmpW7Mbc5/file199d3bbaba96/episodes/files/hi.md"     
#> 
#> $CODE_OF_CONDUCT.md
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/CODE_OF_CONDUCT.md
#> 
#> $CONTRIBUTING.md
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/CONTRIBUTING.md
#> 
#> $LICENSE.md
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/LICENSE.md
#> 
#> $README.md
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/README.md
#> 
#> $index.md
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/index.md
#> 
#> $links.md
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/links.md
#> 
#> $`instructors/instructor-notes.md`
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/instructors/instructor-notes.md
#> 
#> $`learners/reference.md`
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/learners/reference.md
#> 
#> $`learners/setup.md`
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/learners/setup.md
#> 
#> $`profiles/learner-profiles.md`
#> /tmp/RtmpW7Mbc5/file199d3bbaba96/profiles/learner-profiles.md
#> 
