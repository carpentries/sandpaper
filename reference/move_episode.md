...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d7b9d2a08...
...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d7b9d2a08...
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d7b9d2a08/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d7b9d2a08...
#> ✔ First episode created in /tmp/RtmpFQ2hak/file1a5d7b9d2a08/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d7b9d2a08...
...
#> - R             [* -> 4.6.0]
#> 
#> - Lockfile written to "/tmp/RtmpFQ2hak/file1a5d7b9d2a08/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpFQ2hak/file1a5d7b9d2a08
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d7b9d2a08...
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d7b9d2a08/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d7b9d2a08/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d7b9d2a08/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
