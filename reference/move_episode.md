...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc76de3bf81...
...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc76de3bf81...
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc76de3bf81/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc76de3bf81...
#> ✔ First episode created in /tmp/Rtmp4syuyP/file1cc76de3bf81/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc76de3bf81...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/Rtmp4syuyP/file1cc76de3bf81/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmp4syuyP/file1cc76de3bf81
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc76de3bf81...
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc76de3bf81/episodes/getting-started.md.
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc76de3bf81/episodes/plotting.Rmd.
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc76de3bf81/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
