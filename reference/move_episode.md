...
#> → Creating Lesson in /tmp/RtmplVw70p/file1932adae60a...
...
#> → Creating Lesson in /tmp/RtmplVw70p/file1932adae60a...
#> ☐ Edit /tmp/RtmplVw70p/file1932adae60a/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmplVw70p/file1932adae60a...
#> ✔ First episode created in /tmp/RtmplVw70p/file1932adae60a/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmplVw70p/file1932adae60a...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmplVw70p/file1932adae60a/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmplVw70p/file1932adae60a
#> → Creating Lesson in /tmp/RtmplVw70p/file1932adae60a...
#> ☐ Edit /tmp/RtmplVw70p/file1932adae60a/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmplVw70p/file1932adae60a/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmplVw70p/file1932adae60a/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
