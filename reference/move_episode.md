...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01671c1f80...
...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01671c1f80...
#> ☐ Edit /tmp/RtmpNIRNTg/file1c01671c1f80/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01671c1f80...
#> ✔ First episode created in /tmp/RtmpNIRNTg/file1c01671c1f80/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01671c1f80...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpNIRNTg/file1c01671c1f80/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpNIRNTg/file1c01671c1f80
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01671c1f80...
#> ☐ Edit /tmp/RtmpNIRNTg/file1c01671c1f80/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpNIRNTg/file1c01671c1f80/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpNIRNTg/file1c01671c1f80/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
