...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3ed8ccb7...
...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3ed8ccb7...
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe3ed8ccb7/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3ed8ccb7...
#> ✔ First episode created in /tmp/RtmpL2X6sE/file1bfe3ed8ccb7/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3ed8ccb7...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpL2X6sE/file1bfe3ed8ccb7/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpL2X6sE/file1bfe3ed8ccb7
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3ed8ccb7...
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe3ed8ccb7/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe3ed8ccb7/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe3ed8ccb7/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
