...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd634783d6...
...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd634783d6...
#> ☐ Edit /tmp/Rtmpr0Li7l/file1cfd634783d6/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd634783d6...
#> ✔ First episode created in /tmp/Rtmpr0Li7l/file1cfd634783d6/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd634783d6...
...
#> - R             [* -> 4.6.1]
#> 
#> - Lockfile written to "/tmp/Rtmpr0Li7l/file1cfd634783d6/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmpr0Li7l/file1cfd634783d6
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd634783d6...
#> ☐ Edit /tmp/Rtmpr0Li7l/file1cfd634783d6/episodes/getting-started.md.
#> ☐ Edit /tmp/Rtmpr0Li7l/file1cfd634783d6/episodes/plotting.Rmd.
#> ☐ Edit /tmp/Rtmpr0Li7l/file1cfd634783d6/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
