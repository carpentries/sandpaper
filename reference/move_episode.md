...
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c593a8829d4...
...
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c593a8829d4...
#> ☐ Edit /tmp/RtmpqJUIxl/file1c593a8829d4/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c593a8829d4...
#> ✔ First episode created in /tmp/RtmpqJUIxl/file1c593a8829d4/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c593a8829d4...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpqJUIxl/file1c593a8829d4/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpqJUIxl/file1c593a8829d4
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c593a8829d4...
#> ☐ Edit /tmp/RtmpqJUIxl/file1c593a8829d4/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpqJUIxl/file1c593a8829d4/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpqJUIxl/file1c593a8829d4/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
