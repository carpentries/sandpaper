...
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be62142821d...
...
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be62142821d...
#> ☐ Edit /tmp/RtmpszXVxM/file1be62142821d/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be62142821d...
#> ✔ First episode created in /tmp/RtmpszXVxM/file1be62142821d/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be62142821d...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpszXVxM/file1be62142821d/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpszXVxM/file1be62142821d
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be62142821d...
#> ☐ Edit /tmp/RtmpszXVxM/file1be62142821d/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpszXVxM/file1be62142821d/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpszXVxM/file1be62142821d/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
