...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d507b0265...
...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d507b0265...
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d507b0265/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d507b0265...
#> ✔ First episode created in /tmp/RtmpYhnOfg/file1a1d507b0265/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d507b0265...
...
#> - Hydrated 25 packages in 0.12 seconds.
#> - The project is out-of-sync -- use `renv::status()` for details.
...
#> - R             [* -> 4.6.0]
#> 
#> - Lockfile written to "/tmp/RtmpYhnOfg/file1a1d507b0265/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpYhnOfg/file1a1d507b0265
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d507b0265...
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d507b0265/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d507b0265/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d507b0265/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
