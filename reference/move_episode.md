...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05714c31ef...
...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05714c31ef...
#> ☐ Edit /tmp/RtmptmNyLK/file1c05714c31ef/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05714c31ef...
#> ✔ First episode created in /tmp/RtmptmNyLK/file1c05714c31ef/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05714c31ef...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmptmNyLK/file1c05714c31ef/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmptmNyLK/file1c05714c31ef
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05714c31ef...
#> ☐ Edit /tmp/RtmptmNyLK/file1c05714c31ef/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmptmNyLK/file1c05714c31ef/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmptmNyLK/file1c05714c31ef/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
