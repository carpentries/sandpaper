...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0811832584...
...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0811832584...
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c0811832584/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0811832584...
#> ✔ First episode created in /tmp/RtmpG8rnQJ/file1c0811832584/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0811832584...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpG8rnQJ/file1c0811832584/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpG8rnQJ/file1c0811832584
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0811832584...
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c0811832584/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c0811832584/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c0811832584/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
