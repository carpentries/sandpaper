...
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab4e8e2437...
...
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab4e8e2437...
#> ☐ Edit /tmp/RtmpzqWdxf/file1cab4e8e2437/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab4e8e2437...
#> ✔ First episode created in /tmp/RtmpzqWdxf/file1cab4e8e2437/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab4e8e2437...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpzqWdxf/file1cab4e8e2437/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpzqWdxf/file1cab4e8e2437
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab4e8e2437...
#> ☐ Edit /tmp/RtmpzqWdxf/file1cab4e8e2437/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpzqWdxf/file1cab4e8e2437/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpzqWdxf/file1cab4e8e2437/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
