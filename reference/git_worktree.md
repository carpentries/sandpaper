...
#> ℹ Lesson bootstrapped in 3.169085 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01295757 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 93ae0ff] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpzqWdxf/REMOTE-1cab5ca3bc9
...
#> From /tmp/RtmpzqWdxf/REMOTE-1cab5ca3bc9
...
#>   /tmp/RtmpzqWdxf/file1cab4d78f7a6/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 93ae0ff)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 93ae0ff Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 30ed43b] Initializing gh-pages branch
...
#>   /tmp/RtmpzqWdxf/file1cab4d78f7a6/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 30ed43b)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 30ed43b Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.01 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpzqWdxf/file1cab4d78f7a6/lesson-example/site/built", "/tmp/RtmpzqWdxf/file1cab4d78f7a6/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpzqWdxf/file1cab4d78f7a6/lesson-example/site/docs", "/tmp/RtmpzqWdxf/file1cab4d78f7a6/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpzqWdxf/file1cab4d78f7a6/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpzqWdxf/REMOTE-1cab5ca3bc9)
#> /tmp/RtmpzqWdxf/REMOTE-1cab5ca3bc9
