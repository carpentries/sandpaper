...
#> ℹ Lesson bootstrapped in 3.617824 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01282644 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.65 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) 9f6fd9a] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpqRlAf5/REMOTE-1aae1eb5606b
...
#> From /tmp/RtmpqRlAf5/REMOTE-1aae1eb5606b
...
#>   /tmp/RtmpqRlAf5/file1aae3825c32c/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 9f6fd9a)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 9f6fd9a Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) df3a067] Initializing gh-pages branch
...
#>   /tmp/RtmpqRlAf5/file1aae3825c32c/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at df3a067)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at df3a067 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 0.4 seconds
tik <- Sys.time()
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.99 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpqRlAf5/file1aae3825c32c/lesson-example/site/built", "/tmp/RtmpqRlAf5/file1aae3825c32c/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpqRlAf5/file1aae3825c32c/lesson-example/site/docs", "/tmp/RtmpqRlAf5/file1aae3825c32c/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpqRlAf5/file1aae3825c32c/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpqRlAf5/REMOTE-1aae1eb5606b)
#> /tmp/RtmpqRlAf5/REMOTE-1aae1eb5606b
