...
#> ℹ Lesson bootstrapped in 3.574188 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01383662 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) ce6d721] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpHGsTUG/REMOTE-1a57412c32d1
...
#> From /tmp/RtmpHGsTUG/REMOTE-1a57412c32d1
...
#>   /tmp/RtmpHGsTUG/file1a57672aab3/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at ce6d721)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at ce6d721 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 5853ad0] Initializing gh-pages branch
...
#>   /tmp/RtmpHGsTUG/file1a57672aab3/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 5853ad0)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 5853ad0 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpHGsTUG/file1a57672aab3/lesson-example/site/built", "/tmp/RtmpHGsTUG/file1a57672aab3/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpHGsTUG/file1a57672aab3/lesson-example/site/docs", "/tmp/RtmpHGsTUG/file1a57672aab3/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpHGsTUG/file1a57672aab3/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpHGsTUG/REMOTE-1a57412c32d1)
#> /tmp/RtmpHGsTUG/REMOTE-1a57412c32d1
