...
#> ℹ Lesson bootstrapped in 3.416278 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01341033 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 7ac80ff] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/Rtmp82VLs2/REMOTE-1a9165914d83
...
#> From /tmp/Rtmp82VLs2/REMOTE-1a9165914d83
...
#>   /tmp/Rtmp82VLs2/file1a91458540cf/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 7ac80ff)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 7ac80ff Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 08da1a9] Initializing gh-pages branch
...
#>   /tmp/Rtmp82VLs2/file1a91458540cf/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 08da1a9)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 08da1a9 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 0.42 seconds
tik <- Sys.time()
...
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmp82VLs2/file1a91458540cf/lesson-example/site/built", "/tmp/Rtmp82VLs2/file1a91458540cf/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmp82VLs2/file1a91458540cf/lesson-example/site/docs", "/tmp/Rtmp82VLs2/file1a91458540cf/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/Rtmp82VLs2/file1a91458540cf/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/Rtmp82VLs2/REMOTE-1a9165914d83)
#> /tmp/Rtmp82VLs2/REMOTE-1a9165914d83
