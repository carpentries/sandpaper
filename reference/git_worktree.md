...
#> ℹ Lesson bootstrapped in 3.178069 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01303029 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) f2d13b5] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmptmNyLK/REMOTE-1c05533af18e
...
#> From /tmp/RtmptmNyLK/REMOTE-1c05533af18e
...
#>   /tmp/RtmptmNyLK/file1c055329aade/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at f2d13b5)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at f2d13b5 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 1f8c4e2] Initializing gh-pages branch
...
#>   /tmp/RtmptmNyLK/file1c055329aade/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 1f8c4e2)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 1f8c4e2 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmptmNyLK/file1c055329aade/lesson-example/site/built", "/tmp/RtmptmNyLK/file1c055329aade/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmptmNyLK/file1c055329aade/lesson-example/site/docs", "/tmp/RtmptmNyLK/file1c055329aade/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmptmNyLK/file1c055329aade/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmptmNyLK/REMOTE-1c05533af18e)
#> /tmp/RtmptmNyLK/REMOTE-1c05533af18e
