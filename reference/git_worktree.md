...
#> ℹ Lesson bootstrapped in 3.361575 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01327205 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.4 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) 68be5ee] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpL2X6sE/REMOTE-1bfe68e2a68d
...
#> From /tmp/RtmpL2X6sE/REMOTE-1bfe68e2a68d
...
#>   /tmp/RtmpL2X6sE/file1bfe7d145cdc/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 68be5ee)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 68be5ee Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 014d74b] Initializing gh-pages branch
...
#>   /tmp/RtmpL2X6sE/file1bfe7d145cdc/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 014d74b)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 014d74b Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.43 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpL2X6sE/file1bfe7d145cdc/lesson-example/site/built", "/tmp/RtmpL2X6sE/file1bfe7d145cdc/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpL2X6sE/file1bfe7d145cdc/lesson-example/site/docs", "/tmp/RtmpL2X6sE/file1bfe7d145cdc/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpL2X6sE/file1bfe7d145cdc/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpL2X6sE/REMOTE-1bfe68e2a68d)
#> /tmp/RtmpL2X6sE/REMOTE-1bfe68e2a68d
