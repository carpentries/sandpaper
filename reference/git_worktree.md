...
#> ℹ Lesson bootstrapped in 3.654506 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01292872 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.69 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) 3ee72f4] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpFQ2hak/REMOTE-1a5d4dcc32aa
...
#> From /tmp/RtmpFQ2hak/REMOTE-1a5d4dcc32aa
...
#>   /tmp/RtmpFQ2hak/file1a5d57d14804/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 3ee72f4)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 3ee72f4 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 477883b] Initializing gh-pages branch
...
#>   /tmp/RtmpFQ2hak/file1a5d57d14804/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 477883b)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 477883b Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.54 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpFQ2hak/file1a5d57d14804/lesson-example/site/built", "/tmp/RtmpFQ2hak/file1a5d57d14804/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpFQ2hak/file1a5d57d14804/lesson-example/site/docs", "/tmp/RtmpFQ2hak/file1a5d57d14804/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpFQ2hak/file1a5d57d14804/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpFQ2hak/REMOTE-1a5d4dcc32aa)
#> /tmp/RtmpFQ2hak/REMOTE-1a5d4dcc32aa
