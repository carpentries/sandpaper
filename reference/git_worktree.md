...
#> ℹ Lesson bootstrapped in 3.108435 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01335335 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 9d4f6b3] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpuuNLIY/REMOTE-1bff5d2e3de8
...
#> From /tmp/RtmpuuNLIY/REMOTE-1bff5d2e3de8
...
#>   /tmp/RtmpuuNLIY/file1bff22670462/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 9d4f6b3)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 9d4f6b3 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) a1c6a1a] Initializing gh-pages branch
...
#>   /tmp/RtmpuuNLIY/file1bff22670462/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at a1c6a1a)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at a1c6a1a Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.19 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpuuNLIY/file1bff22670462/lesson-example/site/built", "/tmp/RtmpuuNLIY/file1bff22670462/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpuuNLIY/file1bff22670462/lesson-example/site/docs", "/tmp/RtmpuuNLIY/file1bff22670462/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpuuNLIY/file1bff22670462/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpuuNLIY/REMOTE-1bff5d2e3de8)
#> /tmp/RtmpuuNLIY/REMOTE-1bff5d2e3de8
