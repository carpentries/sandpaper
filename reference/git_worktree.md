...
#> ℹ Lesson bootstrapped in 3.717965 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01276946 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 0426716] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpVcV2iC/REMOTE-1b0ed3511c3
...
#> From /tmp/RtmpVcV2iC/REMOTE-1b0ed3511c3
...
#>   /tmp/RtmpVcV2iC/file1b0e128d7ce6/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 0426716)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 0426716 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) b696c93] Initializing gh-pages branch
...
#>   /tmp/RtmpVcV2iC/file1b0e128d7ce6/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at b696c93)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at b696c93 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.2 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpVcV2iC/file1b0e128d7ce6/lesson-example/site/built", "/tmp/RtmpVcV2iC/file1b0e128d7ce6/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpVcV2iC/file1b0e128d7ce6/lesson-example/site/docs", "/tmp/RtmpVcV2iC/file1b0e128d7ce6/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpVcV2iC/file1b0e128d7ce6/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpVcV2iC/REMOTE-1b0ed3511c3)
#> /tmp/RtmpVcV2iC/REMOTE-1b0ed3511c3
