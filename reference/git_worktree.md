...
#> ℹ Lesson bootstrapped in 3.115678 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01342511 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 5e3b648] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/Rtmpy7dRDl/REMOTE-19427da7b01
...
#> From /tmp/Rtmpy7dRDl/REMOTE-19427da7b01
...
#>   /tmp/Rtmpy7dRDl/file1942373041fa/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 5e3b648)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 5e3b648 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 9260764] Initializing gh-pages branch
...
#>   /tmp/Rtmpy7dRDl/file1942373041fa/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 9260764)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 9260764 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmpy7dRDl/file1942373041fa/lesson-example/site/built", "/tmp/Rtmpy7dRDl/file1942373041fa/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmpy7dRDl/file1942373041fa/lesson-example/site/docs", "/tmp/Rtmpy7dRDl/file1942373041fa/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/Rtmpy7dRDl/file1942373041fa/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/Rtmpy7dRDl/REMOTE-19427da7b01)
#> /tmp/Rtmpy7dRDl/REMOTE-19427da7b01
