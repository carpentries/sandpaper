...
#> ℹ Lesson bootstrapped in 3.170083 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01302552 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 2ddd904] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/Rtmpgc9t3l/REMOTE-1c0814362dcd
...
#> From /tmp/Rtmpgc9t3l/REMOTE-1c0814362dcd
...
#>   /tmp/Rtmpgc9t3l/file1c0877d3d828/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 2ddd904)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 2ddd904 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 8347339] Initializing gh-pages branch
...
#>   /tmp/Rtmpgc9t3l/file1c0877d3d828/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 8347339)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 8347339 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.39 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmpgc9t3l/file1c0877d3d828/lesson-example/site/built", "/tmp/Rtmpgc9t3l/file1c0877d3d828/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmpgc9t3l/file1c0877d3d828/lesson-example/site/docs", "/tmp/Rtmpgc9t3l/file1c0877d3d828/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/Rtmpgc9t3l/file1c0877d3d828/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/Rtmpgc9t3l/REMOTE-1c0814362dcd)
#> /tmp/Rtmpgc9t3l/REMOTE-1c0814362dcd
