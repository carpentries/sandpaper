...
#> ℹ Lesson bootstrapped in 3.71542 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01307321 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) cd8f115] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/Rtmpf7ur3n/REMOTE-1c5357e7a8c3
...
#> From /tmp/Rtmpf7ur3n/REMOTE-1c5357e7a8c3
...
#>   /tmp/Rtmpf7ur3n/file1c53472ab84f/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at cd8f115)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at cd8f115 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) c173b5e] Initializing gh-pages branch
...
#>   /tmp/Rtmpf7ur3n/file1c53472ab84f/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at c173b5e)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at c173b5e Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 0.32 seconds
tik <- Sys.time()
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.76 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmpf7ur3n/file1c53472ab84f/lesson-example/site/built", "/tmp/Rtmpf7ur3n/file1c53472ab84f/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmpf7ur3n/file1c53472ab84f/lesson-example/site/docs", "/tmp/Rtmpf7ur3n/file1c53472ab84f/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/Rtmpf7ur3n/file1c53472ab84f/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/Rtmpf7ur3n/REMOTE-1c5357e7a8c3)
#> /tmp/Rtmpf7ur3n/REMOTE-1c5357e7a8c3
