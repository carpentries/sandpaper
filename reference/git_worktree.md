...
#> ℹ Lesson bootstrapped in 3.194383 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01325989 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 8ecb9fa] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmplVw70p/REMOTE-1932252e3744
...
#> From /tmp/RtmplVw70p/REMOTE-1932252e3744
...
#>   /tmp/RtmplVw70p/file1932471a536/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 8ecb9fa)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 8ecb9fa Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 88100bc] Initializing gh-pages branch
...
#>   /tmp/RtmplVw70p/file1932471a536/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 88100bc)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 88100bc Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 0.45 seconds
tik <- Sys.time()
...
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmplVw70p/file1932471a536/lesson-example/site/built", "/tmp/RtmplVw70p/file1932471a536/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmplVw70p/file1932471a536/lesson-example/site/docs", "/tmp/RtmplVw70p/file1932471a536/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmplVw70p/file1932471a536/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmplVw70p/REMOTE-1932252e3744)
#> /tmp/RtmplVw70p/REMOTE-1932252e3744
