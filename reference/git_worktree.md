...
#> ℹ Lesson bootstrapped in 3.154909 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01276469 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 6a42ad2] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpfD9rhg/REMOTE-1939233b5f67
...
#> From /tmp/RtmpfD9rhg/REMOTE-1939233b5f67
...
#>   /tmp/RtmpfD9rhg/file1939903b928/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 6a42ad2)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 6a42ad2 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) caa0b14] Initializing gh-pages branch
...
#>   /tmp/RtmpfD9rhg/file1939903b928/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at caa0b14)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at caa0b14 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpfD9rhg/file1939903b928/lesson-example/site/built", "/tmp/RtmpfD9rhg/file1939903b928/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpfD9rhg/file1939903b928/lesson-example/site/docs", "/tmp/RtmpfD9rhg/file1939903b928/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpfD9rhg/file1939903b928/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpfD9rhg/REMOTE-1939233b5f67)
#> /tmp/RtmpfD9rhg/REMOTE-1939233b5f67
