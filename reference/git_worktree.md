...
#> ℹ Lesson bootstrapped in 4.079508 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01307964 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 4.12 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) f857e96] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmppZSt3g/REMOTE-1be5632850f2
...
#> From /tmp/RtmppZSt3g/REMOTE-1be5632850f2
...
#>   /tmp/RtmppZSt3g/file1be55f583c13/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at f857e96)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at f857e96 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 5b7e055] Initializing gh-pages branch
...
#>   /tmp/RtmppZSt3g/file1be55f583c13/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 5b7e055)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 5b7e055 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.55 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmppZSt3g/file1be55f583c13/lesson-example/site/built", "/tmp/RtmppZSt3g/file1be55f583c13/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmppZSt3g/file1be55f583c13/lesson-example/site/docs", "/tmp/RtmppZSt3g/file1be55f583c13/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmppZSt3g/file1be55f583c13/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmppZSt3g/REMOTE-1be5632850f2)
#> /tmp/RtmppZSt3g/REMOTE-1be5632850f2
