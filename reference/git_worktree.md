...
#> ℹ Lesson bootstrapped in 3.149433 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01275778 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 3398538] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpW7Mbc5/REMOTE-199d70fcaf6b
...
#> From /tmp/RtmpW7Mbc5/REMOTE-199d70fcaf6b
...
#>   /tmp/RtmpW7Mbc5/file199d235523db/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 3398538)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 3398538 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) f9cc784] Initializing gh-pages branch
...
#>   /tmp/RtmpW7Mbc5/file199d235523db/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at f9cc784)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at f9cc784 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.92 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpW7Mbc5/file199d235523db/lesson-example/site/built", "/tmp/RtmpW7Mbc5/file199d235523db/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpW7Mbc5/file199d235523db/lesson-example/site/docs", "/tmp/RtmpW7Mbc5/file199d235523db/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpW7Mbc5/file199d235523db/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpW7Mbc5/REMOTE-199d70fcaf6b)
#> /tmp/RtmpW7Mbc5/REMOTE-199d70fcaf6b
