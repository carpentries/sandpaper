...
#> ℹ Lesson bootstrapped in 3.369822 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01383901 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 87cab07] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpMShUNW/REMOTE-193224be8c53
...
#> From /tmp/RtmpMShUNW/REMOTE-193224be8c53
...
#>   /tmp/RtmpMShUNW/file193213e711df/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 87cab07)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 87cab07 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 163d113] Initializing gh-pages branch
...
#>   /tmp/RtmpMShUNW/file193213e711df/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 163d113)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 163d113 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 14.16 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpMShUNW/file193213e711df/lesson-example/site/built", "/tmp/RtmpMShUNW/file193213e711df/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpMShUNW/file193213e711df/lesson-example/site/docs", "/tmp/RtmpMShUNW/file193213e711df/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpMShUNW/file193213e711df/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpMShUNW/REMOTE-193224be8c53)
#> /tmp/RtmpMShUNW/REMOTE-193224be8c53
