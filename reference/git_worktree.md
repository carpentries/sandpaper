...
#> ℹ Lesson bootstrapped in 3.22268 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01420188 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.26 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) 5d56706] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpNIRNTg/REMOTE-1c017e9c8fd0
...
#> From /tmp/RtmpNIRNTg/REMOTE-1c017e9c8fd0
...
#>   /tmp/RtmpNIRNTg/file1c012f902363/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 5d56706)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 5d56706 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 7d98d55] Initializing gh-pages branch
...
#>   /tmp/RtmpNIRNTg/file1c012f902363/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 7d98d55)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 7d98d55 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.13 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpNIRNTg/file1c012f902363/lesson-example/site/built", "/tmp/RtmpNIRNTg/file1c012f902363/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpNIRNTg/file1c012f902363/lesson-example/site/docs", "/tmp/RtmpNIRNTg/file1c012f902363/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpNIRNTg/file1c012f902363/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpNIRNTg/REMOTE-1c017e9c8fd0)
#> /tmp/RtmpNIRNTg/REMOTE-1c017e9c8fd0
