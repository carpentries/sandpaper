...
#> ℹ Lesson bootstrapped in 3.174096 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01337814 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) ca8eafe] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpRJ0N7a/REMOTE-1e715cf4dbc7
...
#> From /tmp/RtmpRJ0N7a/REMOTE-1e715cf4dbc7
...
#>   /tmp/RtmpRJ0N7a/file1e7136b909d4/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at ca8eafe)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at ca8eafe Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) affbd60] Initializing gh-pages branch
...
#>   /tmp/RtmpRJ0N7a/file1e7136b909d4/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at affbd60)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at affbd60 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.98 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpRJ0N7a/file1e7136b909d4/lesson-example/site/built", "/tmp/RtmpRJ0N7a/file1e7136b909d4/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpRJ0N7a/file1e7136b909d4/lesson-example/site/docs", "/tmp/RtmpRJ0N7a/file1e7136b909d4/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpRJ0N7a/file1e7136b909d4/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpRJ0N7a/REMOTE-1e715cf4dbc7)
#> /tmp/RtmpRJ0N7a/REMOTE-1e715cf4dbc7
