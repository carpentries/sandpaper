...
#> ℹ Lesson bootstrapped in 3.314725 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01415277 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 6395aeb] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpvfYpdV/REMOTE-1ab427df5b40
...
#> From /tmp/RtmpvfYpdV/REMOTE-1ab427df5b40
...
#>   /tmp/RtmpvfYpdV/file1ab4302fc956/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 6395aeb)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 6395aeb Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 1df0d81] Initializing gh-pages branch
...
#>   /tmp/RtmpvfYpdV/file1ab4302fc956/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 1df0d81)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 1df0d81 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpvfYpdV/file1ab4302fc956/lesson-example/site/built", "/tmp/RtmpvfYpdV/file1ab4302fc956/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpvfYpdV/file1ab4302fc956/lesson-example/site/docs", "/tmp/RtmpvfYpdV/file1ab4302fc956/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpvfYpdV/file1ab4302fc956/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpvfYpdV/REMOTE-1ab427df5b40)
#> /tmp/RtmpvfYpdV/REMOTE-1ab427df5b40
