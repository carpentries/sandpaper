...
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d58075a93...
...
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d58075a93...
#> ☐ Edit /tmp/RtmpW7Mbc5/file199d58075a93/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d58075a93...
#> ✔ First episode created in /tmp/RtmpW7Mbc5/file199d58075a93/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d58075a93...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d58075a93...
#> ✔ Lesson successfully created in /tmp/RtmpW7Mbc5/file199d58075a93
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d58075a93...
#> /tmp/RtmpW7Mbc5/file199d58075a93
get_episodes(tmp)
#> [1] "introduction.md"
