...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c081906a8a7...
...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c081906a8a7...
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c081906a8a7/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c081906a8a7...
#> ✔ First episode created in /tmp/RtmpG8rnQJ/file1c081906a8a7/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c081906a8a7...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c081906a8a7...
#> ✔ Lesson successfully created in /tmp/RtmpG8rnQJ/file1c081906a8a7
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c081906a8a7...
#> /tmp/RtmpG8rnQJ/file1c081906a8a7
get_episodes(tmp)
#> [1] "introduction.md"
