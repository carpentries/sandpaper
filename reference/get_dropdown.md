...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7a54d2bf...
...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7a54d2bf...
#> ☐ Edit /tmp/Rtmpr0Li7l/file1cfd7a54d2bf/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7a54d2bf...
#> ✔ First episode created in /tmp/Rtmpr0Li7l/file1cfd7a54d2bf/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7a54d2bf...
...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7a54d2bf...
#> ✔ Lesson successfully created in /tmp/Rtmpr0Li7l/file1cfd7a54d2bf
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7a54d2bf...
#> /tmp/Rtmpr0Li7l/file1cfd7a54d2bf
get_episodes(tmp)
#> [1] "introduction.md"
