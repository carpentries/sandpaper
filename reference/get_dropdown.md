...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa26703e6d7...
...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa26703e6d7...
#> ☐ Edit /tmp/Rtmpw9vtxi/file1aa26703e6d7/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa26703e6d7...
#> ✔ First episode created in /tmp/Rtmpw9vtxi/file1aa26703e6d7/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa26703e6d7...
...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa26703e6d7...
#> ✔ Lesson successfully created in /tmp/Rtmpw9vtxi/file1aa26703e6d7
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa26703e6d7...
#> /tmp/Rtmpw9vtxi/file1aa26703e6d7
get_episodes(tmp)
#> [1] "introduction.md"
