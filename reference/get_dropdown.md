...
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c5978273a77...
...
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c5978273a77...
#> ☐ Edit /tmp/RtmpqJUIxl/file1c5978273a77/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c5978273a77...
#> ✔ First episode created in /tmp/RtmpqJUIxl/file1c5978273a77/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c5978273a77...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c5978273a77...
#> ✔ Lesson successfully created in /tmp/RtmpqJUIxl/file1c5978273a77
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c5978273a77...
#> /tmp/RtmpqJUIxl/file1c5978273a77
get_episodes(tmp)
#> [1] "introduction.md"
