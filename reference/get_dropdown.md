...
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be6f2843a0...
...
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be6f2843a0...
#> ☐ Edit /tmp/RtmpszXVxM/file1be6f2843a0/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be6f2843a0...
#> ✔ First episode created in /tmp/RtmpszXVxM/file1be6f2843a0/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be6f2843a0...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be6f2843a0...
#> ✔ Lesson successfully created in /tmp/RtmpszXVxM/file1be6f2843a0
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be6f2843a0...
#> /tmp/RtmpszXVxM/file1be6f2843a0
get_episodes(tmp)
#> [1] "introduction.md"
