...
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf367547c6b...
...
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf367547c6b...
#> ☐ Edit /tmp/Rtmpfmukg6/file1bf367547c6b/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf367547c6b...
#> ✔ First episode created in /tmp/Rtmpfmukg6/file1bf367547c6b/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf367547c6b...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf367547c6b...
#> ✔ Lesson successfully created in /tmp/Rtmpfmukg6/file1bf367547c6b
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf367547c6b...
#> /tmp/Rtmpfmukg6/file1bf367547c6b
get_episodes(tmp)
#> [1] "introduction.md"
