...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0567c6bc55...
...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0567c6bc55...
#> ☐ Edit /tmp/RtmptmNyLK/file1c0567c6bc55/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0567c6bc55...
#> ✔ First episode created in /tmp/RtmptmNyLK/file1c0567c6bc55/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0567c6bc55...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0567c6bc55...
#> ✔ Lesson successfully created in /tmp/RtmptmNyLK/file1c0567c6bc55
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0567c6bc55...
#> /tmp/RtmptmNyLK/file1c0567c6bc55
get_episodes(tmp)
#> [1] "introduction.md"
