...
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c38697f72d5...
...
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c38697f72d5...
#> ☐ Edit /tmp/RtmprvyUoW/file1c38697f72d5/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c38697f72d5...
#> ✔ First episode created in /tmp/RtmprvyUoW/file1c38697f72d5/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c38697f72d5...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c38697f72d5...
#> ✔ Lesson successfully created in /tmp/RtmprvyUoW/file1c38697f72d5
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c38697f72d5...
#> /tmp/RtmprvyUoW/file1c38697f72d5
get_episodes(tmp)
#> [1] "introduction.md"
