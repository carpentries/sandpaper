...
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe6cffdc49...
...
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe6cffdc49...
#> ☐ Edit /tmp/RtmpHkg0h5/file1bfe6cffdc49/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe6cffdc49...
#> ✔ First episode created in /tmp/RtmpHkg0h5/file1bfe6cffdc49/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe6cffdc49...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe6cffdc49...
#> ✔ Lesson successfully created in /tmp/RtmpHkg0h5/file1bfe6cffdc49
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe6cffdc49...
#> /tmp/RtmpHkg0h5/file1bfe6cffdc49
get_episodes(tmp)
#> [1] "introduction.md"
