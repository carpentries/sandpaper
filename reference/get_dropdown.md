...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e6a84993f...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e6a84993f...
#> ☐ Edit /tmp/RtmpVcV2iC/file1b0e6a84993f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e6a84993f...
#> ✔ First episode created in /tmp/RtmpVcV2iC/file1b0e6a84993f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e6a84993f...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e6a84993f...
#> ✔ Lesson successfully created in /tmp/RtmpVcV2iC/file1b0e6a84993f
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e6a84993f...
#> /tmp/RtmpVcV2iC/file1b0e6a84993f
get_episodes(tmp)
#> [1] "introduction.md"
