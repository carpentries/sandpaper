...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff5eb94d5f...
...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff5eb94d5f...
#> ☐ Edit /tmp/Rtmph9vhkW/file1bff5eb94d5f/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff5eb94d5f...
#> ✔ First episode created in /tmp/Rtmph9vhkW/file1bff5eb94d5f/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff5eb94d5f...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff5eb94d5f...
#> ✔ Lesson successfully created in /tmp/Rtmph9vhkW/file1bff5eb94d5f
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff5eb94d5f...
#> /tmp/Rtmph9vhkW/file1bff5eb94d5f
get_episodes(tmp)
#> [1] "introduction.md"
