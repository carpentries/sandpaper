...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942700cd091...
...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942700cd091...
#> ☐ Edit /tmp/Rtmpy7dRDl/file1942700cd091/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942700cd091...
#> ✔ First episode created in /tmp/Rtmpy7dRDl/file1942700cd091/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942700cd091...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942700cd091...
#> ✔ Lesson successfully created in /tmp/Rtmpy7dRDl/file1942700cd091
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file1942700cd091...
#> /tmp/Rtmpy7dRDl/file1942700cd091
get_episodes(tmp)
#> [1] "introduction.md"
