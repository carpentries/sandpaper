...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0111754db3...
...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0111754db3...
#> ☐ Edit /tmp/RtmpNIRNTg/file1c0111754db3/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0111754db3...
#> ✔ First episode created in /tmp/RtmpNIRNTg/file1c0111754db3/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0111754db3...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0111754db3...
#> ✔ Lesson successfully created in /tmp/RtmpNIRNTg/file1c0111754db3
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0111754db3...
#> /tmp/RtmpNIRNTg/file1c0111754db3
get_episodes(tmp)
#> [1] "introduction.md"
