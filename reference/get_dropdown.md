...
#> → Creating Lesson in /tmp/RtmplVw70p/file1932735a3d26...
...
#> → Creating Lesson in /tmp/RtmplVw70p/file1932735a3d26...
#> ☐ Edit /tmp/RtmplVw70p/file1932735a3d26/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmplVw70p/file1932735a3d26...
#> ✔ First episode created in /tmp/RtmplVw70p/file1932735a3d26/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmplVw70p/file1932735a3d26...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmplVw70p/file1932735a3d26...
#> ✔ Lesson successfully created in /tmp/RtmplVw70p/file1932735a3d26
#> → Creating Lesson in /tmp/RtmplVw70p/file1932735a3d26...
#> /tmp/RtmplVw70p/file1932735a3d26
get_episodes(tmp)
#> [1] "introduction.md"
