...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc71111603c...
...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc71111603c...
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc71111603c/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc71111603c...
#> ✔ First episode created in /tmp/Rtmp4syuyP/file1cc71111603c/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc71111603c...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc71111603c...
#> ✔ Lesson successfully created in /tmp/Rtmp4syuyP/file1cc71111603c
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc71111603c...
#> /tmp/Rtmp4syuyP/file1cc71111603c
get_episodes(tmp)
#> [1] "introduction.md"
