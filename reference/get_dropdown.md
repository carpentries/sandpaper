...
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4633975e...
...
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4633975e...
#> ☐ Edit /tmp/RtmpvfYpdV/file1ab4633975e/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4633975e...
#> ✔ First episode created in /tmp/RtmpvfYpdV/file1ab4633975e/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4633975e...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4633975e...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4633975e...
#> ✔ Lesson successfully created in /tmp/RtmpvfYpdV/file1ab4633975e
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab4633975e...
#> /tmp/RtmpvfYpdV/file1ab4633975e
get_episodes(tmp)
#> [1] "introduction.md"
