...
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09465c26d4...
...
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09465c26d4...
#> ☐ Edit /tmp/Rtmp9LdTx2/file1c09465c26d4/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09465c26d4...
#> ✔ First episode created in /tmp/Rtmp9LdTx2/file1c09465c26d4/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09465c26d4...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09465c26d4...
#> ✔ Lesson successfully created in /tmp/Rtmp9LdTx2/file1c09465c26d4
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09465c26d4...
#> /tmp/Rtmp9LdTx2/file1c09465c26d4
get_episodes(tmp)
#> [1] "introduction.md"
