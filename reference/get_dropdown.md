...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913751e802...
...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913751e802...
#> ☐ Edit /tmp/Rtmp82VLs2/file1a913751e802/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913751e802...
#> ✔ First episode created in /tmp/Rtmp82VLs2/file1a913751e802/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913751e802...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913751e802...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913751e802...
#> ✔ Lesson successfully created in /tmp/Rtmp82VLs2/file1a913751e802
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913751e802...
#> /tmp/Rtmp82VLs2/file1a913751e802
get_episodes(tmp)
#> [1] "introduction.md"
