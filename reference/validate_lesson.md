...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0164925a41...
...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0164925a41...
#> ☐ Edit /tmp/RtmpNIRNTg/file1c0164925a41/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0164925a41...
#> ✔ First episode created in /tmp/RtmpNIRNTg/file1c0164925a41/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0164925a41...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpNIRNTg/file1c0164925a41/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpNIRNTg/file1c0164925a41
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0164925a41...
