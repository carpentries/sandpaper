...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a9178b21845...
...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a9178b21845...
#> ☐ Edit /tmp/Rtmp82VLs2/file1a9178b21845/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a9178b21845...
#> ✔ First episode created in /tmp/Rtmp82VLs2/file1a9178b21845/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a9178b21845...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/Rtmp82VLs2/file1a9178b21845/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmp82VLs2/file1a9178b21845
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a9178b21845...
