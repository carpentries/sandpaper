...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa297a1064...
...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa297a1064...
#> ☐ Edit /tmp/Rtmpw9vtxi/file1aa297a1064/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa297a1064...
#> ✔ First episode created in /tmp/Rtmpw9vtxi/file1aa297a1064/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa297a1064...
...
#> - R             [* -> 4.5.3]
#> 
#> - Lockfile written to "/tmp/Rtmpw9vtxi/file1aa297a1064/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmpw9vtxi/file1aa297a1064
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa297a1064...
