...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc74b438c7d...
...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc74b438c7d...
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc74b438c7d/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc74b438c7d...
#> ✔ First episode created in /tmp/Rtmp4syuyP/file1cc74b438c7d/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc74b438c7d...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/Rtmp4syuyP/file1cc74b438c7d/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmp4syuyP/file1cc74b438c7d
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc74b438c7d...
