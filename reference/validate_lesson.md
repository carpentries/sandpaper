...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57624857d2...
...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57624857d2...
#> ☐ Edit /tmp/RtmpHGsTUG/file1a57624857d2/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57624857d2...
#> ✔ First episode created in /tmp/RtmpHGsTUG/file1a57624857d2/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57624857d2...
...
#> - R             [* -> 4.6.0]
#> 
#> - Lockfile written to "/tmp/RtmpHGsTUG/file1a57624857d2/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpHGsTUG/file1a57624857d2
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a57624857d2...
