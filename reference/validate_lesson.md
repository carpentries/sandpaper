...
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab2117fd2e...
...
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab2117fd2e...
#> ☐ Edit /tmp/RtmpzqWdxf/file1cab2117fd2e/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab2117fd2e...
#> ✔ First episode created in /tmp/RtmpzqWdxf/file1cab2117fd2e/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab2117fd2e...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpzqWdxf/file1cab2117fd2e/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpzqWdxf/file1cab2117fd2e
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab2117fd2e...
