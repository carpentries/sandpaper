...
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c1394c9cd...
...
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c1394c9cd...
#> ☐ Edit /tmp/RtmpZEO1dD/file1c0c1394c9cd/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c1394c9cd...
#> ✔ First episode created in /tmp/RtmpZEO1dD/file1c0c1394c9cd/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c1394c9cd...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpZEO1dD/file1c0c1394c9cd/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpZEO1dD/file1c0c1394c9cd
#> → Creating Lesson in /tmp/RtmpZEO1dD/file1c0c1394c9cd...
