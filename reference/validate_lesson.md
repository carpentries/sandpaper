...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff70abf42c...
...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff70abf42c...
#> ☐ Edit /tmp/Rtmph9vhkW/file1bff70abf42c/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff70abf42c...
#> ✔ First episode created in /tmp/Rtmph9vhkW/file1bff70abf42c/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff70abf42c...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/Rtmph9vhkW/file1bff70abf42c/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmph9vhkW/file1bff70abf42c
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff70abf42c...
