...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff7e07e5cd...
...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff7e07e5cd...
#> ☐ Edit /tmp/RtmpuuNLIY/file1bff7e07e5cd/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff7e07e5cd...
#> ✔ First episode created in /tmp/RtmpuuNLIY/file1bff7e07e5cd/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff7e07e5cd...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpuuNLIY/file1bff7e07e5cd/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpuuNLIY/file1bff7e07e5cd
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff7e07e5cd...
