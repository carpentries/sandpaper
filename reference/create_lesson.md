...
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c386c3987a9...
...
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c386c3987a9...
#> ☐ Edit /tmp/RtmprvyUoW/file1c386c3987a9/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c386c3987a9...
#> ✔ First episode created in /tmp/RtmprvyUoW/file1c386c3987a9/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c386c3987a9...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmprvyUoW/file1c386c3987a9/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmprvyUoW/file1c386c3987a9
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c386c3987a9...
lsn
#> /tmp/RtmprvyUoW/file1c386c3987a9
```
