...
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be61633f51a...
...
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be61633f51a...
#> ☐ Edit /tmp/RtmpszXVxM/file1be61633f51a/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be61633f51a...
#> ✔ First episode created in /tmp/RtmpszXVxM/file1be61633f51a/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be61633f51a...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpszXVxM/file1be61633f51a/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpszXVxM/file1be61633f51a
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be61633f51a...
lsn
#> /tmp/RtmpszXVxM/file1be61633f51a
```
