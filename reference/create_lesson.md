...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0133c35ff6...
...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0133c35ff6...
#> ☐ Edit /tmp/RtmpNIRNTg/file1c0133c35ff6/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0133c35ff6...
#> ✔ First episode created in /tmp/RtmpNIRNTg/file1c0133c35ff6/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0133c35ff6...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpNIRNTg/file1c0133c35ff6/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpNIRNTg/file1c0133c35ff6
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c0133c35ff6...
lsn
#> /tmp/RtmpNIRNTg/file1c0133c35ff6
```
