...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7446d946f...
...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7446d946f...
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc7446d946f/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7446d946f...
#> ✔ First episode created in /tmp/Rtmp4syuyP/file1cc7446d946f/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7446d946f...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/Rtmp4syuyP/file1cc7446d946f/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmp4syuyP/file1cc7446d946f
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7446d946f...
lsn
#> /tmp/Rtmp4syuyP/file1cc7446d946f
```
