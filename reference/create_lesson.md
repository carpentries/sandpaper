...
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c596624f6e0...
...
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c596624f6e0...
#> ☐ Edit /tmp/RtmpqJUIxl/file1c596624f6e0/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c596624f6e0...
#> ✔ First episode created in /tmp/RtmpqJUIxl/file1c596624f6e0/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c596624f6e0...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpqJUIxl/file1c596624f6e0/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpqJUIxl/file1c596624f6e0
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c596624f6e0...
lsn
#> /tmp/RtmpqJUIxl/file1c596624f6e0
```
