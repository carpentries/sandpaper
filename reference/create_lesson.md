...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c085cdbb33e...
...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c085cdbb33e...
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c085cdbb33e/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c085cdbb33e...
#> ✔ First episode created in /tmp/RtmpG8rnQJ/file1c085cdbb33e/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c085cdbb33e...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpG8rnQJ/file1c085cdbb33e/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpG8rnQJ/file1c085cdbb33e
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c085cdbb33e...
lsn
#> /tmp/RtmpG8rnQJ/file1c085cdbb33e
```
