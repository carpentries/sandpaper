...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913054c763...
...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913054c763...
#> ☐ Edit /tmp/Rtmp82VLs2/file1a913054c763/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913054c763...
#> ✔ First episode created in /tmp/Rtmp82VLs2/file1a913054c763/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913054c763...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/Rtmp82VLs2/file1a913054c763/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmp82VLs2/file1a913054c763
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a913054c763...
lsn
#> /tmp/Rtmp82VLs2/file1a913054c763
```
