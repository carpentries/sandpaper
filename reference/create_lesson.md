...
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf318a3a189...
...
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf318a3a189...
#> ☐ Edit /tmp/Rtmpfmukg6/file1bf318a3a189/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf318a3a189...
#> ✔ First episode created in /tmp/Rtmpfmukg6/file1bf318a3a189/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf318a3a189...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/Rtmpfmukg6/file1bf318a3a189/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmpfmukg6/file1bf318a3a189
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf318a3a189...
lsn
#> /tmp/Rtmpfmukg6/file1bf318a3a189
```
