...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194210232c73...
...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194210232c73...
#> ☐ Edit /tmp/Rtmpy7dRDl/file194210232c73/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194210232c73...
#> ✔ First episode created in /tmp/Rtmpy7dRDl/file194210232c73/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194210232c73...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/Rtmpy7dRDl/file194210232c73/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmpy7dRDl/file194210232c73
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file194210232c73...
lsn
#> /tmp/Rtmpy7dRDl/file194210232c73
```
