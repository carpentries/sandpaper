...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff711009b0...
...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff711009b0...
#> ☐ Edit /tmp/RtmpuuNLIY/file1bff711009b0/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff711009b0...
#> ✔ First episode created in /tmp/RtmpuuNLIY/file1bff711009b0/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff711009b0...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpuuNLIY/file1bff711009b0/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpuuNLIY/file1bff711009b0
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff711009b0...
lsn
#> /tmp/RtmpuuNLIY/file1bff711009b0
```
