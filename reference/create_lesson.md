...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0568de3a32...
...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0568de3a32...
#> ☐ Edit /tmp/RtmptmNyLK/file1c0568de3a32/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0568de3a32...
#> ✔ First episode created in /tmp/RtmptmNyLK/file1c0568de3a32/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0568de3a32...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmptmNyLK/file1c0568de3a32/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmptmNyLK/file1c0568de3a32
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c0568de3a32...
lsn
#> /tmp/RtmptmNyLK/file1c0568de3a32
```
