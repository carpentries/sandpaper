...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd3a6374e5...
...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd3a6374e5...
#> ☐ Edit /tmp/Rtmpr0Li7l/file1cfd3a6374e5/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd3a6374e5...
#> ✔ First episode created in /tmp/Rtmpr0Li7l/file1cfd3a6374e5/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd3a6374e5...
...
#> - R             [* -> 4.6.1]
#> 
#> - Lockfile written to "/tmp/Rtmpr0Li7l/file1cfd3a6374e5/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmpr0Li7l/file1cfd3a6374e5
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd3a6374e5...
lsn
#> /tmp/Rtmpr0Li7l/file1cfd3a6374e5
```
