...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3a012f57...
...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3a012f57...
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe3a012f57/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3a012f57...
#> ✔ First episode created in /tmp/RtmpL2X6sE/file1bfe3a012f57/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3a012f57...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpL2X6sE/file1bfe3a012f57/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpL2X6sE/file1bfe3a012f57
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe3a012f57...
lsn
#> /tmp/RtmpL2X6sE/file1bfe3a012f57
```
