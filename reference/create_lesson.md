...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf73ccbd58...
...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf73ccbd58...
#> ☐ Edit /tmp/RtmpRhwHL2/file1ccf73ccbd58/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf73ccbd58...
#> ✔ First episode created in /tmp/RtmpRhwHL2/file1ccf73ccbd58/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf73ccbd58...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpRhwHL2/file1ccf73ccbd58/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpRhwHL2/file1ccf73ccbd58
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf73ccbd58...
lsn
#> /tmp/RtmpRhwHL2/file1ccf73ccbd58
```
