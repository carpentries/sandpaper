...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d43fdd66d...
...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d43fdd66d...
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d43fdd66d/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d43fdd66d...
#> ✔ First episode created in /tmp/RtmpYhnOfg/file1a1d43fdd66d/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d43fdd66d...
...
#> - R             [* -> 4.6.0]
#> 
#> - Lockfile written to "/tmp/RtmpYhnOfg/file1a1d43fdd66d/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpYhnOfg/file1a1d43fdd66d
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d43fdd66d...
lsn
#> /tmp/RtmpYhnOfg/file1a1d43fdd66d
```
