...
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5348e43241...
...
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5348e43241...
#> ☐ Edit /tmp/Rtmpf7ur3n/file1c5348e43241/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5348e43241...
#> ✔ First episode created in /tmp/Rtmpf7ur3n/file1c5348e43241/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5348e43241...
...
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5348e43241...
#> ✔ Lesson successfully created in /tmp/Rtmpf7ur3n/file1c5348e43241
#> → Creating Lesson in /tmp/Rtmpf7ur3n/file1c5348e43241...
#> /tmp/Rtmpf7ur3n/file1c5348e43241
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmpf7ur3n/file1c5348e43241/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmpf7ur3n/file1c5348e43241/episodes/using-r.Rmd.
#> /tmp/Rtmpf7ur3n/file1c5348e43241/episodes/using-r.Rmd
