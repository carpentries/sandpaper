...
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3870c68e88...
...
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3870c68e88...
#> ☐ Edit /tmp/RtmprvyUoW/file1c3870c68e88/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3870c68e88...
#> ✔ First episode created in /tmp/RtmprvyUoW/file1c3870c68e88/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3870c68e88...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3870c68e88...
#> ✔ Lesson successfully created in /tmp/RtmprvyUoW/file1c3870c68e88
#> → Creating Lesson in /tmp/RtmprvyUoW/file1c3870c68e88...
#> /tmp/RtmprvyUoW/file1c3870c68e88
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmprvyUoW/file1c3870c68e88/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmprvyUoW/file1c3870c68e88/episodes/using-r.Rmd.
#> /tmp/RtmprvyUoW/file1c3870c68e88/episodes/using-r.Rmd
