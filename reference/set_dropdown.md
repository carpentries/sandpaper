...
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba243fa0cb2...
...
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba243fa0cb2...
#> ☐ Edit /tmp/RtmpQHhDUx/file1ba243fa0cb2/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba243fa0cb2...
#> ✔ First episode created in /tmp/RtmpQHhDUx/file1ba243fa0cb2/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba243fa0cb2...
...
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba243fa0cb2...
#> ✔ Lesson successfully created in /tmp/RtmpQHhDUx/file1ba243fa0cb2
#> → Creating Lesson in /tmp/RtmpQHhDUx/file1ba243fa0cb2...
#> /tmp/RtmpQHhDUx/file1ba243fa0cb2
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpQHhDUx/file1ba243fa0cb2/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpQHhDUx/file1ba243fa0cb2/episodes/using-r.Rmd.
#> /tmp/RtmpQHhDUx/file1ba243fa0cb2/episodes/using-r.Rmd
