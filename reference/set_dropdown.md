...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7083afae...
...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7083afae...
#> ☐ Edit /tmp/Rtmpr0Li7l/file1cfd7083afae/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7083afae...
#> ✔ First episode created in /tmp/Rtmpr0Li7l/file1cfd7083afae/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7083afae...
...
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7083afae...
#> ✔ Lesson successfully created in /tmp/Rtmpr0Li7l/file1cfd7083afae
#> → Creating Lesson in /tmp/Rtmpr0Li7l/file1cfd7083afae...
#> /tmp/Rtmpr0Li7l/file1cfd7083afae
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmpr0Li7l/file1cfd7083afae/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmpr0Li7l/file1cfd7083afae/episodes/using-r.Rmd.
#> /tmp/Rtmpr0Li7l/file1cfd7083afae/episodes/using-r.Rmd
