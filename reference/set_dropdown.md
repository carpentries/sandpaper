...
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe4051ac06...
...
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe4051ac06...
#> ☐ Edit /tmp/RtmpHkg0h5/file1bfe4051ac06/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe4051ac06...
#> ✔ First episode created in /tmp/RtmpHkg0h5/file1bfe4051ac06/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe4051ac06...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe4051ac06...
#> ✔ Lesson successfully created in /tmp/RtmpHkg0h5/file1bfe4051ac06
#> → Creating Lesson in /tmp/RtmpHkg0h5/file1bfe4051ac06...
#> /tmp/RtmpHkg0h5/file1bfe4051ac06
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpHkg0h5/file1bfe4051ac06/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpHkg0h5/file1bfe4051ac06/episodes/using-r.Rmd.
#> /tmp/RtmpHkg0h5/file1bfe4051ac06/episodes/using-r.Rmd
