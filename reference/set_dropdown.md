...
#> → Creating Lesson in /tmp/RtmplVw70p/file19322ea0e178...
...
#> → Creating Lesson in /tmp/RtmplVw70p/file19322ea0e178...
#> ☐ Edit /tmp/RtmplVw70p/file19322ea0e178/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmplVw70p/file19322ea0e178...
#> ✔ First episode created in /tmp/RtmplVw70p/file19322ea0e178/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmplVw70p/file19322ea0e178...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmplVw70p/file19322ea0e178...
#> ✔ Lesson successfully created in /tmp/RtmplVw70p/file19322ea0e178
#> → Creating Lesson in /tmp/RtmplVw70p/file19322ea0e178...
#> /tmp/RtmplVw70p/file19322ea0e178
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmplVw70p/file19322ea0e178/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmplVw70p/file19322ea0e178/episodes/using-r.Rmd.
#> /tmp/RtmplVw70p/file19322ea0e178/episodes/using-r.Rmd
