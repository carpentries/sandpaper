...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05413b31d...
...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05413b31d...
#> ☐ Edit /tmp/RtmptmNyLK/file1c05413b31d/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05413b31d...
#> ✔ First episode created in /tmp/RtmptmNyLK/file1c05413b31d/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05413b31d...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05413b31d...
#> ✔ Lesson successfully created in /tmp/RtmptmNyLK/file1c05413b31d
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05413b31d...
#> /tmp/RtmptmNyLK/file1c05413b31d
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmptmNyLK/file1c05413b31d/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmptmNyLK/file1c05413b31d/episodes/using-r.Rmd.
#> /tmp/RtmptmNyLK/file1c05413b31d/episodes/using-r.Rmd
