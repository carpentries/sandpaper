...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe6fbdcf8e...
...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe6fbdcf8e...
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe6fbdcf8e/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe6fbdcf8e...
#> ✔ First episode created in /tmp/RtmpL2X6sE/file1bfe6fbdcf8e/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe6fbdcf8e...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe6fbdcf8e...
#> ✔ Lesson successfully created in /tmp/RtmpL2X6sE/file1bfe6fbdcf8e
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe6fbdcf8e...
#> /tmp/RtmpL2X6sE/file1bfe6fbdcf8e
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpL2X6sE/file1bfe6fbdcf8e/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe6fbdcf8e/episodes/using-r.Rmd.
#> /tmp/RtmpL2X6sE/file1bfe6fbdcf8e/episodes/using-r.Rmd
