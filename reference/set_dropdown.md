...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e55072ad8...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e55072ad8...
#> ☐ Edit /tmp/RtmpVcV2iC/file1b0e55072ad8/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e55072ad8...
#> ✔ First episode created in /tmp/RtmpVcV2iC/file1b0e55072ad8/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e55072ad8...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e55072ad8...
#> ✔ Lesson successfully created in /tmp/RtmpVcV2iC/file1b0e55072ad8
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e55072ad8...
#> /tmp/RtmpVcV2iC/file1b0e55072ad8
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpVcV2iC/file1b0e55072ad8/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpVcV2iC/file1b0e55072ad8/episodes/using-r.Rmd.
#> /tmp/RtmpVcV2iC/file1b0e55072ad8/episodes/using-r.Rmd
