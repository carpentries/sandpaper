...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0879df189e...
...
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0879df189e...
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c0879df189e/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0879df189e...
#> ✔ First episode created in /tmp/RtmpG8rnQJ/file1c0879df189e/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0879df189e...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0879df189e...
#> ✔ Lesson successfully created in /tmp/RtmpG8rnQJ/file1c0879df189e
#> → Creating Lesson in /tmp/RtmpG8rnQJ/file1c0879df189e...
#> /tmp/RtmpG8rnQJ/file1c0879df189e
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpG8rnQJ/file1c0879df189e/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpG8rnQJ/file1c0879df189e/episodes/using-r.Rmd.
#> /tmp/RtmpG8rnQJ/file1c0879df189e/episodes/using-r.Rmd
