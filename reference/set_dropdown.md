...
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09471163c4...
...
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09471163c4...
#> ☐ Edit /tmp/Rtmp9LdTx2/file1c09471163c4/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09471163c4...
#> ✔ First episode created in /tmp/Rtmp9LdTx2/file1c09471163c4/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09471163c4...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09471163c4...
#> ✔ Lesson successfully created in /tmp/Rtmp9LdTx2/file1c09471163c4
#> → Creating Lesson in /tmp/Rtmp9LdTx2/file1c09471163c4...
#> /tmp/Rtmp9LdTx2/file1c09471163c4
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmp9LdTx2/file1c09471163c4/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp9LdTx2/file1c09471163c4/episodes/using-r.Rmd.
#> /tmp/Rtmp9LdTx2/file1c09471163c4/episodes/using-r.Rmd
