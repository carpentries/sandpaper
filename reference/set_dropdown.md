...
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c592a327be5...
...
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c592a327be5...
#> ☐ Edit /tmp/RtmpqJUIxl/file1c592a327be5/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c592a327be5...
#> ✔ First episode created in /tmp/RtmpqJUIxl/file1c592a327be5/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c592a327be5...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c592a327be5...
#> ✔ Lesson successfully created in /tmp/RtmpqJUIxl/file1c592a327be5
#> → Creating Lesson in /tmp/RtmpqJUIxl/file1c592a327be5...
#> /tmp/RtmpqJUIxl/file1c592a327be5
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpqJUIxl/file1c592a327be5/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpqJUIxl/file1c592a327be5/episodes/using-r.Rmd.
#> /tmp/RtmpqJUIxl/file1c592a327be5/episodes/using-r.Rmd
