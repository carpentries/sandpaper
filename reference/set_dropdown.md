...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff5ff448ce...
...
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff5ff448ce...
#> ☐ Edit /tmp/RtmpuuNLIY/file1bff5ff448ce/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff5ff448ce...
#> ✔ First episode created in /tmp/RtmpuuNLIY/file1bff5ff448ce/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff5ff448ce...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff5ff448ce...
#> ✔ Lesson successfully created in /tmp/RtmpuuNLIY/file1bff5ff448ce
#> → Creating Lesson in /tmp/RtmpuuNLIY/file1bff5ff448ce...
#> /tmp/RtmpuuNLIY/file1bff5ff448ce
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpuuNLIY/file1bff5ff448ce/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpuuNLIY/file1bff5ff448ce/episodes/using-r.Rmd.
#> /tmp/RtmpuuNLIY/file1bff5ff448ce/episodes/using-r.Rmd
