...
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf3218b967e...
...
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf3218b967e...
#> ☐ Edit /tmp/Rtmpfmukg6/file1bf3218b967e/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf3218b967e...
#> ✔ First episode created in /tmp/Rtmpfmukg6/file1bf3218b967e/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf3218b967e...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf3218b967e...
#> ✔ Lesson successfully created in /tmp/Rtmpfmukg6/file1bf3218b967e
#> → Creating Lesson in /tmp/Rtmpfmukg6/file1bf3218b967e...
#> /tmp/Rtmpfmukg6/file1bf3218b967e
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmpfmukg6/file1bf3218b967e/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmpfmukg6/file1bf3218b967e/episodes/using-r.Rmd.
#> /tmp/Rtmpfmukg6/file1bf3218b967e/episodes/using-r.Rmd
