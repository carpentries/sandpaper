...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa222d45580...
...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa222d45580...
#> ☐ Edit /tmp/Rtmpw9vtxi/file1aa222d45580/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa222d45580...
#> ✔ First episode created in /tmp/Rtmpw9vtxi/file1aa222d45580/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa222d45580...
...
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa222d45580...
#> ✔ Lesson successfully created in /tmp/Rtmpw9vtxi/file1aa222d45580
#> → Creating Lesson in /tmp/Rtmpw9vtxi/file1aa222d45580...
#> /tmp/Rtmpw9vtxi/file1aa222d45580
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmpw9vtxi/file1aa222d45580/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmpw9vtxi/file1aa222d45580/episodes/using-r.Rmd.
#> /tmp/Rtmpw9vtxi/file1aa222d45580/episodes/using-r.Rmd
