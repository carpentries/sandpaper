...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01149500b4...
...
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01149500b4...
#> ☐ Edit /tmp/RtmpNIRNTg/file1c01149500b4/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01149500b4...
#> ✔ First episode created in /tmp/RtmpNIRNTg/file1c01149500b4/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01149500b4...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01149500b4...
#> ✔ Lesson successfully created in /tmp/RtmpNIRNTg/file1c01149500b4
#> → Creating Lesson in /tmp/RtmpNIRNTg/file1c01149500b4...
#> /tmp/RtmpNIRNTg/file1c01149500b4
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpNIRNTg/file1c01149500b4/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpNIRNTg/file1c01149500b4/episodes/using-r.Rmd.
#> /tmp/RtmpNIRNTg/file1c01149500b4/episodes/using-r.Rmd
