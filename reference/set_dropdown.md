...
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be676f3bc65...
...
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be676f3bc65...
#> ☐ Edit /tmp/RtmpszXVxM/file1be676f3bc65/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be676f3bc65...
#> ✔ First episode created in /tmp/RtmpszXVxM/file1be676f3bc65/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be676f3bc65...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be676f3bc65...
#> ✔ Lesson successfully created in /tmp/RtmpszXVxM/file1be676f3bc65
#> → Creating Lesson in /tmp/RtmpszXVxM/file1be676f3bc65...
#> /tmp/RtmpszXVxM/file1be676f3bc65
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpszXVxM/file1be676f3bc65/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpszXVxM/file1be676f3bc65/episodes/using-r.Rmd.
#> /tmp/RtmpszXVxM/file1be676f3bc65/episodes/using-r.Rmd
