...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff13fed898...
...
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff13fed898...
#> ☐ Edit /tmp/Rtmph9vhkW/file1bff13fed898/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff13fed898...
#> ✔ First episode created in /tmp/Rtmph9vhkW/file1bff13fed898/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff13fed898...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff13fed898...
#> ✔ Lesson successfully created in /tmp/Rtmph9vhkW/file1bff13fed898
#> → Creating Lesson in /tmp/Rtmph9vhkW/file1bff13fed898...
#> /tmp/Rtmph9vhkW/file1bff13fed898
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmph9vhkW/file1bff13fed898/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmph9vhkW/file1bff13fed898/episodes/using-r.Rmd.
#> /tmp/Rtmph9vhkW/file1bff13fed898/episodes/using-r.Rmd
