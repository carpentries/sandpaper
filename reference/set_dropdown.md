...
#> → Creating Lesson in /tmp/RtmpfD9rhg/file19394d60fc3c...
...
#> → Creating Lesson in /tmp/RtmpfD9rhg/file19394d60fc3c...
#> ☐ Edit /tmp/RtmpfD9rhg/file19394d60fc3c/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpfD9rhg/file19394d60fc3c...
#> ✔ First episode created in /tmp/RtmpfD9rhg/file19394d60fc3c/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpfD9rhg/file19394d60fc3c...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpfD9rhg/file19394d60fc3c...
#> ✔ Lesson successfully created in /tmp/RtmpfD9rhg/file19394d60fc3c
#> → Creating Lesson in /tmp/RtmpfD9rhg/file19394d60fc3c...
#> /tmp/RtmpfD9rhg/file19394d60fc3c
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpfD9rhg/file19394d60fc3c/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpfD9rhg/file19394d60fc3c/episodes/using-r.Rmd.
#> /tmp/RtmpfD9rhg/file19394d60fc3c/episodes/using-r.Rmd
