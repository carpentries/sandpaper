...
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b3637293707...
...
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b3637293707...
#> ☐ Edit /tmp/RtmpMXjarq/file1b3637293707/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b3637293707...
#> ✔ First episode created in /tmp/RtmpMXjarq/file1b3637293707/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b3637293707...
...
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b3637293707...
#> ✔ Lesson successfully created in /tmp/RtmpMXjarq/file1b3637293707
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b3637293707...
#> /tmp/RtmpMXjarq/file1b3637293707
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpMXjarq/file1b3637293707/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpMXjarq/file1b3637293707/episodes/using-r.Rmd.
#> /tmp/RtmpMXjarq/file1b3637293707/episodes/using-r.Rmd
