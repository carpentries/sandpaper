...
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5743d3e9d...
...
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5743d3e9d...
#> ☐ Edit /tmp/RtmppZSt3g/file1be5743d3e9d/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5743d3e9d...
#> ✔ First episode created in /tmp/RtmppZSt3g/file1be5743d3e9d/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5743d3e9d...
...
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5743d3e9d...
#> ✔ Lesson successfully created in /tmp/RtmppZSt3g/file1be5743d3e9d
#> → Creating Lesson in /tmp/RtmppZSt3g/file1be5743d3e9d...
#> /tmp/RtmppZSt3g/file1be5743d3e9d
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmppZSt3g/file1be5743d3e9d/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmppZSt3g/file1be5743d3e9d/episodes/using-r.Rmd.
#> /tmp/RtmppZSt3g/file1be5743d3e9d/episodes/using-r.Rmd
