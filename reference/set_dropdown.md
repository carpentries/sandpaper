...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d70e35aab...
...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d70e35aab...
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d70e35aab/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d70e35aab...
#> ✔ First episode created in /tmp/RtmpYhnOfg/file1a1d70e35aab/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d70e35aab...
...
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d70e35aab...
#> ✔ Lesson successfully created in /tmp/RtmpYhnOfg/file1a1d70e35aab
#> → Creating Lesson in /tmp/RtmpYhnOfg/file1a1d70e35aab...
#> /tmp/RtmpYhnOfg/file1a1d70e35aab
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpYhnOfg/file1a1d70e35aab/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpYhnOfg/file1a1d70e35aab/episodes/using-r.Rmd.
#> /tmp/RtmpYhnOfg/file1a1d70e35aab/episodes/using-r.Rmd
