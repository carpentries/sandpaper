...
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab3c9cf988...
...
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab3c9cf988...
#> ☐ Edit /tmp/RtmpzqWdxf/file1cab3c9cf988/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab3c9cf988...
#> ✔ First episode created in /tmp/RtmpzqWdxf/file1cab3c9cf988/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab3c9cf988...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab3c9cf988...
#> ✔ Lesson successfully created in /tmp/RtmpzqWdxf/file1cab3c9cf988
#> → Creating Lesson in /tmp/RtmpzqWdxf/file1cab3c9cf988...
#> /tmp/RtmpzqWdxf/file1cab3c9cf988
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpzqWdxf/file1cab3c9cf988/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpzqWdxf/file1cab3c9cf988/episodes/using-r.Rmd.
#> /tmp/RtmpzqWdxf/file1cab3c9cf988/episodes/using-r.Rmd
