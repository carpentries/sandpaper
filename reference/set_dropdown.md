...
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab41e1ecae4...
...
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab41e1ecae4...
#> ☐ Edit /tmp/RtmpvfYpdV/file1ab41e1ecae4/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab41e1ecae4...
#> ✔ First episode created in /tmp/RtmpvfYpdV/file1ab41e1ecae4/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab41e1ecae4...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab41e1ecae4...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab41e1ecae4...
#> ✔ Lesson successfully created in /tmp/RtmpvfYpdV/file1ab41e1ecae4
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab41e1ecae4...
#> /tmp/RtmpvfYpdV/file1ab41e1ecae4
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpvfYpdV/file1ab41e1ecae4/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpvfYpdV/file1ab41e1ecae4/episodes/using-r.Rmd.
#> /tmp/RtmpvfYpdV/file1ab41e1ecae4/episodes/using-r.Rmd
