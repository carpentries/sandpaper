...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a573d31a2d0...
...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a573d31a2d0...
#> ☐ Edit /tmp/RtmpHGsTUG/file1a573d31a2d0/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a573d31a2d0...
#> ✔ First episode created in /tmp/RtmpHGsTUG/file1a573d31a2d0/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a573d31a2d0...
...
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a573d31a2d0...
#> ✔ Lesson successfully created in /tmp/RtmpHGsTUG/file1a573d31a2d0
#> → Creating Lesson in /tmp/RtmpHGsTUG/file1a573d31a2d0...
#> /tmp/RtmpHGsTUG/file1a573d31a2d0
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpHGsTUG/file1a573d31a2d0/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpHGsTUG/file1a573d31a2d0/episodes/using-r.Rmd.
#> /tmp/RtmpHGsTUG/file1a573d31a2d0/episodes/using-r.Rmd
