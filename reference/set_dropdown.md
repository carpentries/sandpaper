...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file19422576d8...
...
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file19422576d8...
#> ☐ Edit /tmp/Rtmpy7dRDl/file19422576d8/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file19422576d8...
#> ✔ First episode created in /tmp/Rtmpy7dRDl/file19422576d8/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file19422576d8...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file19422576d8...
#> ✔ Lesson successfully created in /tmp/Rtmpy7dRDl/file19422576d8
#> → Creating Lesson in /tmp/Rtmpy7dRDl/file19422576d8...
#> /tmp/Rtmpy7dRDl/file19422576d8
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmpy7dRDl/file19422576d8/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmpy7dRDl/file19422576d8/episodes/using-r.Rmd.
#> /tmp/Rtmpy7dRDl/file19422576d8/episodes/using-r.Rmd
