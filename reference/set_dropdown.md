...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a916c75e81b...
...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a916c75e81b...
#> ☐ Edit /tmp/Rtmp82VLs2/file1a916c75e81b/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a916c75e81b...
#> ✔ First episode created in /tmp/Rtmp82VLs2/file1a916c75e81b/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a916c75e81b...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a916c75e81b...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a916c75e81b...
#> ✔ Lesson successfully created in /tmp/Rtmp82VLs2/file1a916c75e81b
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a916c75e81b...
#> /tmp/Rtmp82VLs2/file1a916c75e81b
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmp82VLs2/file1a916c75e81b/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp82VLs2/file1a916c75e81b/episodes/using-r.Rmd.
#> /tmp/Rtmp82VLs2/file1a916c75e81b/episodes/using-r.Rmd
