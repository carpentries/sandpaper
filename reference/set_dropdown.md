...
#> → Creating Lesson in /tmp/Rtmp6Cln26/file1bf9687999e3...
...
#> → Creating Lesson in /tmp/Rtmp6Cln26/file1bf9687999e3...
#> ☐ Edit /tmp/Rtmp6Cln26/file1bf9687999e3/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp6Cln26/file1bf9687999e3...
#> ✔ First episode created in /tmp/Rtmp6Cln26/file1bf9687999e3/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp6Cln26/file1bf9687999e3...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp6Cln26/file1bf9687999e3...
#> ✔ Lesson successfully created in /tmp/Rtmp6Cln26/file1bf9687999e3
#> → Creating Lesson in /tmp/Rtmp6Cln26/file1bf9687999e3...
#> /tmp/Rtmp6Cln26/file1bf9687999e3
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmp6Cln26/file1bf9687999e3/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp6Cln26/file1bf9687999e3/episodes/using-r.Rmd.
#> /tmp/Rtmp6Cln26/file1bf9687999e3/episodes/using-r.Rmd
