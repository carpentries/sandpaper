...
#> → Creating Lesson in /tmp/RtmpMShUNW/file19325cac8a30...
...
#> → Creating Lesson in /tmp/RtmpMShUNW/file19325cac8a30...
#> ☐ Edit /tmp/RtmpMShUNW/file19325cac8a30/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpMShUNW/file19325cac8a30...
#> ✔ First episode created in /tmp/RtmpMShUNW/file19325cac8a30/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpMShUNW/file19325cac8a30...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpMShUNW/file19325cac8a30...
#> ✔ Lesson successfully created in /tmp/RtmpMShUNW/file19325cac8a30
#> → Creating Lesson in /tmp/RtmpMShUNW/file19325cac8a30...
#> /tmp/RtmpMShUNW/file19325cac8a30
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpMShUNW/file19325cac8a30/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpMShUNW/file19325cac8a30/episodes/using-r.Rmd.
#> /tmp/RtmpMShUNW/file19325cac8a30/episodes/using-r.Rmd
