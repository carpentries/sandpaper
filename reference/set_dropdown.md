...
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d5a8aa68d...
...
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d5a8aa68d...
#> ☐ Edit /tmp/RtmpW7Mbc5/file199d5a8aa68d/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d5a8aa68d...
#> ✔ First episode created in /tmp/RtmpW7Mbc5/file199d5a8aa68d/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d5a8aa68d...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d5a8aa68d...
#> ✔ Lesson successfully created in /tmp/RtmpW7Mbc5/file199d5a8aa68d
#> → Creating Lesson in /tmp/RtmpW7Mbc5/file199d5a8aa68d...
#> /tmp/RtmpW7Mbc5/file199d5a8aa68d
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpW7Mbc5/file199d5a8aa68d/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpW7Mbc5/file199d5a8aa68d/episodes/using-r.Rmd.
#> /tmp/RtmpW7Mbc5/file199d5a8aa68d/episodes/using-r.Rmd
