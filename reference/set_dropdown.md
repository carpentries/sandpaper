...
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae558d2d0a...
...
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae558d2d0a...
#> ☐ Edit /tmp/RtmpqRlAf5/file1aae558d2d0a/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae558d2d0a...
#> ✔ First episode created in /tmp/RtmpqRlAf5/file1aae558d2d0a/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae558d2d0a...
...
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae558d2d0a...
#> ✔ Lesson successfully created in /tmp/RtmpqRlAf5/file1aae558d2d0a
#> → Creating Lesson in /tmp/RtmpqRlAf5/file1aae558d2d0a...
#> /tmp/RtmpqRlAf5/file1aae558d2d0a
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpqRlAf5/file1aae558d2d0a/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpqRlAf5/file1aae558d2d0a/episodes/using-r.Rmd.
#> /tmp/RtmpqRlAf5/file1aae558d2d0a/episodes/using-r.Rmd
