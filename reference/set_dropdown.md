...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1637845...
...
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1637845...
#> ☐ Edit /tmp/RtmpRhwHL2/file1ccf1637845/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1637845...
#> ✔ First episode created in /tmp/RtmpRhwHL2/file1ccf1637845/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1637845...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1637845...
#> ✔ Lesson successfully created in /tmp/RtmpRhwHL2/file1ccf1637845
#> → Creating Lesson in /tmp/RtmpRhwHL2/file1ccf1637845...
#> /tmp/RtmpRhwHL2/file1ccf1637845
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpRhwHL2/file1ccf1637845/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpRhwHL2/file1ccf1637845/episodes/using-r.Rmd.
#> /tmp/RtmpRhwHL2/file1ccf1637845/episodes/using-r.Rmd
