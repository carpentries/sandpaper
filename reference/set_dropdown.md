...
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7123489179...
...
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7123489179...
#> ☐ Edit /tmp/RtmpRJ0N7a/file1e7123489179/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7123489179...
#> ✔ First episode created in /tmp/RtmpRJ0N7a/file1e7123489179/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7123489179...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7123489179...
#> ✔ Lesson successfully created in /tmp/RtmpRJ0N7a/file1e7123489179
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7123489179...
#> /tmp/RtmpRJ0N7a/file1e7123489179
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpRJ0N7a/file1e7123489179/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpRJ0N7a/file1e7123489179/episodes/using-r.Rmd.
#> /tmp/RtmpRJ0N7a/file1e7123489179/episodes/using-r.Rmd
