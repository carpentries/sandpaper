...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc743e85b...
...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc743e85b...
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc743e85b/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc743e85b...
#> ✔ First episode created in /tmp/Rtmp4syuyP/file1cc743e85b/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc743e85b...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc743e85b...
#> ✔ Lesson successfully created in /tmp/Rtmp4syuyP/file1cc743e85b
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc743e85b...
#> /tmp/Rtmp4syuyP/file1cc743e85b
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmp4syuyP/file1cc743e85b/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc743e85b/episodes/using-r.Rmd.
#> /tmp/Rtmp4syuyP/file1cc743e85b/episodes/using-r.Rmd
