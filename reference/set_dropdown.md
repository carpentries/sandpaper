...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d57d48877...
...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d57d48877...
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d57d48877/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d57d48877...
#> ✔ First episode created in /tmp/RtmpFQ2hak/file1a5d57d48877/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d57d48877...
...
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d57d48877...
#> ✔ Lesson successfully created in /tmp/RtmpFQ2hak/file1a5d57d48877
#> → Creating Lesson in /tmp/RtmpFQ2hak/file1a5d57d48877...
#> /tmp/RtmpFQ2hak/file1a5d57d48877
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpFQ2hak/file1a5d57d48877/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpFQ2hak/file1a5d57d48877/episodes/using-r.Rmd.
#> /tmp/RtmpFQ2hak/file1a5d57d48877/episodes/using-r.Rmd
