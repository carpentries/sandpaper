...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7259a8ead...
...
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7259a8ead...
#> ☐ Edit /tmp/Rtmp4syuyP/file1cc7259a8ead/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7259a8ead...
#> ✔ First episode created in /tmp/Rtmp4syuyP/file1cc7259a8ead/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7259a8ead...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7259a8ead...
#> ✔ Lesson successfully created in /tmp/Rtmp4syuyP/file1cc7259a8ead
#> → Creating Lesson in /tmp/Rtmp4syuyP/file1cc7259a8ead...
#> /tmp/Rtmp4syuyP/file1cc7259a8ead
check_lesson(tmp)
