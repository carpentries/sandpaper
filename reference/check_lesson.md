...
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b36173175d4...
...
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b36173175d4...
#> ☐ Edit /tmp/RtmpMXjarq/file1b36173175d4/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b36173175d4...
#> ✔ First episode created in /tmp/RtmpMXjarq/file1b36173175d4/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b36173175d4...
...
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b36173175d4...
#> ✔ Lesson successfully created in /tmp/RtmpMXjarq/file1b36173175d4
#> → Creating Lesson in /tmp/RtmpMXjarq/file1b36173175d4...
#> /tmp/RtmpMXjarq/file1b36173175d4
check_lesson(tmp)
