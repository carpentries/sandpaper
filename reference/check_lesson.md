...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a912f230e8...
...
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a912f230e8...
#> ☐ Edit /tmp/Rtmp82VLs2/file1a912f230e8/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a912f230e8...
#> ✔ First episode created in /tmp/Rtmp82VLs2/file1a912f230e8/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a912f230e8...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a912f230e8...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a912f230e8...
#> ✔ Lesson successfully created in /tmp/Rtmp82VLs2/file1a912f230e8
#> → Creating Lesson in /tmp/Rtmp82VLs2/file1a912f230e8...
#> /tmp/Rtmp82VLs2/file1a912f230e8
check_lesson(tmp)
