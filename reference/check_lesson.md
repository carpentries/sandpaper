...
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7174078cd6...
...
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7174078cd6...
#> ☐ Edit /tmp/RtmpRJ0N7a/file1e7174078cd6/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7174078cd6...
#> ✔ First episode created in /tmp/RtmpRJ0N7a/file1e7174078cd6/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7174078cd6...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7174078cd6...
#> ✔ Lesson successfully created in /tmp/RtmpRJ0N7a/file1e7174078cd6
#> → Creating Lesson in /tmp/RtmpRJ0N7a/file1e7174078cd6...
#> /tmp/RtmpRJ0N7a/file1e7174078cd6
check_lesson(tmp)
