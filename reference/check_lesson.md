...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05680590e3...
...
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05680590e3...
#> ☐ Edit /tmp/RtmptmNyLK/file1c05680590e3/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05680590e3...
#> ✔ First episode created in /tmp/RtmptmNyLK/file1c05680590e3/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05680590e3...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05680590e3...
#> ✔ Lesson successfully created in /tmp/RtmptmNyLK/file1c05680590e3
#> → Creating Lesson in /tmp/RtmptmNyLK/file1c05680590e3...
#> /tmp/RtmptmNyLK/file1c05680590e3
check_lesson(tmp)
