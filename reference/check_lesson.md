...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe2ecdc31a...
...
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe2ecdc31a...
#> ☐ Edit /tmp/RtmpL2X6sE/file1bfe2ecdc31a/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe2ecdc31a...
#> ✔ First episode created in /tmp/RtmpL2X6sE/file1bfe2ecdc31a/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe2ecdc31a...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe2ecdc31a...
#> ✔ Lesson successfully created in /tmp/RtmpL2X6sE/file1bfe2ecdc31a
#> → Creating Lesson in /tmp/RtmpL2X6sE/file1bfe2ecdc31a...
#> /tmp/RtmpL2X6sE/file1bfe2ecdc31a
check_lesson(tmp)
