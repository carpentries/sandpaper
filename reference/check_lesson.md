...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e4de6dd3f...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e4de6dd3f...
#> ☐ Edit /tmp/RtmpVcV2iC/file1b0e4de6dd3f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e4de6dd3f...
#> ✔ First episode created in /tmp/RtmpVcV2iC/file1b0e4de6dd3f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e4de6dd3f...
...
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e4de6dd3f...
#> ✔ Lesson successfully created in /tmp/RtmpVcV2iC/file1b0e4de6dd3f
#> → Creating Lesson in /tmp/RtmpVcV2iC/file1b0e4de6dd3f...
#> /tmp/RtmpVcV2iC/file1b0e4de6dd3f
check_lesson(tmp)
