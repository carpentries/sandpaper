...
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab44354449a...
...
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab44354449a...
#> ☐ Edit /tmp/RtmpvfYpdV/file1ab44354449a/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab44354449a...
#> ✔ First episode created in /tmp/RtmpvfYpdV/file1ab44354449a/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab44354449a...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab44354449a...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab44354449a...
#> ✔ Lesson successfully created in /tmp/RtmpvfYpdV/file1ab44354449a
#> → Creating Lesson in /tmp/RtmpvfYpdV/file1ab44354449a...
#> /tmp/RtmpvfYpdV/file1ab44354449a
check_lesson(tmp)
