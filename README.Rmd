...
| [{gert}] | a "batteries included" git interface for R |
...
2. html files are generated from the rendered markdown files and the CSS and JS
   sources in the {sandpaper} package for the preview.
...
folder. The only thing controling how these files will appear is the name of the
file themselves, no config necessary :)
