...
The documentation for using {sandpaper} as the new template, presented as a 
Carpentries-style lesson can be found at 
<https://zkamvar.github.io/sandpaper-docs/>. If, instead, you are interested in
...
[Carpentries drat repository](https://carpentries.github.io/drat/) (updated 
every 12 hours) with the following commands:
