...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec76405fac...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec76405fac...
#> ☐ Edit /tmp/Rtmps3YM4i/file1aec76405fac/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec76405fac...
#> ✔ First episode created in /tmp/Rtmps3YM4i/file1aec76405fac/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec76405fac...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec76405fac...
#> ✔ Lesson successfully created in /tmp/Rtmps3YM4i/file1aec76405fac
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec76405fac...
#> /tmp/Rtmps3YM4i/file1aec76405fac
