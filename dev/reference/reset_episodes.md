...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a753612efd8...
...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a753612efd8...
#> ☐ Edit /tmp/RtmpJOJxpS/file1a753612efd8/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a753612efd8...
#> ✔ First episode created in /tmp/RtmpJOJxpS/file1a753612efd8/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a753612efd8...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a753612efd8...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a753612efd8...
#> ✔ Lesson successfully created in /tmp/RtmpJOJxpS/file1a753612efd8
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a753612efd8...
#> /tmp/RtmpJOJxpS/file1a753612efd8
