...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpACXc8B/file1aa43beabad0': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43beabad0...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43beabad0...
#> ☐ Edit /tmp/RtmpACXc8B/file1aa43beabad0/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43beabad0...
#> ✔ First episode created in /tmp/RtmpACXc8B/file1aa43beabad0/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43beabad0...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43beabad0...
#> ✔ Lesson successfully created in /tmp/RtmpACXc8B/file1aa43beabad0
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43beabad0...
#> /tmp/RtmpACXc8B/file1aa43beabad0
...
#> [1] "/tmp/RtmpACXc8B/file1aa43beabad0/episodes/introduction.Rmd"
#> [2] "/tmp/RtmpACXc8B/file1aa43beabad0/episodes/files/hi.md"     
#> 
#> $CODE_OF_CONDUCT.md
#> /tmp/RtmpACXc8B/file1aa43beabad0/CODE_OF_CONDUCT.md
#> 
#> $CONTRIBUTING.md
#> /tmp/RtmpACXc8B/file1aa43beabad0/CONTRIBUTING.md
#> 
#> $LICENSE.md
#> /tmp/RtmpACXc8B/file1aa43beabad0/LICENSE.md
#> 
#> $README.md
#> /tmp/RtmpACXc8B/file1aa43beabad0/README.md
#> 
#> $index.md
#> /tmp/RtmpACXc8B/file1aa43beabad0/index.md
#> 
#> $links.md
#> /tmp/RtmpACXc8B/file1aa43beabad0/links.md
#> 
#> $`instructors/instructor-notes.md`
#> /tmp/RtmpACXc8B/file1aa43beabad0/instructors/instructor-notes.md
#> 
#> $`learners/reference.md`
#> /tmp/RtmpACXc8B/file1aa43beabad0/learners/reference.md
#> 
#> $`learners/setup.md`
#> /tmp/RtmpACXc8B/file1aa43beabad0/learners/setup.md
#> 
#> $`profiles/learner-profiles.md`
#> /tmp/RtmpACXc8B/file1aa43beabad0/profiles/learner-profiles.md
#> 
