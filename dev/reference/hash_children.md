...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpJOJxpS/file1a756501da8': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a756501da8...
...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a756501da8...
#> ☐ Edit /tmp/RtmpJOJxpS/file1a756501da8/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a756501da8...
#> ✔ First episode created in /tmp/RtmpJOJxpS/file1a756501da8/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a756501da8...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a756501da8...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a756501da8...
#> ✔ Lesson successfully created in /tmp/RtmpJOJxpS/file1a756501da8
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a756501da8...
#> /tmp/RtmpJOJxpS/file1a756501da8
...
#> [1] "/tmp/RtmpJOJxpS/file1a756501da8/episodes/introduction.Rmd"
#> [2] "/tmp/RtmpJOJxpS/file1a756501da8/episodes/files/hi.md"     
#> 
#> $CODE_OF_CONDUCT.md
#> /tmp/RtmpJOJxpS/file1a756501da8/CODE_OF_CONDUCT.md
#> 
#> $CONTRIBUTING.md
#> /tmp/RtmpJOJxpS/file1a756501da8/CONTRIBUTING.md
#> 
#> $LICENSE.md
#> /tmp/RtmpJOJxpS/file1a756501da8/LICENSE.md
#> 
#> $README.md
#> /tmp/RtmpJOJxpS/file1a756501da8/README.md
#> 
#> $index.md
#> /tmp/RtmpJOJxpS/file1a756501da8/index.md
#> 
#> $links.md
#> /tmp/RtmpJOJxpS/file1a756501da8/links.md
#> 
#> $`instructors/instructor-notes.md`
#> /tmp/RtmpJOJxpS/file1a756501da8/instructors/instructor-notes.md
#> 
#> $`learners/reference.md`
#> /tmp/RtmpJOJxpS/file1a756501da8/learners/reference.md
#> 
#> $`learners/setup.md`
#> /tmp/RtmpJOJxpS/file1a756501da8/learners/setup.md
#> 
#> $`profiles/learner-profiles.md`
#> /tmp/RtmpJOJxpS/file1a756501da8/profiles/learner-profiles.md
#> 
