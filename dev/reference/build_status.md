...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpUfNzdK/file1c874bf51485': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c874bf51485...
...
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c874bf51485...
#> ☐ Edit /tmp/RtmpUfNzdK/file1c874bf51485/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c874bf51485...
#> ✔ First episode created in /tmp/RtmpUfNzdK/file1c874bf51485/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c874bf51485...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c874bf51485...
#> ✔ Lesson successfully created in /tmp/RtmpUfNzdK/file1c874bf51485
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c874bf51485...
#> /tmp/RtmpUfNzdK/file1c874bf51485
...
#> $build
#> /tmp/RtmpUfNzdK/file1c874bf51485/episodes/introduction.md
#> /tmp/RtmpUfNzdK/file1c874bf51485/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpUfNzdK/file1c874bf51485/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpUfNzdK/file1c874bf51485/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpUfNzdK/file1c874bf51485/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpUfNzdK/file1c874bf51485/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpUfNzdK/file1c874bf51485/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpUfNzdK/file1c874bf51485/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpUfNzdK/file1c874bf51485/episodes/introduction.md 2026-02-23
#> /tmp/RtmpUfNzdK/file1c874bf51485/index.md                 2026-02-23
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-02-23
#> 2        site/built/index.md 2026-02-23
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpUfNzdK/file1c874bf51485/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpUfNzdK/file1c874bf51485/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-02-23
#> 1        site/built/index.md 2026-02-23
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
