...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpJOJxpS/file1a755df08697': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a755df08697...
...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a755df08697...
#> ☐ Edit /tmp/RtmpJOJxpS/file1a755df08697/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a755df08697...
#> ✔ First episode created in /tmp/RtmpJOJxpS/file1a755df08697/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a755df08697...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a755df08697...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a755df08697...
#> ✔ Lesson successfully created in /tmp/RtmpJOJxpS/file1a755df08697
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a755df08697...
#> /tmp/RtmpJOJxpS/file1a755df08697
...
#> $build
#> /tmp/RtmpJOJxpS/file1a755df08697/episodes/introduction.md
#> /tmp/RtmpJOJxpS/file1a755df08697/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpJOJxpS/file1a755df08697/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpJOJxpS/file1a755df08697/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpJOJxpS/file1a755df08697/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpJOJxpS/file1a755df08697/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpJOJxpS/file1a755df08697/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpJOJxpS/file1a755df08697/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpJOJxpS/file1a755df08697/episodes/introduction.md 2026-02-26
#> /tmp/RtmpJOJxpS/file1a755df08697/index.md                 2026-02-26
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-02-26
#> 2        site/built/index.md 2026-02-26
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpJOJxpS/file1a755df08697/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpJOJxpS/file1a755df08697/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-02-26
#> 1        site/built/index.md 2026-02-26
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
