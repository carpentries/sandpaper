...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpcTm5wz/file1c011139bec6': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011139bec6...
...
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011139bec6...
#> ☐ Edit /tmp/RtmpcTm5wz/file1c011139bec6/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011139bec6...
#> ✔ First episode created in /tmp/RtmpcTm5wz/file1c011139bec6/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011139bec6...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011139bec6...
#> ✔ Lesson successfully created in /tmp/RtmpcTm5wz/file1c011139bec6
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011139bec6...
#> /tmp/RtmpcTm5wz/file1c011139bec6
...
#> $build
#> /tmp/RtmpcTm5wz/file1c011139bec6/episodes/introduction.md
#> /tmp/RtmpcTm5wz/file1c011139bec6/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpcTm5wz/file1c011139bec6/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpcTm5wz/file1c011139bec6/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpcTm5wz/file1c011139bec6/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpcTm5wz/file1c011139bec6/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpcTm5wz/file1c011139bec6/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpcTm5wz/file1c011139bec6/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpcTm5wz/file1c011139bec6/episodes/introduction.md 2026-01-17
#> /tmp/RtmpcTm5wz/file1c011139bec6/index.md                 2026-01-17
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-01-17
#> 2        site/built/index.md 2026-01-17
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpcTm5wz/file1c011139bec6/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpcTm5wz/file1c011139bec6/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-01-17
#> 1        site/built/index.md 2026-01-17
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
