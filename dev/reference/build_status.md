...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmps3YM4i/file1aec10b6b340': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec10b6b340...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec10b6b340...
#> ☐ Edit /tmp/Rtmps3YM4i/file1aec10b6b340/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec10b6b340...
#> ✔ First episode created in /tmp/Rtmps3YM4i/file1aec10b6b340/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec10b6b340...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec10b6b340...
#> ✔ Lesson successfully created in /tmp/Rtmps3YM4i/file1aec10b6b340
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec10b6b340...
#> /tmp/Rtmps3YM4i/file1aec10b6b340
...
#> $build
#> /tmp/Rtmps3YM4i/file1aec10b6b340/episodes/introduction.md
#> /tmp/Rtmps3YM4i/file1aec10b6b340/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/Rtmps3YM4i/file1aec10b6b340/episodes/introduction.md episodes/introduction.md
#> /tmp/Rtmps3YM4i/file1aec10b6b340/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/Rtmps3YM4i/file1aec10b6b340/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/Rtmps3YM4i/file1aec10b6b340/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/Rtmps3YM4i/file1aec10b6b340/episodes/introduction.md site/built/introduction.md
#> /tmp/Rtmps3YM4i/file1aec10b6b340/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/Rtmps3YM4i/file1aec10b6b340/episodes/introduction.md 2026-07-03
#> /tmp/Rtmps3YM4i/file1aec10b6b340/index.md                 2026-07-03
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-07-03
#> 2        site/built/index.md 2026-07-03
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/Rtmps3YM4i/file1aec10b6b340/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/Rtmps3YM4i/file1aec10b6b340/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-07-03
#> 1        site/built/index.md 2026-07-03
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
