...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpUnRg90/file1c4543fb1a3f': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4543fb1a3f...
...
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4543fb1a3f...
#> ☐ Edit /tmp/RtmpUnRg90/file1c4543fb1a3f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4543fb1a3f...
#> ✔ First episode created in /tmp/RtmpUnRg90/file1c4543fb1a3f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4543fb1a3f...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4543fb1a3f...
#> ✔ Lesson successfully created in /tmp/RtmpUnRg90/file1c4543fb1a3f
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4543fb1a3f...
#> /tmp/RtmpUnRg90/file1c4543fb1a3f
...
#> $build
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/episodes/introduction.md
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/episodes/introduction.md 2026-02-11
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/index.md                 2026-02-11
#> 
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpUnRg90/file1c4543fb1a3f/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
