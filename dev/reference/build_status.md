...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpofsREx/file1c8b2eaf8149': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2eaf8149...
...
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2eaf8149...
#> ☐ Edit /tmp/RtmpofsREx/file1c8b2eaf8149/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2eaf8149...
#> ✔ First episode created in /tmp/RtmpofsREx/file1c8b2eaf8149/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2eaf8149...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2eaf8149...
#> ✔ Lesson successfully created in /tmp/RtmpofsREx/file1c8b2eaf8149
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2eaf8149...
#> /tmp/RtmpofsREx/file1c8b2eaf8149
...
#> $build
#> /tmp/RtmpofsREx/file1c8b2eaf8149/episodes/introduction.md
#> /tmp/RtmpofsREx/file1c8b2eaf8149/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpofsREx/file1c8b2eaf8149/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpofsREx/file1c8b2eaf8149/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpofsREx/file1c8b2eaf8149/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpofsREx/file1c8b2eaf8149/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpofsREx/file1c8b2eaf8149/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpofsREx/file1c8b2eaf8149/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpofsREx/file1c8b2eaf8149/episodes/introduction.md 2026-02-12
#> /tmp/RtmpofsREx/file1c8b2eaf8149/index.md                 2026-02-12
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-02-12
#> 2        site/built/index.md 2026-02-12
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpofsREx/file1c8b2eaf8149/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpofsREx/file1c8b2eaf8149/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-02-12
#> 1        site/built/index.md 2026-02-12
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
