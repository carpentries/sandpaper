...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmp6yLLZk/file1acc6a88d461': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc6a88d461...
...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc6a88d461...
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc6a88d461/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc6a88d461...
#> ✔ First episode created in /tmp/Rtmp6yLLZk/file1acc6a88d461/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc6a88d461...
...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc6a88d461...
#> ✔ Lesson successfully created in /tmp/Rtmp6yLLZk/file1acc6a88d461
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc6a88d461...
#> /tmp/Rtmp6yLLZk/file1acc6a88d461
...
#> $build
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/episodes/introduction.md
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/episodes/introduction.md episodes/introduction.md
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/episodes/introduction.md site/built/introduction.md
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/episodes/introduction.md 2026-07-15
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/index.md                 2026-07-15
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-07-15
#> 2        site/built/index.md 2026-07-15
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/Rtmp6yLLZk/file1acc6a88d461/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-07-15
#> 1        site/built/index.md 2026-07-15
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
