...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpH5UNvd/file1daf44457c1c': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1daf44457c1c...
...
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1daf44457c1c...
#> ☐ Edit /tmp/RtmpH5UNvd/file1daf44457c1c/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1daf44457c1c...
#> ✔ First episode created in /tmp/RtmpH5UNvd/file1daf44457c1c/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1daf44457c1c...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1daf44457c1c...
#> ✔ Lesson successfully created in /tmp/RtmpH5UNvd/file1daf44457c1c
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1daf44457c1c...
#> /tmp/RtmpH5UNvd/file1daf44457c1c
...
#> $build
#> /tmp/RtmpH5UNvd/file1daf44457c1c/episodes/introduction.md
#> /tmp/RtmpH5UNvd/file1daf44457c1c/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/RtmpH5UNvd/file1daf44457c1c/episodes/introduction.md episodes/introduction.md
#> /tmp/RtmpH5UNvd/file1daf44457c1c/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/RtmpH5UNvd/file1daf44457c1c/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/RtmpH5UNvd/file1daf44457c1c/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/RtmpH5UNvd/file1daf44457c1c/episodes/introduction.md site/built/introduction.md
#> /tmp/RtmpH5UNvd/file1daf44457c1c/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/RtmpH5UNvd/file1daf44457c1c/episodes/introduction.md 2026-02-24
#> /tmp/RtmpH5UNvd/file1daf44457c1c/index.md                 2026-02-24
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-02-24
#> 2        site/built/index.md 2026-02-24
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/RtmpH5UNvd/file1daf44457c1c/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/RtmpH5UNvd/file1daf44457c1c/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-02-24
#> 1        site/built/index.md 2026-02-24
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
