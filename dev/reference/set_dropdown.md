...
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d509fa264f...
...
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d509fa264f...
#> ☐ Edit /tmp/RtmpPAgXQL/file1d509fa264f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d509fa264f...
#> ✔ First episode created in /tmp/RtmpPAgXQL/file1d509fa264f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d509fa264f...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d509fa264f...
#> ✔ Lesson successfully created in /tmp/RtmpPAgXQL/file1d509fa264f
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d509fa264f...
#> /tmp/RtmpPAgXQL/file1d509fa264f
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpPAgXQL/file1d509fa264f/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpPAgXQL/file1d509fa264f/episodes/using-r.Rmd.
#> /tmp/RtmpPAgXQL/file1d509fa264f/episodes/using-r.Rmd
