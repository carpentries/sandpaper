...
#> → Creating Lesson in /tmp/RtmpPxAdba/file19f91ecf9c33...
...
#> → Creating Lesson in /tmp/RtmpPxAdba/file19f91ecf9c33...
#> ☐ Edit /tmp/RtmpPxAdba/file19f91ecf9c33/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpPxAdba/file19f91ecf9c33...
#> ✔ First episode created in /tmp/RtmpPxAdba/file19f91ecf9c33/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpPxAdba/file19f91ecf9c33...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpPxAdba/file19f91ecf9c33...
#> ✔ Lesson successfully created in /tmp/RtmpPxAdba/file19f91ecf9c33
#> → Creating Lesson in /tmp/RtmpPxAdba/file19f91ecf9c33...
#> /tmp/RtmpPxAdba/file19f91ecf9c33
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpPxAdba/file19f91ecf9c33/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpPxAdba/file19f91ecf9c33/episodes/using-r.Rmd.
#> /tmp/RtmpPxAdba/file19f91ecf9c33/episodes/using-r.Rmd
