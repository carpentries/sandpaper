...
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011f34760c...
...
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011f34760c...
#> ☐ Edit /tmp/RtmpcTm5wz/file1c011f34760c/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011f34760c...
#> ✔ First episode created in /tmp/RtmpcTm5wz/file1c011f34760c/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011f34760c...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011f34760c...
#> ✔ Lesson successfully created in /tmp/RtmpcTm5wz/file1c011f34760c
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c011f34760c...
#> /tmp/RtmpcTm5wz/file1c011f34760c
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpcTm5wz/file1c011f34760c/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpcTm5wz/file1c011f34760c/episodes/using-r.Rmd.
#> /tmp/RtmpcTm5wz/file1c011f34760c/episodes/using-r.Rmd
