...
#> → Creating Lesson in /tmp/RtmpjJX7eW/file199e3d65a5f1...
...
#> → Creating Lesson in /tmp/RtmpjJX7eW/file199e3d65a5f1...
#> ☐ Edit /tmp/RtmpjJX7eW/file199e3d65a5f1/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpjJX7eW/file199e3d65a5f1...
#> ✔ First episode created in /tmp/RtmpjJX7eW/file199e3d65a5f1/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpjJX7eW/file199e3d65a5f1...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpjJX7eW/file199e3d65a5f1...
#> ✔ Lesson successfully created in /tmp/RtmpjJX7eW/file199e3d65a5f1
#> → Creating Lesson in /tmp/RtmpjJX7eW/file199e3d65a5f1...
#> /tmp/RtmpjJX7eW/file199e3d65a5f1
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpjJX7eW/file199e3d65a5f1/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpjJX7eW/file199e3d65a5f1/episodes/using-r.Rmd.
#> /tmp/RtmpjJX7eW/file199e3d65a5f1/episodes/using-r.Rmd
