...
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c45622842e2...
...
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c45622842e2...
#> ☐ Edit /tmp/RtmpUnRg90/file1c45622842e2/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c45622842e2...
#> ✔ First episode created in /tmp/RtmpUnRg90/file1c45622842e2/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c45622842e2...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c45622842e2...
#> ✔ Lesson successfully created in /tmp/RtmpUnRg90/file1c45622842e2
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c45622842e2...
#> /tmp/RtmpUnRg90/file1c45622842e2
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpUnRg90/file1c45622842e2/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpUnRg90/file1c45622842e2/episodes/using-r.Rmd.
#> /tmp/RtmpUnRg90/file1c45622842e2/episodes/using-r.Rmd
