...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e2436f4b3...
...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e2436f4b3...
#> ☐ Edit /tmp/RtmpgOPyFN/file1a7e2436f4b3/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e2436f4b3...
#> ✔ First episode created in /tmp/RtmpgOPyFN/file1a7e2436f4b3/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e2436f4b3...
...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e2436f4b3...
#> ✔ Lesson successfully created in /tmp/RtmpgOPyFN/file1a7e2436f4b3
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e2436f4b3...
#> /tmp/RtmpgOPyFN/file1a7e2436f4b3
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpgOPyFN/file1a7e2436f4b3/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpgOPyFN/file1a7e2436f4b3/episodes/using-r.Rmd.
#> /tmp/RtmpgOPyFN/file1a7e2436f4b3/episodes/using-r.Rmd
