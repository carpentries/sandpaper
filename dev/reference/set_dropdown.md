...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7537e1445a...
...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7537e1445a...
#> ☐ Edit /tmp/RtmpJOJxpS/file1a7537e1445a/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7537e1445a...
#> ✔ First episode created in /tmp/RtmpJOJxpS/file1a7537e1445a/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7537e1445a...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7537e1445a...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7537e1445a...
#> ✔ Lesson successfully created in /tmp/RtmpJOJxpS/file1a7537e1445a
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7537e1445a...
#> /tmp/RtmpJOJxpS/file1a7537e1445a
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpJOJxpS/file1a7537e1445a/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpJOJxpS/file1a7537e1445a/episodes/using-r.Rmd.
#> /tmp/RtmpJOJxpS/file1a7537e1445a/episodes/using-r.Rmd
