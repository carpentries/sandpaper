...
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b112165f6...
...
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b112165f6...
#> ☐ Edit /tmp/RtmpofsREx/file1c8b112165f6/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b112165f6...
#> ✔ First episode created in /tmp/RtmpofsREx/file1c8b112165f6/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b112165f6...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b112165f6...
#> ✔ Lesson successfully created in /tmp/RtmpofsREx/file1c8b112165f6
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b112165f6...
#> /tmp/RtmpofsREx/file1c8b112165f6
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpofsREx/file1c8b112165f6/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpofsREx/file1c8b112165f6/episodes/using-r.Rmd.
#> /tmp/RtmpofsREx/file1c8b112165f6/episodes/using-r.Rmd
