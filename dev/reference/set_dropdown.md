...
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c2532b94762...
...
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c2532b94762...
#> ☐ Edit /tmp/Rtmp2oQNAm/file1c2532b94762/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c2532b94762...
#> ✔ First episode created in /tmp/Rtmp2oQNAm/file1c2532b94762/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c2532b94762...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c2532b94762...
#> ✔ Lesson successfully created in /tmp/Rtmp2oQNAm/file1c2532b94762
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c2532b94762...
#> /tmp/Rtmp2oQNAm/file1c2532b94762
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmp2oQNAm/file1c2532b94762/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp2oQNAm/file1c2532b94762/episodes/using-r.Rmd.
#> /tmp/Rtmp2oQNAm/file1c2532b94762/episodes/using-r.Rmd
