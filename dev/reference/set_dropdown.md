...
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae33d91cbfd...
...
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae33d91cbfd...
#> ☐ Edit /tmp/RtmpUTI0d7/file1ae33d91cbfd/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae33d91cbfd...
#> ✔ First episode created in /tmp/RtmpUTI0d7/file1ae33d91cbfd/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae33d91cbfd...
...
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae33d91cbfd...
#> ✔ Lesson successfully created in /tmp/RtmpUTI0d7/file1ae33d91cbfd
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae33d91cbfd...
#> /tmp/RtmpUTI0d7/file1ae33d91cbfd
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpUTI0d7/file1ae33d91cbfd/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpUTI0d7/file1ae33d91cbfd/episodes/using-r.Rmd.
#> /tmp/RtmpUTI0d7/file1ae33d91cbfd/episodes/using-r.Rmd
