...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc2e5b9592...
...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc2e5b9592...
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc2e5b9592/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc2e5b9592...
#> ✔ First episode created in /tmp/Rtmp6yLLZk/file1acc2e5b9592/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc2e5b9592...
...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc2e5b9592...
#> ✔ Lesson successfully created in /tmp/Rtmp6yLLZk/file1acc2e5b9592
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc2e5b9592...
#> /tmp/Rtmp6yLLZk/file1acc2e5b9592
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmp6yLLZk/file1acc2e5b9592/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc2e5b9592/episodes/using-r.Rmd.
#> /tmp/Rtmp6yLLZk/file1acc2e5b9592/episodes/using-r.Rmd
