...
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1dafa26e07b...
...
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1dafa26e07b...
#> ☐ Edit /tmp/RtmpH5UNvd/file1dafa26e07b/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1dafa26e07b...
#> ✔ First episode created in /tmp/RtmpH5UNvd/file1dafa26e07b/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1dafa26e07b...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1dafa26e07b...
#> ✔ Lesson successfully created in /tmp/RtmpH5UNvd/file1dafa26e07b
#> → Creating Lesson in /tmp/RtmpH5UNvd/file1dafa26e07b...
#> /tmp/RtmpH5UNvd/file1dafa26e07b
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpH5UNvd/file1dafa26e07b/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpH5UNvd/file1dafa26e07b/episodes/using-r.Rmd.
#> /tmp/RtmpH5UNvd/file1dafa26e07b/episodes/using-r.Rmd
