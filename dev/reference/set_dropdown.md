...
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd79abe7f3...
...
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd79abe7f3...
#> ☐ Edit /tmp/RtmpukkbJ4/file1bfd79abe7f3/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd79abe7f3...
#> ✔ First episode created in /tmp/RtmpukkbJ4/file1bfd79abe7f3/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd79abe7f3...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd79abe7f3...
#> ✔ Lesson successfully created in /tmp/RtmpukkbJ4/file1bfd79abe7f3
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd79abe7f3...
#> /tmp/RtmpukkbJ4/file1bfd79abe7f3
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpukkbJ4/file1bfd79abe7f3/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpukkbJ4/file1bfd79abe7f3/episodes/using-r.Rmd.
#> /tmp/RtmpukkbJ4/file1bfd79abe7f3/episodes/using-r.Rmd
