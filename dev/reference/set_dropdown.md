...
#> → Creating Lesson in /tmp/Rtmp9MemTm/file199edecd5a2...
...
#> → Creating Lesson in /tmp/Rtmp9MemTm/file199edecd5a2...
#> ☐ Edit /tmp/Rtmp9MemTm/file199edecd5a2/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp9MemTm/file199edecd5a2...
#> ✔ First episode created in /tmp/Rtmp9MemTm/file199edecd5a2/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp9MemTm/file199edecd5a2...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp9MemTm/file199edecd5a2...
#> ✔ Lesson successfully created in /tmp/Rtmp9MemTm/file199edecd5a2
#> → Creating Lesson in /tmp/Rtmp9MemTm/file199edecd5a2...
#> /tmp/Rtmp9MemTm/file199edecd5a2
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmp9MemTm/file199edecd5a2/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp9MemTm/file199edecd5a2/episodes/using-r.Rmd.
#> /tmp/Rtmp9MemTm/file199edecd5a2/episodes/using-r.Rmd
