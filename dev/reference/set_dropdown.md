...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa461eed67a...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa461eed67a...
#> ☐ Edit /tmp/RtmpACXc8B/file1aa461eed67a/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa461eed67a...
#> ✔ First episode created in /tmp/RtmpACXc8B/file1aa461eed67a/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa461eed67a...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa461eed67a...
#> ✔ Lesson successfully created in /tmp/RtmpACXc8B/file1aa461eed67a
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa461eed67a...
#> /tmp/RtmpACXc8B/file1aa461eed67a
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpACXc8B/file1aa461eed67a/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpACXc8B/file1aa461eed67a/episodes/using-r.Rmd.
#> /tmp/RtmpACXc8B/file1aa461eed67a/episodes/using-r.Rmd
