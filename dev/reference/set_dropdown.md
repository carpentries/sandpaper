...
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8854139428...
...
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8854139428...
#> ☐ Edit /tmp/Rtmp3i6gqa/file1c8854139428/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8854139428...
#> ✔ First episode created in /tmp/Rtmp3i6gqa/file1c8854139428/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8854139428...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8854139428...
#> ✔ Lesson successfully created in /tmp/Rtmp3i6gqa/file1c8854139428
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8854139428...
#> /tmp/Rtmp3i6gqa/file1c8854139428
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/Rtmp3i6gqa/file1c8854139428/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp3i6gqa/file1c8854139428/episodes/using-r.Rmd.
#> /tmp/Rtmp3i6gqa/file1c8854139428/episodes/using-r.Rmd
