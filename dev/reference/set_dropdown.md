...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a862a38cc94...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a862a38cc94...
#> ☐ Edit /tmp/RtmpvxQeST/file1a862a38cc94/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a862a38cc94...
#> ✔ First episode created in /tmp/RtmpvxQeST/file1a862a38cc94/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a862a38cc94...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a862a38cc94...
#> ✔ Lesson successfully created in /tmp/RtmpvxQeST/file1a862a38cc94
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a862a38cc94...
#> /tmp/RtmpvxQeST/file1a862a38cc94
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpvxQeST/file1a862a38cc94/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpvxQeST/file1a862a38cc94/episodes/using-r.Rmd.
#> /tmp/RtmpvxQeST/file1a862a38cc94/episodes/using-r.Rmd
