...
#> ℹ Lesson bootstrapped in 3.166498 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01434469 secs
tok <- Sys.time()
...
#>   name                 commit                        updated            
#>   <chr>                <chr>                         <dttm>             
#> 1 main                 acb582319598d5befc25090ce1c9… 2026-01-16 13:35:35
#> 2 sandpaper-local/main acb582319598d5befc25090ce1c9… 2026-01-16 13:35:35
...
#> 1 episodes/introd… 2026-01-16 13:35:35 2026-01-16 13:35:35       1 acb5…
...
#> [md-outputs (root-commit) 3df846c] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpukkbJ4/REMOTE-1bfd15a70b0b
...
#> From /tmp/RtmpukkbJ4/REMOTE-1bfd15a70b0b
...
#>   /tmp/RtmpukkbJ4/file1bfd4cdc33c0/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 3df846c)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 3df846c Initializing md-outputs branch
#> ::endgroup::
...
#> 
#> 
#> processing file: /tmp/RtmpukkbJ4/file1bfd4cdc33c0/lesson-example/episodes/introduction.Rmd
#> 1/3          
#> 2/3 [pyramid]
#> 3/3          
#> output file: /tmp/RtmpukkbJ4/file1bfd4cdc33c0/lesson-example/site/built/introduction.md
#> 
#> ::endgroup::
...
#> Source  : acb582319598d5befc25090ce1c9ce30e280d1ae
#> Branch  : main
#> Author  : carpenter <team@carpentries.org>
#> Time    : 2026-01-16 13:35:35 +0000
#> Message : Initial commit [via `{sandpaper}`]
#> '
#> [md-outputs 3c83a3d] markdown source builds
...
#> sandpaper-local  /tmp/RtmpukkbJ4/REMOTE-1bfd15a70b0b (fetch)
#> sandpaper-local  /tmp/RtmpukkbJ4/REMOTE-1bfd15a70b0b (push)
#> Running git push --force sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpukkbJ4/REMOTE-1bfd15a70b0b
#>    3df846c..3c83a3d  HEAD -> md-outputs
#> ::endgroup::
#> ::group::Create New Branch
...
#> [gh-pages (root-commit) f034977] Initializing gh-pages branch
...
#>   /tmp/RtmpukkbJ4/file1bfd4cdc33c0/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at f034977)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at f034977 Initializing gh-pages branch
#> ::endgroup::
...
#> ══ Validating cff ══════════════════════════════════════════════════════
#> ✔ Congratulations! /tmp/RtmpukkbJ4/file1bfd4cdc33c0/lesson-example/CITATION.cff is valid
...
#> 
#> Output created: /tmp/RtmpukkbJ4/file1bfd4cdc33c0/lesson-example/site/docs/index.html
#> ::endgroup::
...
#> 
#> Auto-generated via `{sandpaper}`
#> Source  : 3c83a3dcd178baefffc94324b77c56b4ecaf9324
#> Branch  : md-outputs
#> Author  : GitHub Actions <actions@github.com>
#> Time    : 2026-01-16 13:35:39 +0000
...
#>   name                       commit                  updated            
#>   <chr>                      <chr>                   <dttm>             
#> 1 gh-pages                   f6e0d10088231cb4f462d0… 2026-01-16 13:35:51
#> 2 main                       acb582319598d5befc2509… 2026-01-16 13:35:35
#> 3 md-outputs                 3c83a3dcd178baefffc943… 2026-01-16 13:35:39
#> 4 sandpaper-local/gh-pages   f6e0d10088231cb4f462d0… 2026-01-16 13:35:51
#> 5 sandpaper-local/main       acb582319598d5befc2509… 2026-01-16 13:35:35
#> 6 sandpaper-local/md-outputs 3c83a3dcd178baefffc943… 2026-01-16 13:35:39
...
#>   file            created             modified            commits head  
#> * <chr>           <dttm>              <dttm>                <int> <chr> 
#> 1 introduction.md 2026-01-16 13:35:39 2026-01-16 13:35:39       1 3c83a…
...
#>   file             created             modified            commits head 
#> * <chr>            <dttm>              <dttm>                <int> <chr>
#> 1 introduction.ht… 2026-01-16 13:35:51 2026-01-16 13:35:51       1 f6e0…
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpukkbJ4/REMOTE-1bfd15a70b0b)
#> /tmp/RtmpukkbJ4/REMOTE-1bfd15a70b0b
