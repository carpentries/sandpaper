...
#> ℹ Lesson bootstrapped in 3.427441 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01454043 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.47 seconds
...
#>   name                 commit                        updated            
#>   <chr>                <chr>                         <dttm>             
#> 1 main                 8c702eeb78ccaa53b3add02a0a39… 2026-03-06 13:15:55
#> 2 sandpaper-local/main 8c702eeb78ccaa53b3add02a0a39… 2026-03-06 13:15:55
...
#> 1 episodes/introd… 2026-03-06 13:15:55 2026-03-06 13:15:55       1 8c70…
...
#> [md-outputs (root-commit) 480155e] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpXPofNf/REMOTE-1a7530ee8600
...
#> From /tmp/RtmpXPofNf/REMOTE-1a7530ee8600
...
#>   /tmp/RtmpXPofNf/file1a757f6a4d65/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 480155e)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 480155e Initializing md-outputs branch
#> ::endgroup::
...
#> 
#> 
#> processing file: /tmp/RtmpXPofNf/file1a757f6a4d65/lesson-example/episodes/introduction.Rmd
#> 1/3          
#> 2/3 [pyramid]
#> 3/3          
#> output file: /tmp/RtmpXPofNf/file1a757f6a4d65/lesson-example/site/built/introduction.md
#> 
#> ::endgroup::
...
#> Source  : 8c702eeb78ccaa53b3add02a0a39f133485eea90
#> Branch  : main
#> Author  : carpenter <team@carpentries.org>
#> Time    : 2026-03-06 13:15:55 +0000
#> Message : Initial commit [via `{sandpaper}`]
#> '
#> [md-outputs ee6c771] markdown source builds
...
#> sandpaper-local  /tmp/RtmpXPofNf/REMOTE-1a7530ee8600 (fetch)
#> sandpaper-local  /tmp/RtmpXPofNf/REMOTE-1a7530ee8600 (push)
#> Running git push --force sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpXPofNf/REMOTE-1a7530ee8600
#>    480155e..ee6c771  HEAD -> md-outputs
#> ::endgroup::
#> ::group::Create New Branch
...
#> [gh-pages (root-commit) 2f7d1a3] Initializing gh-pages branch
...
#>   /tmp/RtmpXPofNf/file1a757f6a4d65/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 2f7d1a3)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 2f7d1a3 Initializing gh-pages branch
#> ::endgroup::
...
#> ══ Validating cff ══════════════════════════════════════════════════════
#> ✔ Congratulations! /tmp/RtmpXPofNf/file1a757f6a4d65/lesson-example/CITATION.cff is valid
...
#> 
#> Output created: /tmp/RtmpXPofNf/file1a757f6a4d65/lesson-example/site/docs/index.html
#> ::endgroup::
...
#> 
#> Auto-generated via `{sandpaper}`
#> Source  : ee6c771d417a7a1d14ff32cc634cf376324e3782
#> Branch  : md-outputs
#> Author  : GitHub Actions <actions@github.com>
#> Time    : 2026-03-06 13:15:59 +0000
...
#>   name                       commit                  updated            
#>   <chr>                      <chr>                   <dttm>             
#> 1 gh-pages                   13d0575f128da0e90d5511… 2026-03-06 13:16:11
#> 2 main                       8c702eeb78ccaa53b3add0… 2026-03-06 13:15:55
#> 3 md-outputs                 ee6c771d417a7a1d14ff32… 2026-03-06 13:15:59
#> 4 sandpaper-local/gh-pages   13d0575f128da0e90d5511… 2026-03-06 13:16:11
#> 5 sandpaper-local/main       8c702eeb78ccaa53b3add0… 2026-03-06 13:15:55
#> 6 sandpaper-local/md-outputs ee6c771d417a7a1d14ff32… 2026-03-06 13:15:59
...
#>   file            created             modified            commits head  
#> * <chr>           <dttm>              <dttm>                <int> <chr> 
#> 1 introduction.md 2026-03-06 13:15:59 2026-03-06 13:15:59       1 ee6c7…
...
#>   file             created             modified            commits head 
#> * <chr>            <dttm>              <dttm>                <int> <chr>
#> 1 introduction.ht… 2026-03-06 13:16:11 2026-03-06 13:16:11       1 13d0…
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpXPofNf/REMOTE-1a7530ee8600)
#> /tmp/RtmpXPofNf/REMOTE-1a7530ee8600
