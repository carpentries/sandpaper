...
#> ℹ Lesson bootstrapped in 3.173618 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01410437 secs
tok <- Sys.time()
...
#>   name                 commit                        updated            
#>   <chr>                <chr>                         <dttm>             
#> 1 main                 9044d031e9947f779992c142bb0d… 2026-02-24 14:36:03
#> 2 sandpaper-local/main 9044d031e9947f779992c142bb0d… 2026-02-24 14:36:03
...
#> 1 episodes/introd… 2026-02-24 14:36:03 2026-02-24 14:36:03       1 9044…
...
#> [md-outputs (root-commit) 70cd706] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpH5UNvd/REMOTE-1daf16ecb1bf
...
#> From /tmp/RtmpH5UNvd/REMOTE-1daf16ecb1bf
...
#>   /tmp/RtmpH5UNvd/file1daf62d992d1/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 70cd706)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 70cd706 Initializing md-outputs branch
#> ::endgroup::
...
#> 
#> 
#> processing file: /tmp/RtmpH5UNvd/file1daf62d992d1/lesson-example/episodes/introduction.Rmd
#> 1/3          
#> 2/3 [pyramid]
#> 3/3          
#> output file: /tmp/RtmpH5UNvd/file1daf62d992d1/lesson-example/site/built/introduction.md
#> 
#> ::endgroup::
...
#> Source  : 9044d031e9947f779992c142bb0d183295fb432d
#> Branch  : main
#> Author  : carpenter <team@carpentries.org>
#> Time    : 2026-02-24 14:36:03 +0000
#> Message : Initial commit [via `{sandpaper}`]
#> '
#> [md-outputs 6c57458] markdown source builds
...
#> sandpaper-local  /tmp/RtmpH5UNvd/REMOTE-1daf16ecb1bf (fetch)
#> sandpaper-local  /tmp/RtmpH5UNvd/REMOTE-1daf16ecb1bf (push)
#> Running git push --force sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpH5UNvd/REMOTE-1daf16ecb1bf
#>    70cd706..6c57458  HEAD -> md-outputs
#> ::endgroup::
#> ::group::Create New Branch
...
#> [gh-pages (root-commit) c81d3ed] Initializing gh-pages branch
...
#>   /tmp/RtmpH5UNvd/file1daf62d992d1/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at c81d3ed)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at c81d3ed Initializing gh-pages branch
#> ::endgroup::
...
#> ══ Validating cff ══════════════════════════════════════════════════════
#> ✔ Congratulations! /tmp/RtmpH5UNvd/file1daf62d992d1/lesson-example/CITATION.cff is valid
...
#> 
#> Output created: /tmp/RtmpH5UNvd/file1daf62d992d1/lesson-example/site/docs/index.html
#> ::endgroup::
...
#> 
#> Auto-generated via `{sandpaper}`
#> Source  : 6c574584977bbb8d2d509a9a9e473f9637dc5ca1
#> Branch  : md-outputs
#> Author  : GitHub Actions <actions@github.com>
#> Time    : 2026-02-24 14:36:07 +0000
...
#>   name                       commit                  updated            
#>   <chr>                      <chr>                   <dttm>             
#> 1 gh-pages                   5b32f5d85a25e6ae657a7e… 2026-02-24 14:36:19
#> 2 main                       9044d031e9947f779992c1… 2026-02-24 14:36:03
#> 3 md-outputs                 6c574584977bbb8d2d509a… 2026-02-24 14:36:07
#> 4 sandpaper-local/gh-pages   5b32f5d85a25e6ae657a7e… 2026-02-24 14:36:19
#> 5 sandpaper-local/main       9044d031e9947f779992c1… 2026-02-24 14:36:03
#> 6 sandpaper-local/md-outputs 6c574584977bbb8d2d509a… 2026-02-24 14:36:07
...
#>   file            created             modified            commits head  
#> * <chr>           <dttm>              <dttm>                <int> <chr> 
#> 1 introduction.md 2026-02-24 14:36:07 2026-02-24 14:36:07       1 6c574…
...
#>   file             created             modified            commits head 
#> * <chr>            <dttm>              <dttm>                <int> <chr>
#> 1 introduction.ht… 2026-02-24 14:36:19 2026-02-24 14:36:19       1 5b32…
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpH5UNvd/REMOTE-1daf16ecb1bf)
#> /tmp/RtmpH5UNvd/REMOTE-1daf16ecb1bf
