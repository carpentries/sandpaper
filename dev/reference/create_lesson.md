...
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8867db1f01...
...
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8867db1f01...
#> ☐ Edit /tmp/Rtmp3i6gqa/file1c8867db1f01/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8867db1f01...
#> ✔ First episode created in /tmp/Rtmp3i6gqa/file1c8867db1f01/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8867db1f01...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/Rtmp3i6gqa/file1c8867db1f01/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmp3i6gqa/file1c8867db1f01
#> → Creating Lesson in /tmp/Rtmp3i6gqa/file1c8867db1f01...
lsn
#> /tmp/Rtmp3i6gqa/file1c8867db1f01
```
