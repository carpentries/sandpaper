...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8663a26b44...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8663a26b44...
#> ☐ Edit /tmp/RtmpvxQeST/file1a8663a26b44/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8663a26b44...
#> ✔ First episode created in /tmp/RtmpvxQeST/file1a8663a26b44/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8663a26b44...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpvxQeST/file1a8663a26b44/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpvxQeST/file1a8663a26b44
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8663a26b44...
lsn
#> /tmp/RtmpvxQeST/file1a8663a26b44
```
