...
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c014ead44e...
...
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c014ead44e...
#> ☐ Edit /tmp/RtmpcTm5wz/file1c014ead44e/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c014ead44e...
#> ✔ First episode created in /tmp/RtmpcTm5wz/file1c014ead44e/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c014ead44e...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpcTm5wz/file1c014ead44e/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpcTm5wz/file1c014ead44e
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c014ead44e...
lsn
#> /tmp/RtmpcTm5wz/file1c014ead44e
```
