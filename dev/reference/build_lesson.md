...
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a755fd42e9e...
...
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a755fd42e9e...
#> ☐ Edit /tmp/RtmpXPofNf/file1a755fd42e9e/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a755fd42e9e...
#> ✔ First episode created in /tmp/RtmpXPofNf/file1a755fd42e9e/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a755fd42e9e...
...
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a755fd42e9e...
#> ✔ Lesson successfully created in /tmp/RtmpXPofNf/file1a755fd42e9e
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a755fd42e9e...
#> /tmp/RtmpXPofNf/file1a755fd42e9e
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpXPofNf/file1a755fd42e9e/episodes/first-script.Rmd.
#> /tmp/RtmpXPofNf/file1a755fd42e9e/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
