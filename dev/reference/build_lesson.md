...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e45471faa...
...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e45471faa...
#> ☐ Edit /tmp/RtmpgOPyFN/file1a7e45471faa/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e45471faa...
#> ✔ First episode created in /tmp/RtmpgOPyFN/file1a7e45471faa/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e45471faa...
...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e45471faa...
#> ✔ Lesson successfully created in /tmp/RtmpgOPyFN/file1a7e45471faa
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e45471faa...
#> /tmp/RtmpgOPyFN/file1a7e45471faa
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpgOPyFN/file1a7e45471faa/episodes/first-script.Rmd.
#> /tmp/RtmpgOPyFN/file1a7e45471faa/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
