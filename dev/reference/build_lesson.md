...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc4ae68b98...
...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc4ae68b98...
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc4ae68b98/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc4ae68b98...
#> ✔ First episode created in /tmp/Rtmp6yLLZk/file1acc4ae68b98/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc4ae68b98...
...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc4ae68b98...
#> ✔ Lesson successfully created in /tmp/Rtmp6yLLZk/file1acc4ae68b98
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc4ae68b98...
#> /tmp/Rtmp6yLLZk/file1acc4ae68b98
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc4ae68b98/episodes/first-script.Rmd.
#> /tmp/Rtmp6yLLZk/file1acc4ae68b98/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
