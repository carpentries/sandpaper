...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec553890e7...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec553890e7...
#> ☐ Edit /tmp/Rtmps3YM4i/file1aec553890e7/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec553890e7...
#> ✔ First episode created in /tmp/Rtmps3YM4i/file1aec553890e7/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec553890e7...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec553890e7...
#> ✔ Lesson successfully created in /tmp/Rtmps3YM4i/file1aec553890e7
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec553890e7...
#> /tmp/Rtmps3YM4i/file1aec553890e7
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmps3YM4i/file1aec553890e7/episodes/first-script.Rmd.
#> /tmp/Rtmps3YM4i/file1aec553890e7/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
