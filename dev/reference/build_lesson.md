...
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d508ed4af9...
...
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d508ed4af9...
#> ☐ Edit /tmp/RtmpPAgXQL/file1d508ed4af9/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d508ed4af9...
#> ✔ First episode created in /tmp/RtmpPAgXQL/file1d508ed4af9/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d508ed4af9...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d508ed4af9...
#> ✔ Lesson successfully created in /tmp/RtmpPAgXQL/file1d508ed4af9
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d508ed4af9...
#> /tmp/RtmpPAgXQL/file1d508ed4af9
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpPAgXQL/file1d508ed4af9/episodes/first-script.Rmd.
#> /tmp/RtmpPAgXQL/file1d508ed4af9/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
