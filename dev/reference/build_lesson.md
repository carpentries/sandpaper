...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8651e3c555...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8651e3c555...
#> ☐ Edit /tmp/RtmpvxQeST/file1a8651e3c555/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8651e3c555...
#> ✔ First episode created in /tmp/RtmpvxQeST/file1a8651e3c555/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8651e3c555...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8651e3c555...
#> ✔ Lesson successfully created in /tmp/RtmpvxQeST/file1a8651e3c555
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8651e3c555...
#> /tmp/RtmpvxQeST/file1a8651e3c555
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpvxQeST/file1a8651e3c555/episodes/first-script.Rmd.
#> /tmp/RtmpvxQeST/file1a8651e3c555/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
