...
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae3f1ded9d...
...
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae3f1ded9d...
#> ☐ Edit /tmp/RtmpUTI0d7/file1ae3f1ded9d/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae3f1ded9d...
#> ✔ First episode created in /tmp/RtmpUTI0d7/file1ae3f1ded9d/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae3f1ded9d...
...
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae3f1ded9d...
#> ✔ Lesson successfully created in /tmp/RtmpUTI0d7/file1ae3f1ded9d
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae3f1ded9d...
#> /tmp/RtmpUTI0d7/file1ae3f1ded9d
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpUTI0d7/file1ae3f1ded9d/episodes/first-script.Rmd.
#> /tmp/RtmpUTI0d7/file1ae3f1ded9d/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
