...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7529dcca4...
...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7529dcca4...
#> ☐ Edit /tmp/RtmpJOJxpS/file1a7529dcca4/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7529dcca4...
#> ✔ First episode created in /tmp/RtmpJOJxpS/file1a7529dcca4/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7529dcca4...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7529dcca4...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7529dcca4...
#> ✔ Lesson successfully created in /tmp/RtmpJOJxpS/file1a7529dcca4
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7529dcca4...
#> /tmp/RtmpJOJxpS/file1a7529dcca4
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpJOJxpS/file1a7529dcca4/episodes/first-script.Rmd.
#> /tmp/RtmpJOJxpS/file1a7529dcca4/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
