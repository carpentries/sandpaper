...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa46f2db18f...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa46f2db18f...
#> ☐ Edit /tmp/RtmpACXc8B/file1aa46f2db18f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa46f2db18f...
#> ✔ First episode created in /tmp/RtmpACXc8B/file1aa46f2db18f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa46f2db18f...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa46f2db18f...
#> ✔ Lesson successfully created in /tmp/RtmpACXc8B/file1aa46f2db18f
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa46f2db18f...
#> /tmp/RtmpACXc8B/file1aa46f2db18f
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpACXc8B/file1aa46f2db18f/episodes/first-script.Rmd.
#> /tmp/RtmpACXc8B/file1aa46f2db18f/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
