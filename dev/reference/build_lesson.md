...
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd5cd81b4f...
...
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd5cd81b4f...
#> ☐ Edit /tmp/RtmpukkbJ4/file1bfd5cd81b4f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd5cd81b4f...
#> ✔ First episode created in /tmp/RtmpukkbJ4/file1bfd5cd81b4f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd5cd81b4f...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd5cd81b4f...
#> ✔ Lesson successfully created in /tmp/RtmpukkbJ4/file1bfd5cd81b4f
#> → Creating Lesson in /tmp/RtmpukkbJ4/file1bfd5cd81b4f...
#> /tmp/RtmpukkbJ4/file1bfd5cd81b4f
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpukkbJ4/file1bfd5cd81b4f/episodes/first-script.Rmd.
#> /tmp/RtmpukkbJ4/file1bfd5cd81b4f/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
