...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7587db13f...
...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7587db13f...
#> ☐ Edit /tmp/RtmpJOJxpS/file1a7587db13f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7587db13f...
#> ✔ First episode created in /tmp/RtmpJOJxpS/file1a7587db13f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7587db13f...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7587db13f...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7587db13f...
#> ✔ Lesson successfully created in /tmp/RtmpJOJxpS/file1a7587db13f
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a7587db13f...
#> /tmp/RtmpJOJxpS/file1a7587db13f
get_episodes(tmp)
#> [1] "introduction.md"
