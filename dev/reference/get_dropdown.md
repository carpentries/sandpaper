...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc528635e2...
...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc528635e2...
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc528635e2/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc528635e2...
#> ✔ First episode created in /tmp/Rtmp6yLLZk/file1acc528635e2/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc528635e2...
...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc528635e2...
#> ✔ Lesson successfully created in /tmp/Rtmp6yLLZk/file1acc528635e2
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc528635e2...
#> /tmp/Rtmp6yLLZk/file1acc528635e2
get_episodes(tmp)
#> [1] "introduction.md"
