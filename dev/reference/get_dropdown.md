...
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b5074deee...
...
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b5074deee...
#> ☐ Edit /tmp/RtmpofsREx/file1c8b5074deee/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b5074deee...
#> ✔ First episode created in /tmp/RtmpofsREx/file1c8b5074deee/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b5074deee...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b5074deee...
#> ✔ Lesson successfully created in /tmp/RtmpofsREx/file1c8b5074deee
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b5074deee...
#> /tmp/RtmpofsREx/file1c8b5074deee
get_episodes(tmp)
#> [1] "introduction.md"
