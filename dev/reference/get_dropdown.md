...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e794c7249...
...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e794c7249...
#> ☐ Edit /tmp/RtmpgOPyFN/file1a7e794c7249/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e794c7249...
#> ✔ First episode created in /tmp/RtmpgOPyFN/file1a7e794c7249/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e794c7249...
...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e794c7249...
#> ✔ Lesson successfully created in /tmp/RtmpgOPyFN/file1a7e794c7249
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e794c7249...
#> /tmp/RtmpgOPyFN/file1a7e794c7249
get_episodes(tmp)
#> [1] "introduction.md"
