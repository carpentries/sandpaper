...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86417fe2cb...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86417fe2cb...
#> ☐ Edit /tmp/RtmpvxQeST/file1a86417fe2cb/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86417fe2cb...
#> ✔ First episode created in /tmp/RtmpvxQeST/file1a86417fe2cb/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86417fe2cb...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86417fe2cb...
#> ✔ Lesson successfully created in /tmp/RtmpvxQeST/file1a86417fe2cb
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86417fe2cb...
#> /tmp/RtmpvxQeST/file1a86417fe2cb
get_episodes(tmp)
#> [1] "introduction.md"
