...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa44630acfb...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa44630acfb...
#> ☐ Edit /tmp/RtmpACXc8B/file1aa44630acfb/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa44630acfb...
#> ✔ First episode created in /tmp/RtmpACXc8B/file1aa44630acfb/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa44630acfb...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa44630acfb...
#> ✔ Lesson successfully created in /tmp/RtmpACXc8B/file1aa44630acfb
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa44630acfb...
#> /tmp/RtmpACXc8B/file1aa44630acfb
get_episodes(tmp)
#> [1] "introduction.md"
