...
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae34630b385...
...
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae34630b385...
#> ☐ Edit /tmp/RtmpUTI0d7/file1ae34630b385/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae34630b385...
#> ✔ First episode created in /tmp/RtmpUTI0d7/file1ae34630b385/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae34630b385...
...
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae34630b385...
#> ✔ Lesson successfully created in /tmp/RtmpUTI0d7/file1ae34630b385
#> → Creating Lesson in /tmp/RtmpUTI0d7/file1ae34630b385...
#> /tmp/RtmpUTI0d7/file1ae34630b385
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpUTI0d7/file1ae34630b385/episodes/getting-started.md.
#> /tmp/RtmpUTI0d7/file1ae34630b385/episodes/getting-started.md
```
