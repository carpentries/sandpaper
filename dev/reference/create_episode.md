...
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8ba794cf1...
...
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8ba794cf1...
#> ☐ Edit /tmp/RtmpofsREx/file1c8ba794cf1/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8ba794cf1...
#> ✔ First episode created in /tmp/RtmpofsREx/file1c8ba794cf1/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8ba794cf1...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8ba794cf1...
#> ✔ Lesson successfully created in /tmp/RtmpofsREx/file1c8ba794cf1
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8ba794cf1...
#> /tmp/RtmpofsREx/file1c8ba794cf1
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpofsREx/file1c8ba794cf1/episodes/getting-started.md.
#> /tmp/RtmpofsREx/file1c8ba794cf1/episodes/getting-started.md
```
