...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e20adeb3...
...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e20adeb3...
#> ☐ Edit /tmp/RtmpgOPyFN/file1a7e20adeb3/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e20adeb3...
#> ✔ First episode created in /tmp/RtmpgOPyFN/file1a7e20adeb3/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e20adeb3...
...
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e20adeb3...
#> ✔ Lesson successfully created in /tmp/RtmpgOPyFN/file1a7e20adeb3
#> → Creating Lesson in /tmp/RtmpgOPyFN/file1a7e20adeb3...
#> /tmp/RtmpgOPyFN/file1a7e20adeb3
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpgOPyFN/file1a7e20adeb3/episodes/getting-started.md.
#> /tmp/RtmpgOPyFN/file1a7e20adeb3/episodes/getting-started.md
```
