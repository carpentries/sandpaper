...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75336c7256...
...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75336c7256...
#> ☐ Edit /tmp/RtmpJOJxpS/file1a75336c7256/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75336c7256...
#> ✔ First episode created in /tmp/RtmpJOJxpS/file1a75336c7256/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75336c7256...
#> ℹ Downloading workflows from https://api.github.com/repos/carpentries/workbench-workflows/releases/latest
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75336c7256...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75336c7256...
#> ✔ Lesson successfully created in /tmp/RtmpJOJxpS/file1a75336c7256
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75336c7256...
#> /tmp/RtmpJOJxpS/file1a75336c7256
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpJOJxpS/file1a75336c7256/episodes/getting-started.md.
#> /tmp/RtmpJOJxpS/file1a75336c7256/episodes/getting-started.md
```
