...
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8757beeae0...
...
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8757beeae0...
#> ☐ Edit /tmp/RtmpUfNzdK/file1c8757beeae0/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8757beeae0...
#> ✔ First episode created in /tmp/RtmpUfNzdK/file1c8757beeae0/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8757beeae0...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8757beeae0...
#> ✔ Lesson successfully created in /tmp/RtmpUfNzdK/file1c8757beeae0
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8757beeae0...
#> /tmp/RtmpUfNzdK/file1c8757beeae0
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpUfNzdK/file1c8757beeae0/episodes/getting-started.md.
#> /tmp/RtmpUfNzdK/file1c8757beeae0/episodes/getting-started.md
```
