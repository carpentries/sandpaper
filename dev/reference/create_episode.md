...
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c456ab3cfef...
...
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c456ab3cfef...
#> ☐ Edit /tmp/RtmpUnRg90/file1c456ab3cfef/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c456ab3cfef...
#> ✔ First episode created in /tmp/RtmpUnRg90/file1c456ab3cfef/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c456ab3cfef...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c456ab3cfef...
#> ✔ Lesson successfully created in /tmp/RtmpUnRg90/file1c456ab3cfef
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c456ab3cfef...
#> /tmp/RtmpUnRg90/file1c456ab3cfef
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpUnRg90/file1c456ab3cfef/episodes/getting-started.md.
#> /tmp/RtmpUnRg90/file1c456ab3cfef/episodes/getting-started.md
```
