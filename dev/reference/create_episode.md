...
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c25677ffc17...
...
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c25677ffc17...
#> ☐ Edit /tmp/Rtmp2oQNAm/file1c25677ffc17/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c25677ffc17...
#> ✔ First episode created in /tmp/Rtmp2oQNAm/file1c25677ffc17/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c25677ffc17...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c25677ffc17...
#> ✔ Lesson successfully created in /tmp/Rtmp2oQNAm/file1c25677ffc17
#> → Creating Lesson in /tmp/Rtmp2oQNAm/file1c25677ffc17...
#> /tmp/Rtmp2oQNAm/file1c25677ffc17
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/Rtmp2oQNAm/file1c25677ffc17/episodes/getting-started.md.
#> /tmp/Rtmp2oQNAm/file1c25677ffc17/episodes/getting-started.md
```
