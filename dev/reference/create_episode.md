...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86757c042d...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86757c042d...
#> ☐ Edit /tmp/RtmpvxQeST/file1a86757c042d/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86757c042d...
#> ✔ First episode created in /tmp/RtmpvxQeST/file1a86757c042d/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86757c042d...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86757c042d...
#> ✔ Lesson successfully created in /tmp/RtmpvxQeST/file1a86757c042d
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a86757c042d...
#> /tmp/RtmpvxQeST/file1a86757c042d
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpvxQeST/file1a86757c042d/episodes/getting-started.md.
#> /tmp/RtmpvxQeST/file1a86757c042d/episodes/getting-started.md
```
