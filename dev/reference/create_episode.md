...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec7638e8ca...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec7638e8ca...
#> ☐ Edit /tmp/Rtmps3YM4i/file1aec7638e8ca/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec7638e8ca...
#> ✔ First episode created in /tmp/Rtmps3YM4i/file1aec7638e8ca/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec7638e8ca...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec7638e8ca...
#> ✔ Lesson successfully created in /tmp/Rtmps3YM4i/file1aec7638e8ca
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec7638e8ca...
#> /tmp/Rtmps3YM4i/file1aec7638e8ca
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/Rtmps3YM4i/file1aec7638e8ca/episodes/getting-started.md.
#> /tmp/Rtmps3YM4i/file1aec7638e8ca/episodes/getting-started.md
```
