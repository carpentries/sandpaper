...
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a757e89c1b7...
...
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a757e89c1b7...
#> ☐ Edit /tmp/RtmpXPofNf/file1a757e89c1b7/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a757e89c1b7...
#> ✔ First episode created in /tmp/RtmpXPofNf/file1a757e89c1b7/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a757e89c1b7...
...
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a757e89c1b7...
#> ✔ Lesson successfully created in /tmp/RtmpXPofNf/file1a757e89c1b7
#> → Creating Lesson in /tmp/RtmpXPofNf/file1a757e89c1b7...
#> /tmp/RtmpXPofNf/file1a757e89c1b7
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpXPofNf/file1a757e89c1b7/episodes/getting-started.md.
#> /tmp/RtmpXPofNf/file1a757e89c1b7/episodes/getting-started.md
```
