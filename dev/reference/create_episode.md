...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43203123c...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43203123c...
#> ☐ Edit /tmp/RtmpACXc8B/file1aa43203123c/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43203123c...
#> ✔ First episode created in /tmp/RtmpACXc8B/file1aa43203123c/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43203123c...
...
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43203123c...
#> ✔ Lesson successfully created in /tmp/RtmpACXc8B/file1aa43203123c
#> → Creating Lesson in /tmp/RtmpACXc8B/file1aa43203123c...
#> /tmp/RtmpACXc8B/file1aa43203123c
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpACXc8B/file1aa43203123c/episodes/getting-started.md.
#> /tmp/RtmpACXc8B/file1aa43203123c/episodes/getting-started.md
```
