...
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d507165cd32...
...
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d507165cd32...
#> ☐ Edit /tmp/RtmpPAgXQL/file1d507165cd32/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d507165cd32...
#> ✔ First episode created in /tmp/RtmpPAgXQL/file1d507165cd32/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d507165cd32...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpPAgXQL/file1d507165cd32/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpPAgXQL/file1d507165cd32
#> → Creating Lesson in /tmp/RtmpPAgXQL/file1d507165cd32...
#> ☐ Edit /tmp/RtmpPAgXQL/file1d507165cd32/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpPAgXQL/file1d507165cd32/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpPAgXQL/file1d507165cd32/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
