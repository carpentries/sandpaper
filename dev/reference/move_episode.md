...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc699d5cd5...
...
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc699d5cd5...
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc699d5cd5/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc699d5cd5...
#> ✔ First episode created in /tmp/Rtmp6yLLZk/file1acc699d5cd5/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc699d5cd5...
...
#> - R             [* -> 4.6.1]
#> 
#> - Lockfile written to "/tmp/Rtmp6yLLZk/file1acc699d5cd5/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmp6yLLZk/file1acc699d5cd5
#> → Creating Lesson in /tmp/Rtmp6yLLZk/file1acc699d5cd5...
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc699d5cd5/episodes/getting-started.md.
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc699d5cd5/episodes/plotting.Rmd.
#> ☐ Edit /tmp/Rtmp6yLLZk/file1acc699d5cd5/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
