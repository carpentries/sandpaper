...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75149e571c...
...
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75149e571c...
#> ☐ Edit /tmp/RtmpJOJxpS/file1a75149e571c/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75149e571c...
#> ✔ First episode created in /tmp/RtmpJOJxpS/file1a75149e571c/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75149e571c...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpJOJxpS/file1a75149e571c/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpJOJxpS/file1a75149e571c
#> → Creating Lesson in /tmp/RtmpJOJxpS/file1a75149e571c...
#> ☐ Edit /tmp/RtmpJOJxpS/file1a75149e571c/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpJOJxpS/file1a75149e571c/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpJOJxpS/file1a75149e571c/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
