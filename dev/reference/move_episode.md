...
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8726a3fb7d...
...
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8726a3fb7d...
#> ☐ Edit /tmp/RtmpUfNzdK/file1c8726a3fb7d/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8726a3fb7d...
#> ✔ First episode created in /tmp/RtmpUfNzdK/file1c8726a3fb7d/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8726a3fb7d...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpUfNzdK/file1c8726a3fb7d/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpUfNzdK/file1c8726a3fb7d
#> → Creating Lesson in /tmp/RtmpUfNzdK/file1c8726a3fb7d...
#> ☐ Edit /tmp/RtmpUfNzdK/file1c8726a3fb7d/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpUfNzdK/file1c8726a3fb7d/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpUfNzdK/file1c8726a3fb7d/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
