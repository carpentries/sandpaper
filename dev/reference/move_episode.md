...
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2061bd0c...
...
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2061bd0c...
#> ☐ Edit /tmp/RtmpofsREx/file1c8b2061bd0c/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2061bd0c...
#> ✔ First episode created in /tmp/RtmpofsREx/file1c8b2061bd0c/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2061bd0c...
...
#> - R             [* -> 4.5.2]
#> 
#> - Lockfile written to "/tmp/RtmpofsREx/file1c8b2061bd0c/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpofsREx/file1c8b2061bd0c
#> → Creating Lesson in /tmp/RtmpofsREx/file1c8b2061bd0c...
#> ☐ Edit /tmp/RtmpofsREx/file1c8b2061bd0c/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpofsREx/file1c8b2061bd0c/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpofsREx/file1c8b2061bd0c/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
