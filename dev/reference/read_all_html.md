...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpUTI0d7/file1ae36695a284': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpUTI0d7/file1ae36695a284/index.html
#> /tmp/RtmpUTI0d7/file1ae36695a284/instructor/index.html
#> 
```
