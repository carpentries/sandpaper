...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmp9MemTm/file199e397865db': no such file or directory
...
#> 
#> $paths
#> /tmp/Rtmp9MemTm/file199e397865db/index.html
#> /tmp/Rtmp9MemTm/file199e397865db/instructor/index.html
#> 
```
