...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpACXc8B/file1aa46836366a': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpACXc8B/file1aa46836366a/index.html
#> /tmp/RtmpACXc8B/file1aa46836366a/instructor/index.html
#> 
```
