...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpJOJxpS/file1a751dbd4a4d': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpJOJxpS/file1a751dbd4a4d/index.html
#> /tmp/RtmpJOJxpS/file1a751dbd4a4d/instructor/index.html
#> 
```
