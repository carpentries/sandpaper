...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmps3YM4i/file1aec469e1b2c': no such file or directory
...
#> 
#> $paths
#> /tmp/Rtmps3YM4i/file1aec469e1b2c/index.html
#> /tmp/Rtmps3YM4i/file1aec469e1b2c/instructor/index.html
#> 
```
