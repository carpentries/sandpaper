...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmp6yLLZk/file1acc5540d33': no such file or directory
...
#> 
#> $paths
#> /tmp/Rtmp6yLLZk/file1acc5540d33/index.html
#> /tmp/Rtmp6yLLZk/file1acc5540d33/instructor/index.html
#> 
```
