...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpofsREx/file1c8b4ccb84d8': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpofsREx/file1c8b4ccb84d8/index.html
#> /tmp/RtmpofsREx/file1c8b4ccb84d8/instructor/index.html
#> 
```
