...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpukkbJ4/file1bfd46aa0e2b': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpukkbJ4/file1bfd46aa0e2b/index.html
#> /tmp/RtmpukkbJ4/file1bfd46aa0e2b/instructor/index.html
#> 
```
