...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpgOPyFN/file1a7e6695daaf': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpgOPyFN/file1a7e6695daaf/index.html
#> /tmp/RtmpgOPyFN/file1a7e6695daaf/instructor/index.html
#> 
```
