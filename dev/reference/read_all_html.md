...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpjJX7eW/file199e2b61cc1': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpjJX7eW/file199e2b61cc1/index.html
#> /tmp/RtmpjJX7eW/file199e2b61cc1/instructor/index.html
#> 
```
