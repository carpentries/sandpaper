...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpH5UNvd/file1daf169d203a': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpH5UNvd/file1daf169d203a/index.html
#> /tmp/RtmpH5UNvd/file1daf169d203a/instructor/index.html
#> 
```
