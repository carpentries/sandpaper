...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec4dcfc251...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec4dcfc251...
#> ☐ Edit /tmp/Rtmps3YM4i/file1aec4dcfc251/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec4dcfc251...
#> ✔ First episode created in /tmp/Rtmps3YM4i/file1aec4dcfc251/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec4dcfc251...
...
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec4dcfc251...
#> ✔ Lesson successfully created in /tmp/Rtmps3YM4i/file1aec4dcfc251
#> → Creating Lesson in /tmp/Rtmps3YM4i/file1aec4dcfc251...
#> /tmp/Rtmps3YM4i/file1aec4dcfc251
check_lesson(tmp)
