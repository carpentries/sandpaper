...
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c015203dcfb...
...
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c015203dcfb...
#> ☐ Edit /tmp/RtmpcTm5wz/file1c015203dcfb/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c015203dcfb...
#> ✔ First episode created in /tmp/RtmpcTm5wz/file1c015203dcfb/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c015203dcfb...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c015203dcfb...
#> ✔ Lesson successfully created in /tmp/RtmpcTm5wz/file1c015203dcfb
#> → Creating Lesson in /tmp/RtmpcTm5wz/file1c015203dcfb...
#> /tmp/RtmpcTm5wz/file1c015203dcfb
check_lesson(tmp)
