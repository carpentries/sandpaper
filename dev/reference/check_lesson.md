...
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4535405d6e...
...
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4535405d6e...
#> ☐ Edit /tmp/RtmpUnRg90/file1c4535405d6e/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4535405d6e...
#> ✔ First episode created in /tmp/RtmpUnRg90/file1c4535405d6e/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4535405d6e...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4535405d6e...
#> ✔ Lesson successfully created in /tmp/RtmpUnRg90/file1c4535405d6e
#> → Creating Lesson in /tmp/RtmpUnRg90/file1c4535405d6e...
#> /tmp/RtmpUnRg90/file1c4535405d6e
check_lesson(tmp)
