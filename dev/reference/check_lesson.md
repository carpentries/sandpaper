...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8647d4863f...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8647d4863f...
#> ☐ Edit /tmp/RtmpvxQeST/file1a8647d4863f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8647d4863f...
#> ✔ First episode created in /tmp/RtmpvxQeST/file1a8647d4863f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8647d4863f...
...
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8647d4863f...
#> ✔ Lesson successfully created in /tmp/RtmpvxQeST/file1a8647d4863f
#> → Creating Lesson in /tmp/RtmpvxQeST/file1a8647d4863f...
#> /tmp/RtmpvxQeST/file1a8647d4863f
check_lesson(tmp)
