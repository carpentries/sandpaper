...
#> ℹ Lesson bootstrapped in 3.004826 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01357317 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.04 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) 9f94d76] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/Rtmp3i6gqa/REMOTE-1c8831c63d4a
...
#> From /tmp/Rtmp3i6gqa/REMOTE-1c8831c63d4a
...
#>   /tmp/Rtmp3i6gqa/file1c88664a0f87/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 9f94d76)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 9f94d76 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) e3c9f88] Initializing gh-pages branch
...
#>   /tmp/Rtmp3i6gqa/file1c88664a0f87/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at e3c9f88)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at e3c9f88 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.69 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmp3i6gqa/file1c88664a0f87/lesson-example/site/built", "/tmp/Rtmp3i6gqa/file1c88664a0f87/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmp3i6gqa/file1c88664a0f87/lesson-example/site/docs", "/tmp/Rtmp3i6gqa/file1c88664a0f87/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/Rtmp3i6gqa/file1c88664a0f87/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/Rtmp3i6gqa/REMOTE-1c8831c63d4a)
#> /tmp/Rtmp3i6gqa/REMOTE-1c8831c63d4a
