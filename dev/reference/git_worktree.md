...
#> ℹ Lesson bootstrapped in 3.130523 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01376104 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.17 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) efd4c89] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpukkbJ4/REMOTE-1bfd740d23eb
...
#> From /tmp/RtmpukkbJ4/REMOTE-1bfd740d23eb
...
#>   /tmp/RtmpukkbJ4/file1bfd5893c000/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at efd4c89)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at efd4c89 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 5114c56] Initializing gh-pages branch
...
#>   /tmp/RtmpukkbJ4/file1bfd5893c000/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 5114c56)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 5114c56 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpukkbJ4/file1bfd5893c000/lesson-example/site/built", "/tmp/RtmpukkbJ4/file1bfd5893c000/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpukkbJ4/file1bfd5893c000/lesson-example/site/docs", "/tmp/RtmpukkbJ4/file1bfd5893c000/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpukkbJ4/file1bfd5893c000/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpukkbJ4/REMOTE-1bfd740d23eb)
#> /tmp/RtmpukkbJ4/REMOTE-1bfd740d23eb
