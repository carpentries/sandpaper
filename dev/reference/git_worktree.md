...
#> ℹ Lesson bootstrapped in 3.145798 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01073766 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 91300c5] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpgOPyFN/REMOTE-1a7e5c40092d
...
#> From /tmp/RtmpgOPyFN/REMOTE-1a7e5c40092d
...
#>   /tmp/RtmpgOPyFN/file1a7e462eb95d/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 91300c5)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 91300c5 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 5e23c24] Initializing gh-pages branch
...
#>   /tmp/RtmpgOPyFN/file1a7e462eb95d/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 5e23c24)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 5e23c24 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 10.94 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpgOPyFN/file1a7e462eb95d/lesson-example/site/built", "/tmp/RtmpgOPyFN/file1a7e462eb95d/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpgOPyFN/file1a7e462eb95d/lesson-example/site/docs", "/tmp/RtmpgOPyFN/file1a7e462eb95d/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpgOPyFN/file1a7e462eb95d/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpgOPyFN/REMOTE-1a7e5c40092d)
#> /tmp/RtmpgOPyFN/REMOTE-1a7e5c40092d
sandpaper:::reset_git_user(res)
# remove the test fixture and report
tryCatch(fs::dir_delete(res), error = function() FALSE)
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 0.13 seconds
```
