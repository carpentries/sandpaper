...
#> ℹ Lesson bootstrapped in 3.573802 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01354313 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 45a3614] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/Rtmp6yLLZk/REMOTE-1accd2418bf
...
#> From /tmp/Rtmp6yLLZk/REMOTE-1accd2418bf
...
#>   /tmp/Rtmp6yLLZk/file1acc5a7f6d74/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 45a3614)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 45a3614 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) c4ca146] Initializing gh-pages branch
...
#>   /tmp/Rtmp6yLLZk/file1acc5a7f6d74/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at c4ca146)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at c4ca146 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.36 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmp6yLLZk/file1acc5a7f6d74/lesson-example/site/built", "/tmp/Rtmp6yLLZk/file1acc5a7f6d74/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/Rtmp6yLLZk/file1acc5a7f6d74/lesson-example/site/docs", "/tmp/Rtmp6yLLZk/file1acc5a7f6d74/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/Rtmp6yLLZk/file1acc5a7f6d74/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/Rtmp6yLLZk/REMOTE-1accd2418bf)
#> /tmp/Rtmp6yLLZk/REMOTE-1accd2418bf
