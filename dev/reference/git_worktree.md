...
#> ℹ Lesson bootstrapped in 3.459734 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01432204 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) d04ac0d] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpvxQeST/REMOTE-1a86561c438
...
#> From /tmp/RtmpvxQeST/REMOTE-1a86561c438
...
#>   /tmp/RtmpvxQeST/file1a867fbf2956/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at d04ac0d)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at d04ac0d Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 1619b51] Initializing gh-pages branch
...
#>   /tmp/RtmpvxQeST/file1a867fbf2956/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 1619b51)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 1619b51 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.42 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpvxQeST/file1a867fbf2956/lesson-example/site/built", "/tmp/RtmpvxQeST/file1a867fbf2956/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpvxQeST/file1a867fbf2956/lesson-example/site/docs", "/tmp/RtmpvxQeST/file1a867fbf2956/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpvxQeST/file1a867fbf2956/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpvxQeST/REMOTE-1a86561c438)
#> /tmp/RtmpvxQeST/REMOTE-1a86561c438
