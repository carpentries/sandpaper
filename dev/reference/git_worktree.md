...
#> ℹ Lesson bootstrapped in 3.450739 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.02353573 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) ed2c532] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpJOJxpS/REMOTE-1a75701bd757
...
#> From /tmp/RtmpJOJxpS/REMOTE-1a75701bd757
...
#>   /tmp/RtmpJOJxpS/file1a757b245d5c/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at ed2c532)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at ed2c532 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 6c64857] Initializing gh-pages branch
...
#>   /tmp/RtmpJOJxpS/file1a757b245d5c/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 6c64857)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 6c64857 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.53 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpJOJxpS/file1a757b245d5c/lesson-example/site/built", "/tmp/RtmpJOJxpS/file1a757b245d5c/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpJOJxpS/file1a757b245d5c/lesson-example/site/docs", "/tmp/RtmpJOJxpS/file1a757b245d5c/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpJOJxpS/file1a757b245d5c/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpJOJxpS/REMOTE-1a75701bd757)
#> /tmp/RtmpJOJxpS/REMOTE-1a75701bd757
