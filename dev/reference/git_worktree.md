...
#> ℹ Lesson bootstrapped in 3.437468 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01762891 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 3f4e81e] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpUTI0d7/REMOTE-1ae32ca8e949
...
#> From /tmp/RtmpUTI0d7/REMOTE-1ae32ca8e949
...
#>   /tmp/RtmpUTI0d7/file1ae372eece7a/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 3f4e81e)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 3f4e81e Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 64a72de] Initializing gh-pages branch
...
#>   /tmp/RtmpUTI0d7/file1ae372eece7a/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 64a72de)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 64a72de Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.07 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpUTI0d7/file1ae372eece7a/lesson-example/site/built", "/tmp/RtmpUTI0d7/file1ae372eece7a/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpUTI0d7/file1ae372eece7a/lesson-example/site/docs", "/tmp/RtmpUTI0d7/file1ae372eece7a/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpUTI0d7/file1ae372eece7a/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpUTI0d7/REMOTE-1ae32ca8e949)
#> /tmp/RtmpUTI0d7/REMOTE-1ae32ca8e949
