...
#> ℹ Lesson bootstrapped in 3.15703 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01283813 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 1f54c07] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpH5UNvd/REMOTE-1daf5bdbfacf
...
#> From /tmp/RtmpH5UNvd/REMOTE-1daf5bdbfacf
...
#>   /tmp/RtmpH5UNvd/file1daf2c90bfb/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 1f54c07)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 1f54c07 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 236d58f] Initializing gh-pages branch
...
#>   /tmp/RtmpH5UNvd/file1daf2c90bfb/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 236d58f)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 236d58f Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.84 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpH5UNvd/file1daf2c90bfb/lesson-example/site/built", "/tmp/RtmpH5UNvd/file1daf2c90bfb/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpH5UNvd/file1daf2c90bfb/lesson-example/site/docs", "/tmp/RtmpH5UNvd/file1daf2c90bfb/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpH5UNvd/file1daf2c90bfb/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpH5UNvd/REMOTE-1daf5bdbfacf)
#> /tmp/RtmpH5UNvd/REMOTE-1daf5bdbfacf
