...
#> ℹ Lesson bootstrapped in 3.189186 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.0131917 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 2d48ab4] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpjJX7eW/REMOTE-199e3c4f030b
...
#> From /tmp/RtmpjJX7eW/REMOTE-199e3c4f030b
...
#>   /tmp/RtmpjJX7eW/file199e2947e0cf/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 2d48ab4)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 2d48ab4 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) ebf91c2] Initializing gh-pages branch
...
#>   /tmp/RtmpjJX7eW/file199e2947e0cf/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at ebf91c2)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at ebf91c2 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.97 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpjJX7eW/file199e2947e0cf/lesson-example/site/built", "/tmp/RtmpjJX7eW/file199e2947e0cf/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpjJX7eW/file199e2947e0cf/lesson-example/site/docs", "/tmp/RtmpjJX7eW/file199e2947e0cf/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpjJX7eW/file199e2947e0cf/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpjJX7eW/REMOTE-199e3c4f030b)
#> /tmp/RtmpjJX7eW/REMOTE-199e3c4f030b
