...
#> ℹ Lesson bootstrapped in 3.085806 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01255369 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 6725394] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpPAgXQL/REMOTE-1d5074636dc3
...
#> From /tmp/RtmpPAgXQL/REMOTE-1d5074636dc3
...
#>   /tmp/RtmpPAgXQL/file1d50331ea87/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 6725394)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 6725394 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) e4c03f0] Initializing gh-pages branch
...
#>   /tmp/RtmpPAgXQL/file1d50331ea87/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at e4c03f0)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at e4c03f0 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.78 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpPAgXQL/file1d50331ea87/lesson-example/site/built", "/tmp/RtmpPAgXQL/file1d50331ea87/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpPAgXQL/file1d50331ea87/lesson-example/site/docs", "/tmp/RtmpPAgXQL/file1d50331ea87/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpPAgXQL/file1d50331ea87/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpPAgXQL/REMOTE-1d5074636dc3)
#> /tmp/RtmpPAgXQL/REMOTE-1d5074636dc3
