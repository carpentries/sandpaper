...
#> ℹ Lesson bootstrapped in 3.123099 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01269054 secs
tok <- Sys.time()
...
#> [md-outputs (root-commit) 8ed5472] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpPxAdba/REMOTE-19f93fd89914
...
#> From /tmp/RtmpPxAdba/REMOTE-19f93fd89914
...
#>   /tmp/RtmpPxAdba/file19f93765f803/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 8ed5472)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 8ed5472 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 55e3ae3] Initializing gh-pages branch
...
#>   /tmp/RtmpPxAdba/file19f93765f803/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 55e3ae3)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 55e3ae3 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 12.96 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpPxAdba/file19f93765f803/lesson-example/site/built", "/tmp/RtmpPxAdba/file19f93765f803/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpPxAdba/file19f93765f803/lesson-example/site/docs", "/tmp/RtmpPxAdba/file19f93765f803/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpPxAdba/file19f93765f803/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpPxAdba/REMOTE-19f93fd89914)
#> /tmp/RtmpPxAdba/REMOTE-19f93fd89914
