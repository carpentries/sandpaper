...
#> ℹ Lesson bootstrapped in 3.383451 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01405072 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.42 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) 5eb195a] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpXPofNf/REMOTE-1a753f1ce88f
...
#> From /tmp/RtmpXPofNf/REMOTE-1a753f1ce88f
...
#>   /tmp/RtmpXPofNf/file1a757213d0d5/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at 5eb195a)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at 5eb195a Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 9b16368] Initializing gh-pages branch
...
#>   /tmp/RtmpXPofNf/file1a757213d0d5/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 9b16368)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 9b16368 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.5 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpXPofNf/file1a757213d0d5/lesson-example/site/built", "/tmp/RtmpXPofNf/file1a757213d0d5/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpXPofNf/file1a757213d0d5/lesson-example/site/docs", "/tmp/RtmpXPofNf/file1a757213d0d5/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpXPofNf/file1a757213d0d5/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpXPofNf/REMOTE-1a753f1ce88f)
#> /tmp/RtmpXPofNf/REMOTE-1a753f1ce88f
