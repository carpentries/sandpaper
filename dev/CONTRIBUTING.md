...
This outlines how to propose a change to sandpaper. For more detailed
...
Please note that the sandpaper project is released with a [Contributor
Code of
Conduct](https://carpentries.github.io/sandpaper/dev/CODE_OF_CONDUCT.md).
