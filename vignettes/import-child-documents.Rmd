...
txt <- c("## Session Information\n",
  ...
  "\n```{r sessioninfo}", "sessioninfo::session_info()", "```\n")
...
files (note: this requires R Markdown). For example, you have a file structure
like this:
...
and the entire child document looks like this:
