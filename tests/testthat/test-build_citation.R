...
test_that("parse_authors returns correct HTML for multiple authors and affiliations", {
  ...
  expect_match(env$html_authors, "Jane Doe<span class='author-info'> <a href='https://orcid.org/0000-0001-2345-6789' target='_blank'>")
  expect_match(env$html_authors, "Doc Brown<span class='author-info'> <a href='#aff1'><sup>1</sup></a>  <a href='https://orcid.org/0000-0009-8765-4321' target='_blank'>")
  expect_match(env$html_authors, "John Smith<span class='author-info'> <a href='#aff2'><sup>2</sup></a>")
  expect_match(env$pre_authors, "Doe J., Brown D. and Smith J.")
